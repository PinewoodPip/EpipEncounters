...
--- @alias HealEffect string|"Sitting"|"ResistDeath"|"Behavior"|"Heal"|"Unknown4"|"Script"|"Lifesteal"|"None"|"NegativeDamage"|"Unknown9"|"HealSharing"|"HealSharingReflected"|"Surface"|"Necromantic"
...
--- @alias InputModifier string|"Shift"|"Ctrl"|"Gui"|"Alt"
--- @alias InputRawType string|"backspace"|"comma"|"num7"|"f3"|"rightstick_yneg"|"capslock"|"i"|"f14"|"lgui"|"lefttrigger"|"printscreen"|"t"|"kp_0"|"motion"|"righttrigger"|"item9"|"scrolllock"|"dot"|"num9"|"f5"|"controller_a"|"delete_key"|"k"|"f16"|"left"|"kp_1"|"rshift"|"controller_b"|"pagedown"|"num0"|"v"|"controller_x"|"item11"|"semicolon"|"b"|"f7"|"controller_y"|"guide"|"leftbracket"|"m"|"f18"|"kp_3"|"rgui"|"leftstick"|"item2"|"insert"|"backslash"|"num2"|"x"|"rightstick"|"tab"|"rightbracket"|"d"|"f9"|"leftshoulder"|"apostrophe"|"o"|"f20"|"kp_5"|"left2"|"rightshoulder"|"item4"|"pageup"|"num4"|"z"|"up"|"kp_divide"|"dpad_down"|"f"|"f11"|"kp_multiply"|"lctrl"|"dpad_up"|"dpad_left"|"enter"|"q"|"f22"|"kp_minus"|"kp_7"|"right2"|"dpad_right"|"item6"|"num6"|"f2"|"kp_enter"|"touch_tap"|"h"|"f13"|"kp_period"|"lalt"|"touch_hold"|"s"|"f24"|"kp_9"|"x2"|"motion_xneg"|"touch_pinch_in"|"item8"|"dash"|"num8"|"f4"|"motion_ypos"|"touch_pinch_out"|"j"|"f15"|"right"|"rctrl"|"motion_xpos"|"touch_rotate"|"space"|"u"|"down"|"motion_yneg"|"touch_flick"|"item10"|"slash"|"a"|"f6"|"wheel_xpos"|"back"|"touch_press"|"end"|"l"|"f17"|"kp_2"|"ralt"|"wheel_xneg"|"item1"|"pause"|"num1"|"w"|"wheel_ypos"|"c"|"f8"|"wheel_yneg"|"start"|"n"|"f19"|"kp_4"|"mode"|"leftstick_xneg"|"item3"|"home"|"num3"|"y"|"kp_plus"|"leftstick_ypos"|"tilde"|"e"|"f10"|"leftstick_xpos"|"p"|"f21"|"kp_6"|"middle"|"leftstick_yneg"|"item5"|"num5"|"f1"|"rightstick_xneg"|"g"|"f12"|"numlock"|"lshift"|"rightstick_ypos"|"escape"|"equals"|"r"|"f23"|"kp_8"|"x1"|"rightstick_xpos"|"item7"
--- @alias InputState string|"Pressed"|"Released"
--- @alias InputType string|"Unknown"|"AcceleratedRepeat"|"Repeat"|"Release"|"Hold"|"Press"|"ValueChange"
--- @alias ItemDataRarity string|"Legendary"|"Sentinel"|"Epic"|"Rare"|"Unique"|"Common"|"Divine"|"Uncommon"
--- @alias LuaTypeId string|"Unknown"|"Any"|"Set"|"Boolean"|"Float"|"Tuple"|"Function"|"String"|"Array"|"Void"|"Enumeration"|"Map"|"Nullable"|"Integer"|"Object"|"Module"
--- @alias MultiEffectHandlerFlags string|"Beam"|"Detach"|"FaceSource"|"FollowScale"|"EffectAttached"|"KeepRot"
--- @alias NetMessage string|"NETMSG_CHARACTER_UPDATE"|"NETMSG_ITEM_USE_REMOTELY"|"NETMSG_ITEM_STATUS"|"NETMSG_CACHETEMPLATE"|"NETMSG_GM_TICK_ROLLS"|"NETMSG_GM_STOP_TRAVELING"|"NETMSG_MODULE_LOADED"|"NETMSG_REALTIME_MULTIPLAY"|"NETMSG_ARENA_RESULTS"|"NETMSG_CHARACTER_ACTION_DATA"|"NETMSG_PARTYGROUP"|"NETMSG_INVENTORY_CREATE_AND_OPEN"|"NETMSG_INVENTORY_LOCKSTATE_SYNC"|"NETMSG_TURNBASED_START"|"NETMSG_QUEST_UPDATE"|"NETMSG_GM_LOAD_CAMPAIGN"|"NETMSG_GM_CHANGE_SCENE_PATH"|"NETMSG_LEVEL_SWAP_READY"|"NETMSG_PING_BEACON"|"NETMSG_CLIENT_CONNECT"|"NETMSG_CHARACTER_LOCK_ABILITY"|"NETMSG_ITEM_ACTIVATE"|"NETMSG_SKILL_DESTROY"|"NETMSG_COMBATLOGITEMINTERACTION"|"NETMSG_CLOSED_MESSAGE_BOX_MESSAGE"|"NETMSG_QUEST_POSTPONE"|"NETMSG_DIALOG_NODE_MESSAGE"|"NETMSG_GM_GIVE_REWARD"|"NETMSG_CHANGE_COMBAT_FORMATION"|"NETMSG_LOCK_WAYPOINT"|"NETMSG_HOST_REFUSEPLAYER"|"NETMSG_PLAYER_LEFT"|"NETMSG_ITEM_MOVE_TO_INVENTORY"|"NETMSG_EFFECT_FORGET"|"NETMSG_FLAG_UPDATE"|"NETMSG_DIALOG_ACTORJOINS_MESSAGE"|"NETMSG_GM_SYNC_VIGNETTES"|"NETMSG_GM_DEACTIVATE"|"NETMSG_LOBBY_DATAUPDATE"|"NETMSG_LOBBY_CHARACTER_SELECT"|"NETMSG_CHARACTER_ASSIGN"|"NETMSG_CHARACTER_SET_STORY_NAME"|"NETMSG_PROJECTILE_EXPLOSION"|"NETMSG_ALIGNMENT_CREATE"|"NETMSG_GAMEOVER"|"NETMSG_GM_REQUEST_ROLL"|"NETMSG_GM_UI_OPEN_STICKY"|"NETMSG_PARTY_NPC_DATA"|"NETMSG_CHARACTER_ANIMATION_SET_UPDATE"|"NETMSG_AITEST_UPDATE"|"NETMSG_CHARACTER_BOOST"|"NETMSG_CHARACTER_ITEM_USED"|"NETMSG_INVENTORY_CREATE"|"NETMSG_SCREEN_FADE_DONE"|"NETMSG_OPEN_WAYPOINT_UI_MESSAGE"|"NETMSG_DIALOG_HISTORY_MESSAGE"|"NETMSG_GM_SPAWN"|"NETMSG_GM_CAMPAIGN_SAVE"|"NETMSG_LEVEL_LOAD"|"NETMSG_JOURNALDIALOGLOG_UPDATE"|"NETMSG_ACHIEVEMENT_PROGRESS_MESSAGE"|"NETMSG_TRIGGER_CREATE"|"NETMSG_HOST_WELCOME"|"NETMSG_CHARACTER_DESTROY"|"NETMSG_SHROUD_UPDATE"|"NETMSG_ITEM_CONFIRMATION"|"NETMSG_PEER_ACTIVATE"|"NETMSG_MARKER_UI_CREATE"|"NETMSG_GM_HEAL"|"NETMSG_GM_SET_START_POINT"|"NETMSG_GM_ITEM_USE"|"NETMSG_ITEM_ENGRAVE"|"NETMSG_SET_CHARACTER_ARCHETYPE"|"NETMSG_MULTIPLE_TARGET_OPERATION"|"NETMSG_DLC_UPDATE"|"NETMSG_PLAYER_CONNECT"|"NETMSG_CHARACTER_UPGRADE"|"NETMSG_CHARACTER_CORPSE_LOOTABLE"|"NETMSG_TURNBASED_SETTEAM"|"NETMSG_SKILL_ACTIVATE"|"NETMSG_JOURNALRECIPE_UPDATE"|"NETMSG_PARTYFORMATION"|"NETMSG_GM_ROLL"|"NETMSG_GM_EDIT_ITEM"|"NETMSG_GM_SET_REPUTATION"|"NETMSG_DIALOG_LISTEN"|"NETMSG_SURFACE_META"|"NETMSG_COMBAT_TURN_TIMER"|"NETMSG_PLAYMOVIE"|"NETMSG_OPEN_KICKSTARTER_BOOK_UI_MESSAGE"|"NETMSG_GM_TOGGLE_VIGNETTE"|"NETMSG_GM_DAMAGE"|"NETMSG_GM_HOST"|"NETMSG_CAMERA_TARGET"|"NETMSG_SAVEGAME_LOAD_FAIL"|"NETMSG_LOBBY_SURRENDER"|"NETMSG_CHARACTER_ACTIVATE"|"NETMSG_CHARACTER_DIALOG"|"NETMSG_ITEM_TRANSFORM"|"NETMSG_INVENTORY_DESTROY"|"NETMSG_OVERHEADTEXT"|"NETMSG_DIALOG_ANSWER_HIGHLIGHT_MESSAGE"|"NETMSG_GM_CHANGE_LEVEL"|"NETMSG_GM_REQUEST_CAMPAIGN_DATA"|"NETMSG_CHAT"|"NETMSG_MODULES_DOWNLOAD"|"NETMSG_CAMERA_SPLINE"|"NETMSG_CUSTOM_STATS_UPDATE"|"NETMSG_CHARACTER_CUSTOMIZATION"|"NETMSG_PARTYORDER"|"NETMSG_TURNBASED_STOP"|"NETMSG_NET_ENTITY_DESTROY"|"NETMSG_QUEST_STATE"|"NETMSG_PARTY_CONSUMED_ITEMS"|"NETMSG_GM_POSSESS"|"NETMSG_GM_REQUEST_CHARACTERS_REROLL"|"NETMSG_SAVEGAME"|"NETMSG_SAVEGAMEHANDSHAKE"|"NETMSG_LEVEL_START"|"NETMSG_GIVE_REWARD"|"NETMSG_CLIENT_ACCEPT"|"NETMSG_CHARACTER_ACTION_REQUEST_RESULT"|"NETMSG_UPDATE_COMBAT_GROUP_INFO"|"NETMSG_ITEM_DEACTIVATE"|"NETMSG_SKILL_UPDATE"|"NETMSG_UI_QUESTSELECTED"|"NETMSG_GM_ADD_EXPERIENCE"|"NETMSG_GM_SET_STATUS"|"NETMSG_NOTIFY_COMBINE_FAILED_MESSAGE"|"NETMSG_OPEN_CRAFT_UI_MESSAGE"|"NETMSG_CRAFT_RESULT"|"NETMSG_PAUSE"|"NETMSG_VOICEDATA"|"NETMSG_CHARACTER_POSITION"|"NETMSG_INVENTORY_VIEW_DESTROY"|"NETMSG_EFFECT_DESTROY"|"NETMSG_GM_DELETE"|"NETMSG_GM_SET_ATMOSPHERE"|"NETMSG_TRADE_ACTION"|"NETMSG_LOBBY_USERUPDATE"|"NETMSG_UNPAUSE"|"NETMSG_LOAD_GAME_WITH_ADDONS_FAIL"|"NETMSG_CLIENT_GAME_SETTINGS"|"NETMSG_CHARACTER_ACTION"|"NETMSG_CHARACTER_SELECTEDSKILLSET"|"NETMSG_CHARACTER_TELEPORT"|"NETMSG_GAMECONTROL_UPDATE_C2S"|"NETMSG_ALIGNMENT_SET"|"NETMSG_PARTY_SPLIT_NOTIFICATION"|"NETMSG_GM_PASS_ROLL"|"NETMSG_REQUESTAUTOSAVE"|"NETMSG_LEVEL_SWAP_COMPLETE"|"NETMSG_TELEPORT_ACK"|"NETMSG_PARTY_CREATE"|"NETMSG_SECRET_REGION_UNLOCK"|"NETMSG_EGG_CREATE"|"NETMSG_TURNBASED_FLEECOMBATRESULT"|"NETMSG_CLOSE_CUSTOM_BOOK_UI_MESSAGE"|"NETMSG_CLOSE_UI_MESSAGE"|"NETMSG_GM_TRAVEL_TO_DESTINATION"|"NETMSG_GM_SYNC_SCENES"|"NETMSG_LEVEL_LOADED"|"NETMSG_TELEPORT_WAYPOINT"|"NETMSG_TRIGGER_DESTROY"|"NETMSG_HOST_REFUSE"|"NETMSG_CHARACTER_STEERING"|"NETMSG_ITEM_CREATE"|"NETMSG_INVENTORY_ITEM_UPDATE"|"NETMSG_PEER_DEACTIVATE"|"NETMSG_MARKER_UI_UPDATE"|"NETMSG_GM_TOGGLE_PEACE"|"NETMSG_GM_CHANGE_SCENE_NAME"|"NETMSG_STORY_ELEMENT_UI"|"NETMSG_MUTATORS_ENABLED"|"NETMSG_HACK_TELL_BUILDNAME"|"NETMSG_PLAYER_ACCEPT"|"NETMSG_CHARACTER_OFFSTAGE"|"NETMSG_SKILL_REMOVED"|"NETMSG_ALIGNMENT_RELATION"|"NETMSG_STOP_FOLLOW"|"NETMSG_DIALOG_STATE_MESSAGE"|"NETMSG_GM_SET_INTERESTED_CHARACTER"|"NETMSG_GM_SYNC_NOTES"|"NETMSG_CHARACTERCREATION_READY"|"NETMSG_MUSIC_STATE"|"NETMSG_GAMEACTION"|"NETMSG_ITEM_MOVE_TO_WORLD"|"NETMSG_PLAY_HUD_SOUND"|"NETMSG_GM_EXPORT"|"NETMSG_GM_SYNC_OVERVIEW_MAPS"|"NETMSG_CAMERA_MODE"|"NETMSG_ACHIEVEMENT_UNLOCKED_MESSAGE"|"NETMSG_LOBBY_SPECTATORUPDATE"|"NETMSG_LOBBY_RETURN"|"NETMSG_CHARACTER_COMPANION_CUSTOMIZATION"|"NETMSG_CHARACTER_CONTROL"|"NETMSG_CHARACTER_USE_AP"|"NETMSG_ITEM_OFFSTAGE"|"NETMSG_PROJECTILE_CREATE"|"NETMSG_COMBATLOG"|"NETMSG_GM_POSITION_SYNC"|"NETMSG_GM_EDIT_CHARACTER"|"NETMSG_SESSION_LOAD"|"NETMSG_READYCHECK"|"NETMSG_CUSTOM_STATS_DEFINITION_UPDATE"|"NETMSG_CHARACTER_LOOT_CORPSE"|"NETMSG_PARTYUPDATE"|"NETMSG_TURNBASED_ROUND"|"NETMSG_OPEN_MESSAGE_BOX_MESSAGE"|"NETMSG_SECRET_UPDATE"|"NETMSG_DIALOG_ANSWER_MESSAGE"|"NETMSG_GM_CHANGE_NAME"|"NETMSG_DIFFICULTY_CHANGED"|"NETMSG_RUNECRAFT"|"NETMSG_SHOW_ERROR"|"NETMSG_CLIENT_JOINED"|"NETMSG_PLAYER_DISCONNECT"|"NETMSG_ITEM_DESTINATION"|"NETMSG_ITEM_STATUS_LIFETIME"|"NETMSG_INVENTORY_VIEW_UPDATE_PARENTS"|"NETMSG_SKILL_LEARN"|"NETMSG_OPEN_CUSTOM_BOOK_UI_MESSAGE"|"NETMSG_MYSTERY_STATE"|"NETMSG_GM_REORDER_ELEMENTS"|"NETMSG_GM_REMOVE_STATUS"|"NETMSG_UNLOCK_ITEM"|"NETMSG_UPDATE_CHARACTER_TAGS"|"NETMSG_SKIPMOVIE_RESULT"|"NETMSG_CHARACTER_SKILLBAR"|"NETMSG_TURNBASED_SUMMONS"|"NETMSG_FORCE_SHEATH"|"NETMSG_GM_ITEM_CHANGE"|"NETMSG_GM_INVENTORY_OPERATION"|"NETMSG_CAMERA_ACTIVATE"|"NETMSG_LOBBY_COMMAND"|"NETMSG_CHARACTER_STATUS"|"NETMSG_CHARACTER_IN_DIALOG"|"NETMSG_ITEM_ACTION"|"NETMSG_ALIGNMENT_CLEAR"|"NETMSG_QUEST_CATEGORY_UPDATE"|"NETMSG_GM_TOGGLE_OVERVIEWMAP"|"NETMSG_GM_REMOVE_ROLL"|"NETMSG_GM_ASSETS_PENDING_SYNCS_INFO"|"NETMSG_MODULE_LOAD"|"NETMSG_SHOW_TUTORIAL_MESSAGE"|"NETMSG_PARTYCREATEGROUP"|"NETMSG_CHARACTER_CONFIRMATION"|"NETMSG_PARTY_DESTROY"|"NETMSG_ITEM_MOVED_INFORM"|"NETMSG_EGG_DESTROY"|"NETMSG_JOURNAL_RESET"|"NETMSG_GM_SYNC_ASSETS"|"NETMSG_GM_CONFIGURE_CAMPAIGN"|"NETMSG_LOAD_START"|"NETMSG_CHARACTER_CHANGE_OWNERSHIP"|"NETMSG_TRIGGER_UPDATE"|"NETMSG_CUSTOM_STATS_CREATE"|"NETMSG_HOST_LEFT"|"NETMSG_CHARACTER_STATS_UPDATE"|"NETMSG_ITEM_DESTROY"|"NETMSG_NET_ENTITY_CREATE"|"NETMSG_SKILL_CREATE"|"NETMSG_QUEST_TRACK"|"NETMSG_REGISTER_WAYPOINT"|"NETMSG_GM_MAKE_TRADER"|"NETMSG_ATMOSPHERE_OVERRIDE"|"NETMSG_UNLOCK_WAYPOINT"|"NETMSG_CUSTOM_STATS_DEFINITION_REMOVE"|"NETMSG_SCRIPT_EXTENDER"|"NETMSG_PLAYER_JOINED"|"NETMSG_COMBAT_COMPONENT_SYNC"|"NETMSG_EFFECT_CREATE"|"NETMSG_NOTIFICATION"|"NETMSG_GM_REMOVE_EXPORTED"|"NETMSG_GM_MAKE_FOLLOWER"|"NETMSG_SERVER_NOTIFICATION"|"NETMSG_MUSIC_EVENT"|"NETMSG_CHARACTER_CREATE"|"NETMSG_CHARACTER_DEACTIVATE"|"NETMSG_INVENTORY_VIEW_CREATE"|"NETMSG_INVENTORY_VIEW_UPDATE_ITEMS"|"NETMSG_CHARACTER_ERROR"|"NETMSG_GM_TOGGLE_PAUSE"|"NETMSG_GM_CLEAR_STATUSES"|"NETMSG_GAMETIME_SYNC"|"NETMSG_UPDATE_ITEM_TAGS"|"NETMSG_LOAD_GAME_WITH_ADDONS"|"NETMSG_CHARACTER_AOO"|"NETMSG_CHARACTER_TRANSFORM"|"NETMSG_ITEM_MOVE_UUID"|"NETMSG_GAMECONTROL_UPDATE_S2C"|"NETMSG_SCREEN_FADE"|"NETMSG_SHOW_ENTER_REGION_UI_MESSAGE"|"NETMSG_PARTY_UNLOCKED_RECIPE"|"NETMSG_GM_TELEPORT"|"NETMSG_SESSION_LOADED"|"NETMSG_LEVEL_INSTANTIATE_SWAP"|"NETMSG_DIPLOMACY"|"NETMSG_PARTYUSER"|"NETMSG_SHROUD_FRUSTUM_UPDATE"|"NETMSG_TURNBASED_ORDER"|"NETMSG_TROPHY_UPDATE"|"NETMSG_DIALOG_ACTORLEAVES_MESSAGE"|"NETMSG_GM_VIGNETTE_ANSWER"|"NETMSG_GM_DUPLICATE"|"NETMSG_SERVER_COMMAND"|"NETMSG_DISCOVERED_PORTALS"|"NETMSG_STORY_VERSION"|"NETMSG_CLIENT_LEFT"|"NETMSG_CHARACTER_POSITION_SYNC"|"NETMSG_ITEM_UPDATE"|"NETMSG_INVENTORY_VIEW_SORT"|"NETMSG_SKILL_UNLEARN"|"NETMSG_MYSTERY_UPDATE"|"NETMSG_GM_CREATE_ITEM"|"NETMSG_GM_SOUND_PLAYBACK"|"NETMSG_CHARACTERCREATION_NOT_READY"|"NETMSG_TELEPORT_PYRAMID"|"NETMSG_GM_JOURNAL_UPDATE"|"NETMSG_SURFACE_CREATE"|"NETMSG_CHARACTER_STATUS_LIFETIME"|"NETMSG_CHARACTER_PICKPOCKET"|"NETMSG_GAMECONTROL_PRICETAG"|"NETMSG_PLAYSOUND"|"NETMSG_PARTY_MERGE_NOTIFICATION"|"NETMSG_GM_DRAW_SURFACE"|"NETMSG_CAMERA_ROTATE"|"NETMSG_CHARACTERCREATION_DONE"|"NETMSG_LOBBY_STARTGAME"|"NETMSG_CUSTOM_STATS_DEFINITION_CREATE"
--- @alias ObjectHandleType string|"ClientWallBase"|"ClientDummyGameObject"|"ClientInventory"|"ServerStartTrigger"|"CustomStatsComponent"|"ClientAlignment"|"ServerCrimeRegionTrigger"|"ServerRegionTrigger"|"Unknown"|"ClientGameAction"|"ClientSkill"|"ClientStatus"|"ClientSpectatorTrigger"|"ClientParty"|"ServerSurfaceAction"|"Effect"|"ClientVignette"|"ServerAtmosphereTrigger"|"ClientWallIntersection"|"ClientNote"|"ClientCameraLockTrigger"|"ClientSurface"|"ServerSoundVolumeTrigger"|"ServerEgg"|"ServerProjectile"|"ServerCharacter"|"ServerTeleportTrigger"|"ContainerComponent"|"ServerItem"|"Texture"|"TextureRemoveData"|"ClientOverviewMap"|"ServerInventory"|"Visual"|"ClientSecretRegionTrigger"|"ClientAtmosphereTrigger"|"ServerParty"|"ServerVignette"|"ServerEocPointTrigger"|"ServerNote"|"ServerAIHintAreaTrigger"|"Light"|"ClientInventoryView"|"ClientPointSoundTriggerDummy"|"IndexBuffer"|"ClientRegionTrigger"|"ServerCustomStatDefinitionComponent"|"VertexBuffer"|"Reference"|"ServerInventoryView"|"VertexFormat"|"ServerEventTrigger"|"ServerMusicVolumeTrigger"|"SamplerState"|"SRV"|"Scene"|"ClientProjectile"|"Shader"|"BlendState"|"StructuredBuffer"|"Dummy"|"ClientPointTrigger"|"DepthState"|"ClientAiSeederTrigger"|"ServerSecretRegionTrigger"|"RasterizerState"|"UIObject"|"Decal"|"Trigger"|"ServerEocAreaTrigger"|"Constant"|"TerrainObject"|"CombatComponent"|"ServerStatsAreaTrigger"|"ConstantBuffer"|"MeshProxy"|"GrannyFile"|"ClientAlignmentData"|"ServerExplorationTrigger"|"CompiledShader"|"GMJournalNode"|"ClientPointSoundTrigger"|"TexturedFont"|"Text3D"|"SoundVolumeTrigger"|"ContainerElementComponent"|"ClientEgg"|"ServerOverviewMap"|"ClientCharacter"|"ServerCrimeAreaTrigger"|"ClientCustomStatDefinitionComponent"|"ClientItem"|"ClientWallConstruction"|"ExtenderClientVisual"|"ClientScenery"|"ClientCullTrigger"|"ClientSoundVolumeTrigger"
--- @alias PathRootType string|"Public"|"Data"|"Root"|"MyDocuments"|"GameStorage"
--- @alias PlayerUpgradeAttribute string|"Strength"|"Intelligence"|"Constitution"|"Wits"|"Memory"|"Finesse"
--- @alias RecipeCategory string|"Arrows"|"Armour"|"Potions"|"Weapons"|"Grenades"|"Grimoire"|"Runes"|"Objects"|"Food"|"Common"
--- @alias ResourceType string|"VisualSet"|"Atmosphere"|"Physics"|"Effect"|"Texture"|"Script"|"Visual"|"MaterialSet"|"Animation"|"MeshProxy"|"AnimationBlueprint"|"AnimationSet"|"Material"|"Sound"
...
--- @alias SkillType string|"Path"|"Zone"|"Wall"|"ProjectileStrike"|"Quake"|"Jump"|"Shout"|"Tornado"|"Rush"|"MultiStrike"|"Teleportation"|"Target"|"Summon"|"Projectile"|"Storm"|"Rain"|"SkillHeal"|"Dome"
--- @alias StatAttributeFlags string|"PoisonImmunity"|"PetrifiedImmunity"|"WebImmunity"|"CharmImmunity"|"ClairvoyantImmunity"|"MagicalSulfur"|"FearImmunity"|"ThrownImmunity"|"MuteImmunity"|"ChilledImmunity"|"BleedingImmunity"|"WarmImmunity"|"InfectiousDiseasedImmunity"|"RegeneratingImmunity"|"WetImmunity"|"EntangledContact"|"BlindImmunity"|"CursedImmunity"|"LoseDurabilityOnCharacterHit"|"WeakImmunity"|"SlippingImmunity"|"SlowedImmunity"|"ProtectFromSummon"|"DrunkImmunity"|"FreezeContact"|"Floating"|"CrippledImmunity"|"BurnContact"|"StunContact"|"DisarmedImmunity"|"PoisonContact"|"ShacklesOfPainImmunity"|"ChillContact"|"Torch"|"Unbreakable"|"Unrepairable"|"SleepingImmunity"|"Unstorable"|"DeflectProjectiles"|"Grounded"|"HastedImmunity"|"DiseasedImmunity"|"TauntedImmunity"|"PickpocketableWhenEquipped"|"Arrow"|"AcidImmunity"|"DecayingImmunity"|"EnragedImmunity"|"InvisibilityImmunity"|"BlessedImmunity"|"KnockdownImmunity"|"IgnoreClouds"|"SuffocatingImmunity"|"MadnessImmunity"|"FreezeImmunity"|"ChickenImmunity"|"LootableWhenEquipped"|"BurnImmunity"|"IgnoreCursedOil"|"StunImmunity"|"ShockedImmunity"
...
--- @alias StatusType string|"MUTED"|"IDENTIFY"|"LEADERSHIP"|"FLANKED"|"ADRENALINE"|"LYING"|"WIND_WALKER"|"DARK_AVENGER"|"SOURCE_MUTED"|"HEAL_SHARING_CASTER"|"HEAL"|"KNOCKED_DOWN"|"CLEAN"|"SUMMONING"|"FLOATING"|"STORY_FROZEN"|"UNLOCK"|"EXTRA_TURN"|"SHACKLES_OF_PAIN"|"ACTIVE_DEFENSE"|"SNEAKING"|"CHALLENGE"|"SITTING"|"DECAYING_TOUCH"|"DAMAGE_ON_MOVE"|"SPARK"|"THROWN"|"UNHEALABLE"|"SPIRIT"|"DEMONIC_BARGAIN"|"DYING"|"SMELLY"|"CHANNELING"|"GUARDIAN_ANGEL"|"SPIRIT_VISION"|"COMBAT"|"UNSHEATHED"|"FORCE_MOVE"|"REMORSE"|"CLIMBING"|"DISARMED"|"INCAPACITATED"|"PLAY_DEAD"|"STANCE"|"SHACKLES_OF_PAIN_CASTER"|"INSURFACE"|"CONSTRAINED"|"HEALING"|"INFUSED"|"HIT"|"BLIND"|"DEACTIVATED"|"EFFECT"|"TUTORIAL_BED"|"TELEPORT_FALLING"|"CONSUME"|"OVERPOWER"|"EXPLODE"|"COMBUSTION"|"REPAIR"|"POLYMORPHED"|"BOOST"|"HEAL_SHARING"|"CHARMED"|"DRAIN"|"DAMAGE"|"LINGERING_WOUNDS"|"AOO"|"INVISIBLE"|"ROTATE"|"INFECTIOUS_DISEASED"|"ENCUMBERED"|"FEAR"|"MATERIAL"
--- @alias SurfaceActionType string|"ZoneAction"|"CreatePuddleAction"|"ChangeSurfaceOnPathAction"|"PolygonSurfaceAction"|"ExtinguishFireAction"|"SwapSurfaceAction"|"TransformSurfaceAction"|"CreateSurfaceAction"|"RectangleSurfaceAction"
--- @alias SurfaceLayer string|"Ground"|"None"|"Cloud"
--- @alias SurfaceTransformActionType string|"Shatter"|"Purify"|"Oilify"|"Bless"|"Electrify"|"Condense"|"None"|"Vaporize"|"Freeze"|"Bloodify"|"Contaminate"|"Ignite"|"Melt"|"Curse"
--- @alias SurfaceType string|"WaterCloudPurified"|"WaterCloudElectrifiedPurified"|"PoisonCloudPurified"|"WaterElectrified"|"BloodElectrifiedBlessed"|"BloodCloudElectrifiedCursed"|"Sentinel"|"FireBlessed"|"WaterCloudElectrified"|"FireCursed"|"BloodCloudPurified"|"FirePurified"|"WaterFrozen"|"WaterFrozenCursed"|"WaterBlessed"|"BloodFrozenPurified"|"WaterCursed"|"BloodCloudElectrified"|"WaterPurified"|"SmokeCloudBlessed"|"WaterElectrifiedBlessed"|"BloodFrozen"|"BloodElectrifiedPurified"|"BloodBlessed"|"BloodFrozenBlessed"|"Lava"|"BloodCursed"|"Source"|"WaterCloudBlessed"|"BloodPurified"|"WaterCloudElectrifiedCursed"|"PoisonCloudBlessed"|"PoisonBlessed"|"Water"|"WaterFrozenPurified"|"PoisonCursed"|"FireCloud"|"PoisonPurified"|"FireCloudBlessed"|"WaterCloud"|"BloodCloudElectrifiedBlessed"|"OilBlessed"|"BloodCloud"|"BloodCloudBlessed"|"OilCursed"|"PoisonCloud"|"SmokeCloudCursed"|"Fire"|"WaterFrozenBlessed"|"OilPurified"|"BloodCloudElectrifiedPurified"|"SmokeCloud"|"BloodElectrifiedCursed"|"WebBlessed"|"ExplosionCloud"|"WebCursed"|"WaterCloudCursed"|"FrostCloud"|"Blood"|"WebPurified"|"PoisonCloudCursed"|"Web"|"CustomBlessed"|"WaterElectrifiedPurified"|"BloodElectrified"|"Poison"|"CustomCursed"|"CustomPurified"|"FireCloudPurified"|"Custom"|"FireCloudCursed"|"BloodCloudCursed"|"WaterCloudElectrifiedBlessed"|"SmokeCloudPurified"|"Deathfog"|"WaterElectrifiedCursed"|"ShockwaveCloud"|"BloodFrozenCursed"|"Oil"|"Deepwater"
--- @alias TemplateType string|"GlobalCacheTemplate"|"LevelCacheTemplate"|"RootTemplate"|"LocalTemplate"|"GlobalTemplate"
--- @alias TriggerTypeId string|"CrimeRegionTrigger"|"AIHintAreaTrigger"|"SpectatorTrigger"|"AtmosphereTrigger"|"MusicVolumeTrigger"|"CameraLockTrigger"|"PointTrigger"|"StatsAreaTrigger"|"RegionTrigger"|"AISeederTrigger"|"SecretRegionTrigger"|"AreaTrigger"|"CullTrigger"|"PointSoundTriggerDummy"|"EventTrigger"|"StartTrigger"|"TeleportTrigger"|"CrimeAreaTrigger"|"ExplorationTrigger"|"SoundVolumeTrigger"|"PointSoundTrigger"
--- @alias UIObjectFlags string|"OF_PlayerTextInput3"|"OF_Load"|"OF_DeleteOnChildDestroy"|"OF_PreventCameraMove"|"OF_PlayerTextInput4"|"OF_Loaded"|"OF_Visible"|"OF_PlayerTextInput1"|"OF_Activated"|"OF_PlayerInput1"|"OF_PlayerInput2"|"OF_RequestDelete"|"OF_PlayerInput3"|"OF_PlayerInput4"|"OF_DontHideOnDelete"|"OF_PlayerModal1"|"OF_PlayerModal2"|"OF_PlayerModal3"|"OF_PlayerModal4"|"OF_PlayerTextInput2"|"OF_KeepInScreen"|"OF_PauseRequest"|"OF_SortOnAdd"|"OF_KeepCustomInScreen"|"OF_FullScreen"|"OF_PrecacheUIData"
--- @alias VisualAttachmentFlags string|"BonusWeaponFX"|"WeaponOverlayFX"|"Wings"|"InheritAnimations"|"ParticleSystem"|"DestroyWithParent"|"Horns"|"ExcludeFromBounds"|"Armor"|"KeepScale"|"KeepRot"|"DoNotUpdate"|"Weapon"|"Overhead"|"UseLocalTransform"|"WeaponFX"
--- @alias VisualComponentFlags string|"ForceUseAnimationBlueprint"|"VisualSetLoaded"
--- @alias VisualFlags string|"IsShadowProxy"|"AllowReceiveDecalWhenAnimated"|"ReceiveDecal"|"Reflecting"|"CastShadow"
...
--- @alias EclCharacterFlags string|"CharacterCreationFinished"|"PartyFollower"|"VisionGridInvisible2"|"NoRotate"|"InCombat"|"VisualsUpdated"|"IsRunning"|"IsPlayer"|"WeaponSheathed"|"HasInventory"|"CanShootThrough"|"DisableSneaking"|"HasSkillTargetEffect"|"MovementUpdated"|"ReservedForDialog"|"GMControl"|"Floating"|"WalkThrough"|"Global"|"SpotSneakers"|"Activated"|"Dead"|"OffStage"|"NoCover"|"Multiplayer"|"IsHuge"|"InParty"|"HasOwner"|"InDialog"|"UseOverlayMaterials"|"Summon"|"VisionGridInvisible"|"CharCreationInProgress"|"StoryNPC"|"HasCustomVisualIndices"|"CannotMove"|"Invisible"
--- @alias EclEntityComponentIndex string|"CustomStats"|"Character"|"EquipmentVisualsComponent"|"LightProbe"|"ParentEntity"|"AiSeederTrigger"|"ContainerElement"|"Scenery"|"PingBeacon"|"GameMaster"|"Effect"|"SpectatorTrigger"|"Egg"|"AtmosphereTrigger"|"Visual"|"PublishingRequest"|"OverviewMap"|"Vignette"|"CameraLockTrigger"|"Net"|"PointTrigger"|"Spline"|"Light"|"RegionTrigger"|"SecretRegionTrigger"|"Container"|"CullTrigger"|"PointSoundTriggerDummy"|"Note"|"CustomStatDefinition"|"Item"|"Decal"|"Combat"|"Projectile"|"AnimationBlueprint"|"GMJournalNode"|"SoundVolumeTrigger"|"PointSoundTrigger"|"Sound"
--- @alias EclEntitySystemIndex string|"GameActionManager"|"GameMasterManager"|"GMJournalSystem"|"CustomStatsSystem"|"LightProbeManager"|"EncounterManager"|"CharacterManager"|"AnimationBlueprintSystem"|"AtmosphereManager"|"GameMasterCampaignManager"|"MusicManager"|"PublishingSystem"|"PingBeaconManager"|"VisualSystem"|"LightManager"|"DecalManager"|"SoundSystem"|"SeeThroughManager"|"GrannySystem"|"TurnManager"|"SceneryManager"|"ProjectileManager"|"PickingHelperManager"|"TriggerManager"|"ItemManager"|"EquipmentVisualsSystem"|"ContainerElementComponent"|"EggManager"|"ContainerComponentSystem"|"PhysXScene"|"SurfaceManager"|"CameraSplineSystem"|"LEDSystem"
--- @alias EclGameState string|"SwapLevel"|"LoadLevel"|"LoadModule"|"Unknown"|"LoadSession"|"LoadGMCampaign"|"UnloadLevel"|"Join"|"UnloadModule"|"UnloadSession"|"PrepareRunning"|"Disconnect"|"Exit"|"StartLoading"|"StopLoading"|"StartServer"|"Init"|"Installation"|"Idle"|"GameMasterPause"|"Lobby"|"ModReceiving"|"BuildStory"|"LoadLoca"|"Movie"|"Save"|"Menu"|"Paused"|"InitMenu"|"InitNetwork"|"InitConnection"|"Running"|"LoadMenu"
--- @alias EclItemFlags string|"Wadable"|"TeleportOnUse"|"IsCraftingIngredient"|"PinnedContainer"|"CanBePickedUp"|"Known"|"CanBeMoved"|"IsDoor"|"CoverAmount"|"CanShootThrough"|"MovementUpdated"|"EnableHighlights"|"Floating"|"Global"|"HideHP"|"FreezeGravity"|"Activated"|"Walkable"|"StoryItem"|"CanWalkThrough"|"DontAddToBottomBar"|"IsSourceContainer"|"WasOpened"|"Fade"|"PhysicsFlag1"|"InteractionDisabled"|"PhysicsFlag2"|"JoinedDialog"|"Registered"|"FoldDynamicStats"|"PhysicsFlag3"|"Destroyed"|"Hostile"|"IsLadder"|"Sticky"|"HasPendingNetUpdate"|"Unimportant"|"CanUse"|"Invulnerable"|"IsSecretDoor"|"Invisible"
...
--- @alias EclSceneryFlags string|"Wadable"|"CanShootThrough"|"Fadeable"|"SeeThrough"|"Walkable"|"Fade"|"IsWall"|"Destroyed"|"UnknownFlag80"|"UnknownFlag100"|"Invisible"
--- @alias EclSceneryRenderFlags string|"IsShadowProxy"|"UnknownRenderFlag20"|"AllowReceiveDecalWhenAnimated"|"ForceUseAnimationBlueprint"|"ReceiveDecals"|"CastShadow"|"UnknownRenderFlag1"|"IsReflecting"
--- @alias EclStatusFlags string|"Started"|"HasVisuals"|"KeepAlive"|"RequestDelete"
--- @alias EocCombatComponentFlags string|"IsBoss"|"InArena"|"CanFight"|"TurnEnded"|"CanJoinCombat"|"RequestTakeExtraTurn"|"CanGuard"|"IsInspector"|"IsTicking"|"Guarded"|"RequestEndTurn"|"CanForceEndTurn"|"FleeOnEndTurn"|"GuardOnEndTurn"|"EnteredCombat"|"TookExtraTurn"|"DelayDeathCount"|"CounterAttacked"|"RequestEnterCombat"
--- @alias EocSkillBarItemType string|"Skill"|"None"|"ItemTemplate"|"Action"|"Item"
--- @alias EsvActionStateType string|"Hit"|"Lockpick"|"PickUp"|"PrepareSkill"|"MoveItem"|"UseSkill"|"KnockedDown"|"Polymorphing"|"CombineItem"|"Identify"|"UseItem"|"TeleportFall"|"DisarmTrap"|"Die"|"Unsheath"|"Repair"|"Incapacitated"|"Sheath"|"JumpFlight"|"Idle"|"Drop"|"Animation"|"Attack"|"Summoning"
--- @alias EsvCharacterFlags string|"CharacterCreationFinished"|"PartyFollower"|"CharacterControl"|"DisableFlee_M"|"Temporary"|"DontCacheTemplate"|"IgnoresTriggers"|"InArena"|"NoRotate"|"IsCompanion_M"|"DisableCulling"|"GMReroll"|"Passthrough"|"IsPlayer"|"DeferredRemoveEscapist"|"CoverAmount"|"CanShootThrough"|"Loaded"|"ReservedForDialog"|"Floating"|"WalkThrough"|"SpotSneakers"|"Activated"|"FindValidPositionOnActivate"|"OffStage"|"Dead"|"ForceNonzeroSpeed"|"Totem"|"CustomLookEnabled"|"Multiplayer"|"LevelTransitionPending"|"HostControl"|"IsHuge"|"RegisteredForAutomatedDialog"|"InParty"|"HasOwner"|"InDialog"|"Deactivated"|"NeedsMakePlayerUpdate"|"Summon"|"CharCreationInProgress"|"Invulnerable"|"CannotDie"|"StoryNPC"|"FightMode"|"CannotMove"|"RequestStartTurn"|"CannotRun"
...
--- @alias EsvCharacterTransformFlags string|"ReplaceEquipment"|"DiscardOriginalDisplayName"|"ReplaceInventory"|"ReplaceCustomLooks"|"ReplaceScripts"|"ReplaceOriginalTemplate"|"ReplaceStats"|"Immediate"|"ReplaceTags"|"ReplaceCustomNameIcon"|"ReplaceScale"|"ReplaceSkills"|"ReplaceVoiceSet"|"ImmediateSync"|"ReplaceCurrentTemplate"|"DontCheckRootTemplate"|"ReleasePlayerData"|"SaveOriginalDisplayName"|"DontReplaceCombatState"
--- @alias EsvCharacterTransformType string|"TransformToTemplate"|"TransformToCharacter"
--- @alias EsvEntityComponentIndex string|"CustomStats"|"Character"|"CrimeRegionTrigger"|"EoCPointTrigger"|"EoCAreaTrigger"|"ContainerElement"|"GameMaster"|"AIHintAreaTrigger"|"Effect"|"Egg"|"AtmosphereTrigger"|"MusicVolumeTrigger"|"OverviewMap"|"Vignette"|"Net"|"StatsAreaTrigger"|"Spline"|"RegionTrigger"|"SecretRegionTrigger"|"Container"|"EventTrigger"|"Note"|"CustomStatDefinition"|"StartTrigger"|"Item"|"TeleportTrigger"|"CrimeAreaTrigger"|"Combat"|"Projectile"|"ExplorationTrigger"|"AnimationBlueprint"|"GMJournalNode"|"SoundVolumeTrigger"
--- @alias EsvEntitySystemIndex string|"GameActionManager"|"EffectManager"|"GameMasterManager"|"GMJournalSystem"|"RewardManager"|"CustomStatsSystem"|"CharacterManager"|"AnimationBlueprintSystem"|"GameMasterCampaignManager"|"NetEntityManager"|"ShroudManager"|"TurnManager"|"ProjectileManager"|"TriggerManager"|"ItemManager"|"EnvironmentalStatusManager"|"ContainerElementComponent"|"EggManager"|"ContainerComponentSystem"|"CharacterSplineSystem"|"SurfaceManager"|"SightManager"|"CameraSplineSystem"
--- @alias EsvGameState string|"LoadLevel"|"LoadModule"|"Sync"|"Unknown"|"LoadSession"|"LoadGMCampaign"|"UnloadLevel"|"UnloadModule"|"UnloadSession"|"Disconnect"|"Exit"|"Init"|"Installation"|"Idle"|"GameMasterPause"|"BuildStory"|"Save"|"Paused"|"Uninitialized"|"Running"|"ReloadStory"
--- @alias EsvItemFlags string|"SourceContainer"|"TeleportOnUse"|"PinnedContainer"|"Frozen"|"CanBePickedUp"|"Known"|"CanBeMoved"|"CanOnlyBeUsedByOwner"|"IsDoor"|"WalkOn"|"CanShootThrough"|"ReservedForDialog"|"WalkThrough"|"Floating"|"HideHP"|"FreezeGravity"|"IsSurfaceBlocker"|"Activated"|"StoryItem"|"InAutomatedDialog"|"OffStage"|"NoCover"|"Totem"|"LoadedTemplate"|"InteractionDisabled"|"ClientSync1"|"IsContainer"|"ForceSync"|"Destroy"|"Invisible2"|"Destroyed"|"Summon"|"DisableSync"|"IsSurfaceCloudBlocker"|"IsLadder"|"Sticky"|"DontAddToHotbar"|"CanUse"|"Invulnerable"|"PositionChanged"|"GMFolding"|"TransformChanged"|"IsSecretDoor"|"WakePhysics"|"Invulnerable2"|"ForceClientSync"|"Invisible"|"ClientSync2"
--- @alias EsvItemFlags2 string|"CanConsume"|"IsKey"|"UnsoldGenerated"|"UnEquipLocked"|"Global"|"UseRemotely"|"TreasureGenerated"
...
--- @alias EsvStatusControllerFlags string|"PlayingDeathAnimation"|"HitAnimationFlag2b"|"CancelCurrentAction"|"Dying"|"KnockedDown"|"EndTurn"|"Polymorphing"|"PlayHitAnimation"|"CancelCurrentAction2"|"Incapacitated"|"JumpFlight"|"HitAnimationFlag1"|"PlayHitStillAnimation"|"TeleportFalling"|"HitAnimationFlag2"|"CombatReady"|"SheathWeapon"|"UnsheathWeapon"|"HitAnimationFlag3"|"SteerToEnemy"|"CancelSkill"|"Summoning"
...
--- @alias EsvTaskType string|"Appear"|"Wander"|"MoveItem"|"UseSkill"|"UseItem"|"MoveToLocation"|"MoveToObject"|"MoveInRange"|"Disappear"|"FollowNPC"|"PlayAnimation"|"PickupItem"|"Steer"|"Drop"|"Resurrect"|"TeleportToLocation"|"MoveToAndTalk"|"Flee"|"Attack"
--- @alias StatsAbilityType string|"Ranged"|"Polymorph"|"PainReflection"|"Telekinesis"|"WaterSpecialist"|"Sentinel"|"Barter"|"Sulfurology"|"Sourcery"|"Crafting"|"Thievery"|"Wand"|"Loremaster"|"Reflexes"|"Repair"|"Sneaking"|"RangerLore"|"RogueLore"|"Reason"|"Persuasion"|"Intimidate"|"Leadership"|"DualWielding"|"Pickpocket"|"Perseverance"|"PhysicalArmorMastery"|"VitalityMastery"|"Shield"|"Luck"|"SingleHanded"|"TwoHanded"|"WarriorLore"|"AirSpecialist"|"EarthSpecialist"|"Brewmaster"|"MagicArmorMastery"|"FireSpecialist"|"Charm"|"Runecrafting"|"Necromancy"|"Summoning"
--- @alias StatsArmorType string|"Robe"|"Sentinel"|"None"|"Cloth"|"Plate"|"Leather"|"Mail"
--- @alias StatsCharacterFlags string|"DrinkedPotion"|"IsPlayer"|"InParty"|"EquipmentValidated"|"IsSneaking"|"Invisible"|"Blind"
--- @alias StatsCharacterStatGetterType string|"Strength"|"APStart"|"Intelligence"|"Constitution"|"CorrosiveResistance"|"Sight"|"PoisonResistance"|"LifeSteal"|"ChanceToHitBoost"|"Initiative"|"APMaximum"|"APRecovery"|"ShadowResistance"|"BlockChance"|"Wits"|"Accuracy"|"Movement"|"PiercingResistance"|"FireResistance"|"EarthResistance"|"MaxMp"|"WaterResistance"|"CustomResistance"|"Memory"|"AirResistance"|"MagicResistance"|"DamageBoost"|"CriticalChance"|"PhysicalResistance"|"Dodge"|"Hearing"|"Finesse"
--- @alias StatsCriticalRoll string|"Critical"|"NotCritical"|"Roll"
--- @alias StatsDamageType string|"Piercing"|"Physical"|"Corrosive"|"Chaos"|"Shadow"|"Sentinel"|"Earth"|"Magic"|"None"|"Water"|"Fire"|"Poison"|"Sulfuric"|"Air"
--- @alias StatsDeathType string|"Piercing"|"Physical"|"Sentinel"|"KnockedDown"|"DoT"|"None"|"Explode"|"Acid"|"Incinerate"|"Arrow"|"Electrocution"|"FrozenShatter"|"Hang"|"Surrender"|"Lifetime"|"PetrifiedShatter"|"Sulfur"
...
--- @alias StatsHitFlag string|"Flanking"|"CriticalHit"|"Backstab"|"DamagedPhysicalArmor"|"Hit"|"FromSetHP"|"NoDamageOnOwner"|"DamagedVitality"|"Missed"|"DontCreateBloodSurface"|"CounterAttack"|"Poisoned"|"Reflection"|"Bleeding"|"DoT"|"NoEvents"|"ProcWindWalker"|"PropagatedFromOwner"|"FromShacklesOfPain"|"Blocked"|"Dodged"|"Surface"|"DamagedMagicArmor"|"Burning"
--- @alias StatsHitType string|"Ranged"|"DoT"|"Magic"|"Surface"|"Melee"|"WeaponDamage"|"Reflected"
--- @alias StatsItemSlot string|"Helmet"|"Amulet"|"Wings"|"Sentinel"|"Ring"|"Breast"|"Ring2"|"Horns"|"Shield"|"Leggings"|"Boots"|"Weapon"|"Gloves"|"Overhead"|"Belt"
--- @alias StatsItemSlot32 string|"Helmet"|"Amulet"|"Wings"|"Sentinel"|"Ring"|"Breast"|"Ring2"|"Horns"|"Shield"|"Leggings"|"Boots"|"Weapon"|"Gloves"|"Overhead"|"Belt"
...
--- @alias StatsRequirementType string|"Ranged"|"Polymorph"|"TALENT_FireSpells"|"TALENT_Reason"|"TALENT_WarriorLoreNaturalResistance"|"TALENT_Elf_CorpseEater"|"TALENT_Sadist"|"TALENT_MagicCycles"|"Strength"|"PainReflection"|"TALENT_AttackOfOpportunity"|"TALENT_Luck"|"TALENT_AvoidDetection"|"TALENT_Sourcerer"|"TALENT_Haymaker"|"Intelligence"|"Telekinesis"|"TALENT_ItemMovement"|"TALENT_Escapist"|"TALENT_WhatARush"|"TALENT_RogueLoreDaggerBackStab"|"TRAIT_Compassionate"|"TALENT_WildMag"|"Constitution"|"WaterSpecialist"|"TALENT_ResistFear"|"TALENT_Raistlin"|"TALENT_GoldenMage"|"Barter"|"TALENT_ExtraSkillPoints"|"TALENT_ResurrectToFullHealth"|"TALENT_Leech"|"TALENT_Human_Inventive"|"TALENT_Soulcatcher"|"Sourcery"|"TALENT_Intimidate"|"TALENT_Bully"|"TALENT_RogueLoreHoldResistance"|"TALENT_ViolentMagic"|"Tag"|"Crafting"|"TALENT_LightStep"|"TALENT_LoneWolf"|"TRAIT_Independent"|"Thievery"|"Wand"|"TALENT_ActionPoints2"|"TALENT_FiveStarRestaurant"|"TALENT_Politician"|"TALENT_Zombie"|"Loremaster"|"TALENT_ResistSilence"|"TALENT_Demon"|"TALENT_Kickstarter"|"TALENT_WarriorLoreGrenadeRange"|"TALENT_Gladiator"|"TALENT_WaterSpells"|"TALENT_IceKing"|"TALENT_Perfectionist"|"Reflexes"|"TALENT_AnimalEmpathy"|"TALENT_Stench"|"TALENT_WarriorLoreNaturalHealth"|"TRAIT_Vindictive"|"Repair"|"Sneaking"|"TALENT_ItemCreation"|"TALENT_FaroutDude"|"TALENT_Elf_Lore"|"TALENT_Lizard_Persuasion"|"RangerLore"|"TALENT_ResistKnockdown"|"TALENT_WalkItOff"|"TALENT_Memory"|"None"|"RogueLore"|"TALENT_Durability"|"TALENT_RangerLoreEvasionBonus"|"TALENT_Dwarf_Sneaking"|"TALENT_Torturer"|"TALENT_MasterThief"|"Reason"|"Persuasion"|"TALENT_Initiative"|"TALENT_LivingArmor"|"TALENT_Unstable"|"Intimidate"|"TALENT_Scientist"|"TRAIT_Forgiving"|"TRAIT_Materialistic"|"Wits"|"Leadership"|"TALENT_Criticals"|"TALENT_WeatherProof"|"TALENT_RogueLoreDaggerAPBonus"|"TRAIT_Bold"|"DualWielding"|"TALENT_ResistDead"|"TALENT_ExtraWandCharge"|"TRAIT_Timid"|"TALENT_Indomitable"|"Pickpocket"|"Perseverance"|"TALENT_ChanceToHitRanged"|"TALENT_AirSpells"|"TALENT_Executioner"|"TRAIT_Obedient"|"PhysicalArmorMastery"|"TALENT_Flanking"|"TALENT_StandYourGround"|"TALENT_RogueLoreMovementBonus"|"TRAIT_Altruistic"|"TRAIT_Pragmatic"|"TALENT_Backstab"|"TALENT_ChanceToHitMelee"|"TALENT_ElementalRanger"|"TRAIT_Romantic"|"Shield"|"Luck"|"TALENT_Trade"|"TALENT_ResistStun"|"TALENT_ElementalAffinity"|"TALENT_FolkDancer"|"TRAIT_Spiritual"|"TALENT_Lockpick"|"TALENT_Awareness"|"TALENT_NoAttackOfOpportunity"|"TALENT_Dwarf_Sturdy"|"TRAIT_Righteous"|"TALENT_GreedyVessel"|"Memory"|"SingleHanded"|"TALENT_Damage"|"TALENT_InventoryAccess"|"TALENT_Ambidextrous"|"TRAIT_Renegade"|"Level"|"TwoHanded"|"TALENT_Sight"|"TALENT_MrKnowItAll"|"TALENT_WarriorLoreNaturalArmor"|"TRAIT_Blunt"|"TRAIT_Considerate"|"Combat"|"WarriorLore"|"TALENT_IncreasedArmor"|"TALENT_Carry"|"TALENT_Courageous"|"TALENT_RogueLoreGrenadePrecision"|"TALENT_DualWieldingDodging"|"TRAIT_Heartless"|"AirSpecialist"|"TALENT_Kinetics"|"TALENT_ExtraStatPoints"|"TALENT_Human_Civil"|"MinKarma"|"TALENT_Jitterbug"|"EarthSpecialist"|"TALENT_Repair"|"TALENT_EarthSpells"|"TALENT_RangerLoreArrowRecover"|"TALENT_QuickStep"|"MaxKarma"|"MagicArmorMastery"|"Vitality"|"FireSpecialist"|"Charm"|"TALENT_ExpGain"|"TALENT_SurpriseAttack"|"TALENT_Lizard_Resistance"|"TRAIT_Egotistical"|"Immobile"|"Necromancy"|"TALENT_ActionPoints"|"TALENT_Vitality"|"TALENT_LightningRod"|"Finesse"|"Summoning"|"TALENT_ResistPoison"|"TALENT_Charm"|"TALENT_SpillNoBlood"|"TALENT_RangerLoreRangedAPBonus"|"TALENT_Elementalist"
--- @alias StatsTalentType string|"Flanking"|"MrKnowItAll"|"Lizard_Persuasion"|"Backstab"|"WhatARush"|"Human_Inventive"|"ResurrectExtraHealth"|"Lockpick"|"ChanceToHitMelee"|"FaroutDude"|"Human_Civil"|"WildMag"|"ActionPoints2"|"ExpGain"|"ElementalRanger"|"RangerLoreEvasionBonus"|"WandCharge"|"Dwarf_Sneaking"|"Criticals"|"Durability"|"LightningRod"|"WarriorLoreGrenadeRange"|"Dwarf_Sturdy"|"IncreasedArmor"|"Sight"|"Politician"|"Elf_Lore"|"Quest_SpidersKiss_Per"|"ResistFear"|"WeatherProof"|"Demon"|"Perfectionist"|"ResistKnockdown"|"FiveStarRestaurant"|"LoneWolf"|"Executioner"|"ResistStun"|"RogueLoreMovementBonus"|"ViolentMagic"|"ActionPoints"|"ResistPoison"|"Lizard_Resistance"|"QuickStep"|"Sadist"|"ResistSilence"|"Carry"|"Initiative"|"BeastMaster"|"NaturalConductor"|"ResistDead"|"Repair"|"ExtraSkillPoints"|"Quest_GhostTree"|"Throwing"|"WarriorLoreNaturalResistance"|"RangerLoreRangedAPBonus"|"LivingArmor"|"None"|"Zombie"|"DualWieldingDodging"|"Torturer"|"Reason"|"Quest_SpidersKiss_Null"|"Ambidextrous"|"ItemMovement"|"AttackOfOpportunity"|"ExtraStatPoints"|"Intimidate"|"Unstable"|"AnimalEmpathy"|"WarriorLoreNaturalArmor"|"Quest_Rooted"|"Rager"|"Trade"|"Awareness"|"RogueLoreHoldResistance"|"PainDrinker"|"Max"|"Escapist"|"Quest_SpidersKiss_Str"|"Sourcerer"|"Damage"|"FireSpells"|"DeathfogResistant"|"Elementalist"|"WaterSpells"|"ResurrectToFullHealth"|"Bully"|"Haymaker"|"AirSpells"|"Luck"|"RogueLoreDaggerAPBonus"|"Gladiator"|"EarthSpells"|"Elf_CorpseEating"|"Indomitable"|"InventoryAccess"|"Stench"|"Memory"|"Quest_TradeSecrets"|"Jitterbug"|"ChanceToHitRanged"|"AvoidDetection"|"Soulcatcher"|"Kickstarter"|"RangerLoreArrowRecover"|"MasterThief"|"StandYourGround"|"Courageous"|"WarriorLoreNaturalHealth"|"NoAttackOfOpportunity"|"GreedyVessel"|"SurpriseAttack"|"Leech"|"GoldenMage"|"Quest_SpidersKiss_Int"|"MagicCycles"|"Vitality"|"Charm"|"LightStep"|"WalkItOff"|"Scientist"|"ElementalAffinity"|"FolkDancer"|"RogueLoreGrenadePrecision"|"ItemCreation"|"Raistlin"|"IceKing"|"SpillNoBlood"|"RogueLoreDaggerBackStab"
--- @alias StatsWeaponType string|"Club"|"Bow"|"Sentinel"|"Wand"|"Rifle"|"None"|"Knife"|"Sword"|"Crossbow"|"Axe"|"Staff"|"Arrow"|"Spear"

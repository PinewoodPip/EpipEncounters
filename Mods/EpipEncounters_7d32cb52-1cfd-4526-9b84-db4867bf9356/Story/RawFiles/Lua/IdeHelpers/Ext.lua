...
--- @alias ActionDataType string|"Consume"|"Repair"|"Ladder"|"ShowStoryElementUI"|"OpenClose"|"Teleport"|"CreateSurface"|"StoryUse"|"KickstarterMessageInABottle"|"PlaySound"|"CreatePuddle"|"Destroy"|"UseSkill"|"SkillBook"|"StoryUseInInventoryOnly"|"Identify"|"DisarmTrap"|"Sticky"|"Craft"|"SpawnCharacter"|"DestroyParameters"|"Lying"|"Constrain"|"Door"|"Pyramid"|"Lockpick"|"Unknown"|"StoryUseInInventory"|"Book"|"Recipe"|"Equip"|"Sit"
--- @alias AiActionStep string|"Init"|"CalculateStandardAttack"|"ScoreActionsFallback"|"CalculateSkills"|"CalculateItems"|"CalculatePositionScores"|"SortActions"|"ScoreActions"|"ReevaluateActions"|"ScoreActionsAPSaving"|"CollectPossibleActions"|"CalculateFutureScores"|"ScoreActionsBehavior"
--- @alias AiActionType string|"Consume"|"None"|"StandardAttack"|"FallbackCommand"|"Skill"
--- @alias AiModifier string|"MULTIPLIER_DOT_ENEMY_POS"|"MULTIPLIER_DOT_ALLY_NEG"|"MULTIPLIER_ARMOR_NEUTRAL_NEG"|"MULTIPLIER_DECAYING_TOUCH"|"MULTIPLIER_DESTROY_INTERESTING_ITEM"|"MULTIPLIER_CRITICAL"|"MULTIPLIER_MAGICAL_SULFUR"|"MULTIPLIER_CONTROL_ENEMY_NEG"|"MULTIPLIER_ENDPOS_ALLIES_NEARBY"|"DANGEROUS_ITEM_NEARBY"|"MULTIPLIER_AP_COSTBOOST"|"MULTIPLIER_DAMAGE_NEUTRAL_NEG"|"MULTIPLIER_BOOST_NEUTRAL_POS"|"MULTIPLIER_ACTION_COST_MULTIPLIER"|"MULTIPLIER_VITALITYBOOST"|"MULTIPLIER_KILL_ENEMY"|"MULTIPLIER_SECONDARY_ATTRIB"|"MULTIPLIER_MAGICAL_SULFUR_CURRENTLY_DAM"|"UNSTABLE_BOMB_RADIUS"|"MULTIPLIER_DOT_NEUTRAL_POS"|"MULTIPLIER_INVISIBLE_MOVEMENT_COST_MULT"|"MULTIPLIER_TARGET_MY_ENEMY"|"MULTIPLIER_INVISIBLE"|"AVENGE_ME_VITALITY_LEVEL"|"MULTIPLIER_DOT_SELF_POS"|"MULTIPLIER_CONTROL_ALLY_NEG"|"MULTIPLIER_TARGET_HOSTILE_COUNT_ONE"|"MULTIPLIER_ENDPOS_FLANKED"|"MULTIPLIER_GUARDIAN_ANGEL"|"MULTIPLIER_RESURRECT"|"MULTIPLIER_HEAL_SELF_NEG"|"MULTIPLIER_HOT_ALLY_NEG"|"MULTIPLIER_ARMOR_SELF_POS"|"MULTIPLIER_ENDPOS_NOT_IN_DANGEROUS_SURF"|"MULTIPLIER_KILL_ENEMY_SUMMON"|"MULTIPLIER_AP_RECOVERY"|"MIN_TURNS_SCORE_EXISTING_STATUS"|"MULTIPLIER_HOT_ENEMY_POS"|"MULTIPLIER_TARGET_SUMMON"|"MAX_HEAL_MULTIPLIER"|"MULTIPLIER_STATUS_CANCEL_SLEEPING"|"MULTIPLIER_GROUNDED"|"MULTIPLIER_DAMAGE_SELF_POS"|"MULTIPLIER_CONTROL_NEUTRAL_NEG"|"MULTIPLIER_ENDPOS_NOT_IN_SMOKE"|"MULTIPLIER_KNOCKDOWN"|"MULTIPLIER_DAMAGE_ON_MOVE"|"MULTIPLIER_HEAL_ENEMY_NEG"|"MULTIPLIER_ARMOR_ENEMY_POS"|"SURFACE_DAMAGE_MAX_TURNS"|"MULTIPLIER_WINDWALKER"|"MULTIPLIER_PUDDLE_RADIUS"|"ENABLE_ACTIVE_DEFENSE_OFFENSIVE_USE"|"MULTIPLIER_HOT_SELF_POS"|"MULTIPLIER_HOT_NEUTRAL_POS"|"MULTIPLIER_MOVEMENT_COST_MULTPLIER"|"MULTIPLIER_TARGET_IN_SIGHT"|"MULTIPLIER_ACC_BOOST"|"MULTIPLIER_DAMAGE_ENEMY_POS"|"MULTIPLIER_BOOST_SELF_NEG"|"MULTIPLIER_CANNOT_EXECUTE_THIS_TURN"|"FALLBACK_ALLIES_NEARBY"|"MOVESKILL_AP_DIFF_REQUIREMENT"|"SKILL_TELEPORT_MINIMUM_DISTANCE"|"MULTIPLIER_SOURCE_POINT"|"MULTIPLIER_HEAL_ALLY_NEG"|"MULTIPLIER_ARMOR_ALLY_POS"|"MULTIPLIER_ENDPOS_TURNED_INVISIBLE"|"MULTIPLIER_KILL_ALLY"|"MULTIPLIER_STATUS_FAILED"|"MULTIPLIER_DEFLECT_PROJECTILES"|"TARGET_WEAK_ALLY"|"MULTIPLIER_CONTROL_SELF_POS"|"MULTIPLIER_TARGET_KNOCKED_DOWN"|"MULTIPLIER_STATUS_CANCEL_INVISIBILITY"|"MULTIPLIER_SOURCE_MUTE"|"MULTIPLIER_DAMAGE_ALLY_POS"|"MULTIPLIER_DOT_SELF_NEG"|"MULTIPLIER_BOOST_ENEMY_NEG"|"MULTIPLIER_SCORE_ON_ALLY"|"MULTIPLIER_ADD_ARMOR"|"MULTIPLIER_REMOVE_MAGIC_ARMOR"|"MULTIPLIER_SUMMON_PATH_INFLUENCES"|"MULTIPLIER_HEAL_NEUTRAL_NEG"|"MULTIPLIER_ARMOR_NEUTRAL_POS"|"MULTIPLIER_FREE_ACTION"|"MULTIPLIER_SHACKLES_OF_PAIN"|"MULTIPLIER_AP_BOOST"|"MULTIPLIER_POS_SECONDARY_SURFACE"|"MULTIPLIER_REFLECT_DAMAGE"|"SCORE_MOD"|"MULTIPLIER_CONTROL_ENEMY_POS"|"MULTIPLIER_TARGET_UNPREFERRED"|"MULTIPLIER_DAMAGEBOOST"|"MULTIPLIER_SHIELD_BLOCK"|"MULTIPLIER_DAMAGE_NEUTRAL_POS"|"MULTIPLIER_BOOST_ALLY_NEG"|"MULTIPLIER_HIGH_ITEM_AMOUNT_MULTIPLIER"|"MAX_HEAL_SELF_MULTIPLIER"|"MULTIPLIER_CHARMED"|"MULTIPLIER_FEAR"|"MULTIPLIER_MOVEMENT_BOOST"|"MULTIPLIER_DOT_ENEMY_NEG"|"MULTIPLIER_COOLDOWN_MULTIPLIER"|"MULTIPLIER_ENDPOS_HEIGHT_DIFFERENCE"|"MULTIPLIER_MUTE"|"MULTIPLIER_SPARK"|"MULTIPLIER_FIRST_ACTION_BUFF"|"MULTIPLIER_HOT_SELF_NEG"|"MULTIPLIER_CONTROL_ALLY_POS"|"MULTIPLIER_ENDPOS_STENCH"|"MULTIPLIER_SURFACE_STATUS_ON_MOVE"|"MULTIPLIER_DODGE_BOOST"|"BUFF_DIST_MAX"|"MULTIPLIER_HEAL_SELF_POS"|"MULTIPLIER_BOOST_NEUTRAL_NEG"|"FALLBACK_ENEMIES_NEARBY"|"MULTIPLIER_BONUS_WEAPON_BOOST"|"MULTIPLIER_SP_COSTBOOST"|"MULTIPLIER_CONTACT_BOOST"|"MULTIPLIER_COMBO_SCORE_POSITIONING"|"BUFF_DIST_MIN"|"MULTIPLIER_DOT_NEUTRAL_NEG"|"MULTIPLIER_TARGET_MY_HOSTILE"|"MULTIPLIER_LOSE_CONTROL"|"AVENGE_ME_RADIUS"|"MULTIPLIER_CONTROL_NEUTRAL_POS"|"MULTIPLIER_ENDPOS_NOT_IN_AIHINT"|"MULTIPLIER_HEAL_SHARING"|"MULTIPLIER_ACTIVE_DEFENSE"|"MULTIPLIER_HEAL_ENEMY_POS"|"MULTIPLIER_DOT_ALLY_POS"|"MULTIPLIER_ARMOR_SELF_NEG"|"MULTIPLIER_LOW_ITEM_AMOUNT_MULTIPLIER"|"MULTIPLIER_KILL_ALLY_SUMMON"|"MULTIPLIER_REMOVE_ARMOR"|"TURNS_REPLACEMENT_INFINITE"|"MULTIPLIER_HOT_ENEMY_NEG"|"MULTIPLIER_TARGET_AGGRO_MARKED"|"ENDPOS_NEARBY_DISTANCE"|"MULTIPLIER_ENDPOS_ENEMIES_NEARBY"|"MULTIPLIER_AP_MAX"|"MULTIPLIER_DAMAGE_SELF_NEG"|"MULTIPLIER_BOOST_SELF_POS"|"FALLBACK_WANTED_ENEMY_DISTANCE"|"MULTIPLIER_ARMORBOOST"|"MULTIPLIER_EXPLOSION_DISTANCE_MIN"|"SKILL_JUMP_MINIMUM_DISTANCE"|"UNSTABLE_BOMB_NEARBY"|"MULTIPLIER_HEAL_ALLY_POS"|"MULTIPLIER_ARMOR_ENEMY_NEG"|"MULTIPLIER_STATUS_REMOVE"|"MULTIPLIER_BLIND"|"MULTIPLIER_COMBO_SCORE_INTERACTION"|"MULTIPLIER_POSITION_LEAVE"|"MULTIPLIER_HOT_NEUTRAL_NEG"|"MULTIPLIER_TARGET_INCAPACITATED"|"MULTIPLIER_DEATH_RESIST"|"MULTIPLIER_DAMAGE_ENEMY_NEG"|"MULTIPLIER_HOT_ALLY_POS"|"MULTIPLIER_BOOST_ENEMY_POS"|"MULTIPLIER_SCORE_ON_NEUTRAL"|"MULTIPLIER_ADD_MAGIC_ARMOR"|"MULTIPLIER_RESISTANCE"|"CHARMED_MAX_CONSUMABLES_PER_TURN"|"MULTIPLIER_HEAL_NEUTRAL_POS"|"MULTIPLIER_ARMOR_ALLY_NEG"|"MULTIPLIER_SOURCE_COST_MULTIPLIER"|"MAX_SCORE_ON_NEUTRAL"|"MULTIPLIER_STATUS_OVERWRITE"|"MULTIPLIER_MAIN_ATTRIB"|"ENABLE_SAVING_ACTION_POINTS"|"MULTIPLIER_CONTROL_SELF_NEG"|"MULTIPLIER_TARGET_HOSTILE_COUNT_TWO_OR_"|"MULTIPLIER_TARGET_PREFERRED"|"MULTIPLIER_INCAPACITATE"|"MULTIPLIER_DAMAGE_ALLY_NEG"|"MULTIPLIER_BOOST_ALLY_POS"|"MOVESKILL_ITEM_AP_DIFF_REQUIREMENT"|"MULTIPLIER_SCORE_OUT_OF_COMBAT"|"MULTIPLIER_DISARMED"|"MULTIPLIER_SURFACE_REMOVE"
--- @alias AiScoreReasonFlags string|"BreakInvisibility"|"BreakInvisibilityForNoEnemies"|"KillSelf"|"ScoreTooLow"|"TooComplex"|"CannotTargetFrozen"|"NoMovement"|"StupidInvisibility"|"ResurrectOutOfCombat"|"MustStayInAiHint"|"ResurrectByCharmedPlayer"|"TooFar"|"MoveSkillCannotExecute"|"TargetBlocked"|"RemoveMadnessSelf"
--- @alias CauseType string|"None"|"GM"|"Offhand"|"Attack"|"SurfaceMove"|"SurfaceCreate"|"SurfaceStatus"|"StatusEnter"|"StatusTick"
--- @alias CraftingStationType string|"None"|"Misc2"|"Well"|"Misc4"|"Anvil"|"Beehive"|"Wetstone"|"Misc1"|"BoilingPot"|"SpinningWheel"|"Cauldron"|"Misc3"|"Oven"
--- @alias ESurfaceFlag string|"Deathfog"|"Lava"|"ShockwaveCloud"|"CloudSurfaceBlock"|"Source"|"MovementBlock"|"ProjectileBlock"|"Water"|"FireCloud"|"HasCharacter"|"WaterCloud"|"Blessed"|"Occupied"|"BloodCloud"|"SurfaceExclude"|"PoisonCloud"|"Fire"|"Sulfurium"|"SmokeCloud"|"ExplosionCloud"|"CloudBlessed"|"FrostCloud"|"CloudCursed"|"CloudElectrified"|"Blood"|"Purified"|"CloudPurified"|"Web"|"Electrified"|"SomeDecay"|"Poison"|"Irreplaceable"|"HasInteractableObject"|"HasItem"|"Oil"|"Deepwater"|"ElectrifiedDecay"|"Frozen"|"GroundSurfaceBlock"|"IrreplaceableCloud"|"Cursed"
--- @alias ExtComponentType string|"ClientCharacter"|"ClientItem"|"Max"|"Combat"|"ServerCharacter"|"ServerItem"|"ServerCustomStatDefinition"|"ServerProjectile"
...
--- @alias HealEffect string|"Heal"|"Script"|"HealSharingReflected"|"None"|"Surface"|"Necromantic"|"ResistDeath"|"Behavior"|"Unknown4"|"Lifesteal"|"NegativeDamage"|"Unknown9"|"HealSharing"|"Sitting"
--- @alias IngredientTransformType string|"Consume"|"None"|"Poison"|"Boost"|"Transform"
--- @alias IngredientType string|"Category"|"None"|"Object"|"Property"
--- @alias InputModifier string|"Ctrl"|"Gui"|"Alt"|"Shift"
--- @alias InputRawType string|"backspace"|"i"|"f14"|"up"|"lgui"|"rightstick_yneg"|"capslock"|"t"|"kp_0"|"motion"|"lefttrigger"|"item9"|"printscreen"|"dot"|"num9"|"f5"|"righttrigger"|"scrolllock"|"k"|"f16"|"kp_1"|"rshift"|"controller_a"|"delete_key"|"num0"|"v"|"controller_b"|"item11"|"pagedown"|"b"|"f7"|"controller_x"|"guide"|"semicolon"|"m"|"f18"|"kp_3"|"rgui"|"controller_y"|"item2"|"insert"|"leftbracket"|"num2"|"x"|"right"|"leftstick"|"tab"|"backslash"|"d"|"f9"|"rightstick"|"rightbracket"|"o"|"f20"|"kp_5"|"left2"|"leftshoulder"|"item4"|"pageup"|"apostrophe"|"num4"|"z"|"rightshoulder"|"f"|"f11"|"kp_divide"|"lctrl"|"dpad_up"|"dpad_down"|"enter"|"q"|"f22"|"kp_multiply"|"kp_7"|"right2"|"dpad_left"|"item6"|"num6"|"f2"|"kp_minus"|"dpad_right"|"h"|"f13"|"kp_enter"|"lalt"|"touch_tap"|"s"|"f24"|"kp_9"|"kp_period"|"x2"|"touch_hold"|"item8"|"dash"|"num8"|"f4"|"motion_xneg"|"touch_pinch_in"|"j"|"f15"|"rctrl"|"motion_ypos"|"touch_pinch_out"|"space"|"u"|"down"|"motion_xpos"|"touch_rotate"|"item10"|"slash"|"a"|"f6"|"motion_yneg"|"back"|"touch_flick"|"end"|"l"|"f17"|"kp_2"|"ralt"|"wheel_xpos"|"touch_press"|"item1"|"pause"|"num1"|"w"|"wheel_xneg"|"c"|"f8"|"wheel_ypos"|"start"|"n"|"f19"|"kp_4"|"mode"|"wheel_yneg"|"item3"|"home"|"num3"|"y"|"left"|"kp_plus"|"leftstick_xneg"|"tilde"|"e"|"f10"|"leftstick_ypos"|"p"|"f21"|"kp_6"|"middle"|"leftstick_xpos"|"item5"|"num5"|"f1"|"leftstick_yneg"|"g"|"f12"|"numlock"|"lshift"|"rightstick_xneg"|"escape"|"equals"|"r"|"f23"|"kp_8"|"x1"|"rightstick_ypos"|"item7"|"comma"|"num7"|"f3"|"rightstick_xpos"
--- @alias InputState string|"Pressed"|"Released"
--- @alias InputType string|"Repeat"|"Release"|"Unknown"|"Hold"|"AcceleratedRepeat"|"Press"|"ValueChange"
--- @alias ItemDataRarity string|"Rare"|"Sentinel"|"Unique"|"Common"|"Divine"|"Uncommon"|"Legendary"|"Epic"
--- @alias LuaTypeId string|"Set"|"Function"|"Boolean"|"String"|"Tuple"|"Object"|"Module"|"Array"|"Void"|"Unknown"|"Map"|"Enumeration"|"Integer"|"Any"|"Nullable"|"Float"
--- @alias MultiEffectHandlerFlags string|"Detach"|"Beam"|"FaceSource"|"FollowScale"|"EffectAttached"|"KeepRot"
--- @alias NetMessage string|"NETMSG_CHARACTER_ACTION_DATA"|"NETMSG_PARTYUPDATE"|"NETMSG_INVENTORY_LOCKSTATE_SYNC"|"NETMSG_TURNBASED_ROUND"|"NETMSG_SECRET_UPDATE"|"NETMSG_DIALOG_STATE_MESSAGE"|"NETMSG_GM_CHANGE_NAME"|"NETMSG_CHARACTERCREATION_READY"|"NETMSG_RUNECRAFT"|"NETMSG_ACHIEVEMENT_UNLOCKED_MESSAGE"|"NETMSG_SHOW_ERROR"|"NETMSG_CLIENT_JOINED"|"NETMSG_CHARACTER_LOCK_ABILITY"|"NETMSG_SKILL_LEARN"|"NETMSG_MYSTERY_STATE"|"NETMSG_GM_SYNC_OVERVIEW_MAPS"|"NETMSG_GM_REMOVE_STATUS"|"NETMSG_UNLOCK_ITEM"|"NETMSG_LOBBY_SPECTATORUPDATE"|"NETMSG_CUSTOM_STATS_DEFINITION_UPDATE"|"NETMSG_HOST_REFUSEPLAYER"|"NETMSG_SKIPMOVIE_RESULT"|"NETMSG_ITEM_MOVE_TO_INVENTORY"|"NETMSG_FORCE_SHEATH"|"NETMSG_OPEN_MESSAGE_BOX_MESSAGE"|"NETMSG_GM_ITEM_CHANGE"|"NETMSG_GM_EDIT_CHARACTER"|"NETMSG_CAMERA_ACTIVATE"|"NETMSG_LOBBY_COMMAND"|"NETMSG_CHARACTER_STATUS"|"NETMSG_CHARACTER_STATUS_LIFETIME"|"NETMSG_CHARACTER_SET_STORY_NAME"|"NETMSG_ITEM_ACTION"|"NETMSG_PROJECTILE_EXPLOSION"|"NETMSG_ALIGNMENT_CLEAR"|"NETMSG_OPEN_CUSTOM_BOOK_UI_MESSAGE"|"NETMSG_DIALOG_ANSWER_MESSAGE"|"NETMSG_GM_REMOVE_ROLL"|"NETMSG_MODULE_LOAD"|"NETMSG_DIFFICULTY_CHANGED"|"NETMSG_PARTYCREATEGROUP"|"NETMSG_CHARACTER_ITEM_USED"|"NETMSG_PARTY_DESTROY"|"NETMSG_INVENTORY_VIEW_UPDATE_PARENTS"|"NETMSG_EGG_DESTROY"|"NETMSG_JOURNAL_RESET"|"NETMSG_GM_SYNC_ASSETS"|"NETMSG_GM_REORDER_ELEMENTS"|"NETMSG_LOAD_START"|"NETMSG_UPDATE_CHARACTER_TAGS"|"NETMSG_TRIGGER_UPDATE"|"NETMSG_HOST_LEFT"|"NETMSG_CHARACTER_DESTROY"|"NETMSG_ITEM_CONFIRMATION"|"NETMSG_SKILL_CREATE"|"NETMSG_QUEST_CATEGORY_UPDATE"|"NETMSG_QUEST_TRACK"|"NETMSG_GM_ASSETS_PENDING_SYNCS_INFO"|"NETMSG_GM_MAKE_TRADER"|"NETMSG_GM_INVENTORY_OPERATION"|"NETMSG_UNLOCK_WAYPOINT"|"NETMSG_SCRIPT_EXTENDER"|"NETMSG_PLAYER_JOINED"|"NETMSG_CHARACTER_UPGRADE"|"NETMSG_TURNBASED_SETTEAM"|"NETMSG_EFFECT_CREATE"|"NETMSG_NOTIFICATION"|"NETMSG_GM_TOGGLE_OVERVIEWMAP"|"NETMSG_GM_MAKE_FOLLOWER"|"NETMSG_CHARACTER_CHANGE_OWNERSHIP"|"NETMSG_SHOW_TUTORIAL_MESSAGE"|"NETMSG_MUSIC_EVENT"|"NETMSG_CHARACTER_CREATE"|"NETMSG_COMBAT_TURN_TIMER"|"NETMSG_ITEM_DEACTIVATE"|"NETMSG_CHARACTER_ERROR"|"NETMSG_GM_TOGGLE_PAUSE"|"NETMSG_GM_CONFIGURE_CAMPAIGN"|"NETMSG_GAMETIME_SYNC"|"NETMSG_UPDATE_ITEM_TAGS"|"NETMSG_CUSTOM_STATS_DEFINITION_REMOVE"|"NETMSG_CUSTOM_STATS_CREATE"|"NETMSG_CHARACTER_ACTIVATE"|"NETMSG_CHARACTER_AOO"|"NETMSG_ITEM_MOVE_UUID"|"NETMSG_INVENTORY_DESTROY"|"NETMSG_SCREEN_FADE"|"NETMSG_GAMEOVER"|"NETMSG_REGISTER_WAYPOINT"|"NETMSG_GM_TELEPORT"|"NETMSG_ATMOSPHERE_OVERRIDE"|"NETMSG_SESSION_LOADED"|"NETMSG_DIPLOMACY"|"NETMSG_CHARACTER_CUSTOMIZATION"|"NETMSG_PARTYUSER"|"NETMSG_TURNBASED_ORDER"|"NETMSG_TURNBASED_FLEECOMBATRESULT"|"NETMSG_NET_ENTITY_DESTROY"|"NETMSG_TROPHY_UPDATE"|"NETMSG_GM_SPAWN"|"NETMSG_GM_REMOVE_EXPORTED"|"NETMSG_GM_DUPLICATE"|"NETMSG_SERVER_COMMAND"|"NETMSG_SERVER_NOTIFICATION"|"NETMSG_STORY_VERSION"|"NETMSG_CLIENT_LEFT"|"NETMSG_UPDATE_COMBAT_GROUP_INFO"|"NETMSG_INVENTORY_VIEW_UPDATE_ITEMS"|"NETMSG_SKILL_UNLEARN"|"NETMSG_SHOW_ENTER_REGION_UI_MESSAGE"|"NETMSG_MYSTERY_UPDATE"|"NETMSG_GM_HEAL"|"NETMSG_GM_CLEAR_STATUSES"|"NETMSG_GM_CREATE_ITEM"|"NETMSG_TELEPORT_PYRAMID"|"NETMSG_LOAD_GAME_WITH_ADDONS"|"NETMSG_SURFACE_CREATE"|"NETMSG_CHARACTER_POSITION"|"NETMSG_ITEM_CREATE"|"NETMSG_INVENTORY_VIEW_DESTROY"|"NETMSG_PLAYSOUND"|"NETMSG_PARTY_UNLOCKED_RECIPE"|"NETMSG_DIALOG_ACTORLEAVES_MESSAGE"|"NETMSG_GM_DRAW_SURFACE"|"NETMSG_GM_ROLL"|"NETMSG_CAMERA_ROTATE"|"NETMSG_LEVEL_INSTANTIATE_SWAP"|"NETMSG_LOBBY_STARTGAME"|"NETMSG_CHARACTER_UPDATE"|"NETMSG_CHARACTER_TELEPORT"|"NETMSG_ITEM_STATUS"|"NETMSG_CACHETEMPLATE"|"NETMSG_GM_TICK_ROLLS"|"NETMSG_GM_VIGNETTE_ANSWER"|"NETMSG_GM_HOST"|"NETMSG_MODULE_LOADED"|"NETMSG_CHARACTERCREATION_NOT_READY"|"NETMSG_DISCOVERED_PORTALS"|"NETMSG_ARENA_RESULTS"|"NETMSG_PARTYGROUP"|"NETMSG_SECRET_REGION_UNLOCK"|"NETMSG_TURNBASED_START"|"NETMSG_GAMECONTROL_PRICETAG"|"NETMSG_QUEST_UPDATE"|"NETMSG_GM_LOAD_CAMPAIGN"|"NETMSG_GM_SOUND_PLAYBACK"|"NETMSG_CHAT"|"NETMSG_LEVEL_SWAP_READY"|"NETMSG_PING_BEACON"|"NETMSG_CUSTOM_STATS_DEFINITION_CREATE"|"NETMSG_GM_JOURNAL_UPDATE"|"NETMSG_CLIENT_CONNECT"|"NETMSG_CHARACTER_STEERING"|"NETMSG_CHARACTER_ACTION_REQUEST_RESULT"|"NETMSG_INVENTORY_ITEM_UPDATE"|"NETMSG_SKILL_DESTROY"|"NETMSG_QUEST_POSTPONE"|"NETMSG_PARTY_MERGE_NOTIFICATION"|"NETMSG_GM_GIVE_REWARD"|"NETMSG_SAVEGAME"|"NETMSG_CHARACTERCREATION_DONE"|"NETMSG_LOCK_WAYPOINT"|"NETMSG_PLAYER_LEFT"|"NETMSG_CHARACTER_OFFSTAGE"|"NETMSG_EFFECT_FORGET"|"NETMSG_FLAG_UPDATE"|"NETMSG_GM_STOP_TRAVELING"|"NETMSG_GM_DEACTIVATE"|"NETMSG_REALTIME_MULTIPLAY"|"NETMSG_LOBBY_DATAUPDATE"|"NETMSG_PAUSE"|"NETMSG_CHARACTER_ASSIGN"|"NETMSG_ITEM_DESTINATION"|"NETMSG_ITEM_MOVE_TO_WORLD"|"NETMSG_INVENTORY_CREATE_AND_OPEN"|"NETMSG_ALIGNMENT_CREATE"|"NETMSG_COMBATLOGITEMINTERACTION"|"NETMSG_CLOSED_MESSAGE_BOX_MESSAGE"|"NETMSG_GM_REQUEST_ROLL"|"NETMSG_GM_CHANGE_SCENE_PATH"|"NETMSG_PARTY_NPC_DATA"|"NETMSG_AITEST_UPDATE"|"NETMSG_UNPAUSE"|"NETMSG_CHARACTER_CONTROL"|"NETMSG_CHARACTER_BOOST"|"NETMSG_INVENTORY_CREATE"|"NETMSG_PROJECTILE_CREATE"|"NETMSG_SCREEN_FADE_DONE"|"NETMSG_DIALOG_NODE_MESSAGE"|"NETMSG_DIALOG_ACTORJOINS_MESSAGE"|"NETMSG_GM_CAMPAIGN_SAVE"|"NETMSG_LEVEL_LOAD"|"NETMSG_CHANGE_COMBAT_FORMATION"|"NETMSG_TRIGGER_CREATE"|"NETMSG_HOST_WELCOME"|"NETMSG_CHARACTER_LOOT_CORPSE"|"NETMSG_SHROUD_UPDATE"|"NETMSG_PEER_ACTIVATE"|"NETMSG_MARKER_UI_CREATE"|"NETMSG_GM_SYNC_VIGNETTES"|"NETMSG_GM_ITEM_USE"|"NETMSG_CHARACTER_ANIMATION_SET_UPDATE"|"NETMSG_ITEM_ENGRAVE"|"NETMSG_LOBBY_CHARACTER_SELECT"|"NETMSG_DLC_UPDATE"|"NETMSG_PLAYER_CONNECT"|"NETMSG_PLAYER_DISCONNECT"|"NETMSG_ITEM_STATUS_LIFETIME"|"NETMSG_SKILL_ACTIVATE"|"NETMSG_OPEN_WAYPOINT_UI_MESSAGE"|"NETMSG_PARTYFORMATION"|"NETMSG_GM_EDIT_ITEM"|"NETMSG_GM_UI_OPEN_STICKY"|"NETMSG_ACHIEVEMENT_PROGRESS_MESSAGE"|"NETMSG_DIALOG_LISTEN"|"NETMSG_SURFACE_META"|"NETMSG_CHARACTER_SKILLBAR"|"NETMSG_ITEM_DESTROY"|"NETMSG_TURNBASED_SUMMONS"|"NETMSG_PLAYMOVIE"|"NETMSG_DIALOG_HISTORY_MESSAGE"|"NETMSG_GM_DAMAGE"|"NETMSG_CAMERA_TARGET"|"NETMSG_JOURNALDIALOGLOG_UPDATE"|"NETMSG_LOBBY_SURRENDER"|"NETMSG_MULTIPLE_TARGET_OPERATION"|"NETMSG_CHARACTER_DIALOG"|"NETMSG_CHARACTER_IN_DIALOG"|"NETMSG_ITEM_TRANSFORM"|"NETMSG_OVERHEADTEXT"|"NETMSG_GM_CHANGE_LEVEL"|"NETMSG_GM_SET_START_POINT"|"NETMSG_MODULES_DOWNLOAD"|"NETMSG_CAMERA_SPLINE"|"NETMSG_SET_CHARACTER_ARCHETYPE"|"NETMSG_CHARACTER_CONFIRMATION"|"NETMSG_CHARACTER_CORPSE_LOOTABLE"|"NETMSG_PARTYORDER"|"NETMSG_ITEM_MOVED_INFORM"|"NETMSG_TURNBASED_STOP"|"NETMSG_OPEN_KICKSTARTER_BOOK_UI_MESSAGE"|"NETMSG_QUEST_STATE"|"NETMSG_JOURNALRECIPE_UPDATE"|"NETMSG_GM_POSSESS"|"NETMSG_GM_SET_REPUTATION"|"NETMSG_LEVEL_START"|"NETMSG_CHARACTER_COMPANION_CUSTOMIZATION"|"NETMSG_GIVE_REWARD"|"NETMSG_CLIENT_ACCEPT"|"NETMSG_CHARACTER_STATS_UPDATE"|"NETMSG_NET_ENTITY_CREATE"|"NETMSG_SKILL_UPDATE"|"NETMSG_UI_QUESTSELECTED"|"NETMSG_DIALOG_ANSWER_HIGHLIGHT_MESSAGE"|"NETMSG_GM_TOGGLE_VIGNETTE"|"NETMSG_GM_SET_STATUS"|"NETMSG_SAVEGAME_LOAD_FAIL"|"NETMSG_CRAFT_RESULT"|"NETMSG_VOICEDATA"|"NETMSG_COMBAT_COMPONENT_SYNC"|"NETMSG_EFFECT_DESTROY"|"NETMSG_GM_DELETE"|"NETMSG_GM_REQUEST_CAMPAIGN_DATA"|"NETMSG_GM_REQUEST_CHARACTERS_REROLL"|"NETMSG_TRADE_ACTION"|"NETMSG_LOBBY_USERUPDATE"|"NETMSG_CUSTOM_STATS_UPDATE"|"NETMSG_CHARACTER_DEACTIVATE"|"NETMSG_CHARACTER_ACTION"|"NETMSG_ITEM_UPDATE"|"NETMSG_INVENTORY_VIEW_CREATE"|"NETMSG_ALIGNMENT_SET"|"NETMSG_PARTY_CONSUMED_ITEMS"|"NETMSG_GM_PASS_ROLL"|"NETMSG_REQUESTAUTOSAVE"|"NETMSG_SAVEGAMEHANDSHAKE"|"NETMSG_NOTIFY_COMBINE_FAILED_MESSAGE"|"NETMSG_TELEPORT_ACK"|"NETMSG_CHARACTER_TRANSFORM"|"NETMSG_PARTY_CREATE"|"NETMSG_EGG_CREATE"|"NETMSG_GAMECONTROL_UPDATE_S2C"|"NETMSG_CLOSE_UI_MESSAGE"|"NETMSG_GM_ADD_EXPERIENCE"|"NETMSG_GM_SYNC_SCENES"|"NETMSG_LEVEL_LOADED"|"NETMSG_OPEN_CRAFT_UI_MESSAGE"|"NETMSG_TRIGGER_DESTROY"|"NETMSG_LOAD_GAME_WITH_ADDONS_FAIL"|"NETMSG_HOST_REFUSE"|"NETMSG_SHROUD_FRUSTUM_UPDATE"|"NETMSG_PEER_DEACTIVATE"|"NETMSG_GAMECONTROL_UPDATE_C2S"|"NETMSG_MARKER_UI_UPDATE"|"NETMSG_GM_TOGGLE_PEACE"|"NETMSG_GM_SET_ATMOSPHERE"|"NETMSG_STORY_ELEMENT_UI"|"NETMSG_CLIENT_GAME_SETTINGS"|"NETMSG_MUTATORS_ENABLED"|"NETMSG_PLAYER_ACCEPT"|"NETMSG_CHARACTER_POSITION_SYNC"|"NETMSG_CHARACTER_SELECTEDSKILLSET"|"NETMSG_INVENTORY_VIEW_SORT"|"NETMSG_SKILL_REMOVED"|"NETMSG_CLOSE_CUSTOM_BOOK_UI_MESSAGE"|"NETMSG_STOP_FOLLOW"|"NETMSG_PARTY_SPLIT_NOTIFICATION"|"NETMSG_GM_SYNC_NOTES"|"NETMSG_LEVEL_SWAP_COMPLETE"|"NETMSG_MUSIC_STATE"|"NETMSG_GAMEACTION"|"NETMSG_CHARACTER_PICKPOCKET"|"NETMSG_ITEM_ACTIVATE"|"NETMSG_PLAY_HUD_SOUND"|"NETMSG_GM_EXPORT"|"NETMSG_GM_TRAVEL_TO_DESTINATION"|"NETMSG_CAMERA_MODE"|"NETMSG_TELEPORT_WAYPOINT"|"NETMSG_LOBBY_RETURN"|"NETMSG_CHARACTER_USE_AP"|"NETMSG_ITEM_USE_REMOTELY"|"NETMSG_ITEM_OFFSTAGE"|"NETMSG_ALIGNMENT_RELATION"|"NETMSG_COMBATLOG"|"NETMSG_GM_POSITION_SYNC"|"NETMSG_GM_SET_INTERESTED_CHARACTER"|"NETMSG_GM_CHANGE_SCENE_NAME"|"NETMSG_SESSION_LOAD"|"NETMSG_READYCHECK"|"NETMSG_HACK_TELL_BUILDNAME"
--- @alias ObjectHandleType string|"ClientEgg"|"ServerEventTrigger"|"Texture"|"ClientCustomStatDefinitionComponent"|"ClientCharacter"|"ClientProjectile"|"ServerCrimeRegionTrigger"|"StructuredBuffer"|"Visual"|"ClientItem"|"ClientPointTrigger"|"ClientScenery"|"ClientAiSeederTrigger"|"ClientWallBase"|"ServerEocAreaTrigger"|"Light"|"ClientInventory"|"ServerStatsAreaTrigger"|"ClientAlignment"|"ClientAlignmentData"|"Reference"|"ClientSkill"|"ClientPointSoundTrigger"|"ServerSoundVolumeTrigger"|"SoundVolumeTrigger"|"ClientStatus"|"ServerOverviewMap"|"ClientParty"|"ServerCrimeAreaTrigger"|"ClientWallConstruction"|"ClientVignette"|"SRV"|"ExtenderClientVisual"|"Scene"|"ClientNote"|"ClientCullTrigger"|"Shader"|"Decal"|"Dummy"|"Trigger"|"ClientSecretRegionTrigger"|"ClientSurface"|"ClientDummyGameObject"|"CombatComponent"|"ServerEgg"|"ServerStartTrigger"|"MeshProxy"|"CustomStatsComponent"|"ServerCharacter"|"ServerRegionTrigger"|"ClientGameAction"|"ClientPointSoundTriggerDummy"|"ServerItem"|"Text3D"|"ClientSpectatorTrigger"|"ServerInventory"|"ServerParty"|"ServerSurfaceAction"|"ServerVignette"|"ServerAtmosphereTrigger"|"ServerMusicVolumeTrigger"|"ClientWallIntersection"|"ServerNote"|"ClientCameraLockTrigger"|"IndexBuffer"|"ServerProjectile"|"ServerSecretRegionTrigger"|"VertexBuffer"|"ServerTeleportTrigger"|"VertexFormat"|"Unknown"|"ContainerComponent"|"SamplerState"|"TextureRemoveData"|"ClientOverviewMap"|"ServerExplorationTrigger"|"BlendState"|"ClientAtmosphereTrigger"|"DepthState"|"Effect"|"ContainerElementComponent"|"ServerCustomStatDefinitionComponent"|"ServerEocPointTrigger"|"RasterizerState"|"UIObject"|"ServerAIHintAreaTrigger"|"Constant"|"TerrainObject"|"ClientInventoryView"|"ConstantBuffer"|"GrannyFile"|"ClientRegionTrigger"|"ClientSoundVolumeTrigger"|"CompiledShader"|"GMJournalNode"|"ServerInventoryView"|"TexturedFont"
...
--- @alias RecipeCategory string|"Weapons"|"Grenades"|"Runes"|"Objects"|"Food"|"Common"|"Arrows"|"Grimoire"|"Armour"|"Potions"
--- @alias ResourceType string|"Texture"|"Script"|"Visual"|"MaterialSet"|"AnimationBlueprint"|"Animation"|"MeshProxy"|"AnimationSet"|"Material"|"Sound"|"VisualSet"|"Atmosphere"|"Physics"|"Effect"
...
--- @alias SkillType string|"Jump"|"Shout"|"Tornado"|"Rush"|"MultiStrike"|"Teleportation"|"Target"|"Summon"|"Projectile"|"Storm"|"Rain"|"Dome"|"Path"|"Zone"|"Wall"|"ProjectileStrike"|"Quake"|"SkillHeal"
--- @alias StatAttributeFlags string|"FreezeImmunity"|"ProtectFromSummon"|"ChickenImmunity"|"BurnImmunity"|"Floating"|"IgnoreCursedOil"|"StunImmunity"|"ShockedImmunity"|"PoisonImmunity"|"CrippledImmunity"|"WebImmunity"|"CharmImmunity"|"DisarmedImmunity"|"MagicalSulfur"|"FearImmunity"|"ShacklesOfPainImmunity"|"ThrownImmunity"|"MuteImmunity"|"PickpocketableWhenEquipped"|"ChilledImmunity"|"Torch"|"WarmImmunity"|"SleepingImmunity"|"WetImmunity"|"DeflectProjectiles"|"BlindImmunity"|"CursedImmunity"|"WeakImmunity"|"DiseasedImmunity"|"SlowedImmunity"|"DecayingImmunity"|"DrunkImmunity"|"Arrow"|"InvisibilityImmunity"|"FreezeContact"|"KnockdownImmunity"|"BurnContact"|"StunContact"|"SuffocatingImmunity"|"PoisonContact"|"LootableWhenEquipped"|"ChillContact"|"InfectiousDiseasedImmunity"|"Unbreakable"|"PetrifiedImmunity"|"Unrepairable"|"Unstorable"|"ClairvoyantImmunity"|"Grounded"|"LoseDurabilityOnCharacterHit"|"HastedImmunity"|"BleedingImmunity"|"TauntedImmunity"|"AcidImmunity"|"RegeneratingImmunity"|"EnragedImmunity"|"EntangledContact"|"BlessedImmunity"|"IgnoreClouds"|"SlippingImmunity"|"MadnessImmunity"
...
--- @alias StatusType string|"DYING"|"SMELLY"|"CHANNELING"|"GUARDIAN_ANGEL"|"SPIRIT_VISION"|"COMBAT"|"UNSHEATHED"|"FORCE_MOVE"|"REMORSE"|"CLIMBING"|"DISARMED"|"INCAPACITATED"|"PLAY_DEAD"|"STANCE"|"SHACKLES_OF_PAIN_CASTER"|"INSURFACE"|"CONSTRAINED"|"HEALING"|"INFUSED"|"HIT"|"BLIND"|"DEACTIVATED"|"EFFECT"|"TUTORIAL_BED"|"TELEPORT_FALLING"|"CONSUME"|"OVERPOWER"|"EXPLODE"|"COMBUSTION"|"REPAIR"|"POLYMORPHED"|"BOOST"|"HEAL_SHARING"|"CHARMED"|"DRAIN"|"DAMAGE"|"LINGERING_WOUNDS"|"AOO"|"INVISIBLE"|"ROTATE"|"INFECTIOUS_DISEASED"|"ENCUMBERED"|"FEAR"|"MATERIAL"|"MUTED"|"IDENTIFY"|"LEADERSHIP"|"FLANKED"|"ADRENALINE"|"LYING"|"WIND_WALKER"|"DARK_AVENGER"|"SOURCE_MUTED"|"HEAL_SHARING_CASTER"|"HEAL"|"KNOCKED_DOWN"|"CLEAN"|"SUMMONING"|"FLOATING"|"STORY_FROZEN"|"UNLOCK"|"EXTRA_TURN"|"SHACKLES_OF_PAIN"|"ACTIVE_DEFENSE"|"SNEAKING"|"CHALLENGE"|"SITTING"|"DECAYING_TOUCH"|"DAMAGE_ON_MOVE"|"SPARK"|"THROWN"|"UNHEALABLE"|"SPIRIT"|"DEMONIC_BARGAIN"
--- @alias SurfaceActionType string|"ExtinguishFireAction"|"ZoneAction"|"SwapSurfaceAction"|"TransformSurfaceAction"|"CreateSurfaceAction"|"RectangleSurfaceAction"|"ChangeSurfaceOnPathAction"|"CreatePuddleAction"|"PolygonSurfaceAction"
--- @alias SurfaceLayer string|"None"|"Cloud"|"Ground"
--- @alias SurfaceTransformActionType string|"Bless"|"Electrify"|"Condense"|"None"|"Vaporize"|"Freeze"|"Bloodify"|"Contaminate"|"Ignite"|"Melt"|"Curse"|"Shatter"|"Purify"|"Oilify"
--- @alias SurfaceType string|"SmokeCloudBlessed"|"Deathfog"|"WaterElectrifiedBlessed"|"Lava"|"BloodCloudElectrifiedBlessed"|"ShockwaveCloud"|"BloodFrozenBlessed"|"Source"|"WaterCloudBlessed"|"BloodCloudElectrifiedPurified"|"PoisonCloudBlessed"|"Water"|"FireCloud"|"WaterFrozenPurified"|"WaterCloud"|"FireBlessed"|"FireCloudBlessed"|"BloodCloud"|"Sentinel"|"FireCursed"|"BloodCloudBlessed"|"PoisonCloud"|"Fire"|"FirePurified"|"WaterElectrifiedPurified"|"SmokeCloud"|"SmokeCloudCursed"|"WaterFrozen"|"WaterFrozenBlessed"|"ExplosionCloud"|"WaterBlessed"|"BloodElectrifiedCursed"|"FrostCloud"|"WaterCursed"|"Blood"|"WaterCloudElectrifiedBlessed"|"WaterCloudCursed"|"WaterPurified"|"Web"|"PoisonCloudCursed"|"BloodFrozen"|"Poison"|"BloodElectrified"|"BloodBlessed"|"WaterCloudElectrifiedPurified"|"BloodCursed"|"Custom"|"FireCloudPurified"|"BloodPurified"|"BloodCloudCursed"|"PoisonBlessed"|"BloodCloudElectrifiedCursed"|"SmokeCloudPurified"|"WaterElectrifiedCursed"|"PoisonCursed"|"Oil"|"Deepwater"|"BloodFrozenCursed"|"PoisonPurified"|"OilBlessed"|"WaterCloudPurified"|"OilCursed"|"PoisonCloudPurified"|"WaterElectrified"|"OilPurified"|"BloodElectrifiedBlessed"|"WebBlessed"|"WebCursed"|"WaterCloudElectrified"|"BloodElectrifiedPurified"|"WebPurified"|"BloodCloudPurified"|"CustomBlessed"|"WaterFrozenCursed"|"CustomCursed"|"BloodFrozenPurified"|"CustomPurified"|"WaterCloudElectrifiedCursed"|"FireCloudCursed"|"BloodCloudElectrified"
--- @alias TemplateType string|"GlobalTemplate"|"LevelCacheTemplate"|"RootTemplate"|"LocalTemplate"|"GlobalCacheTemplate"
--- @alias TriggerTypeId string|"PointSoundTriggerDummy"|"CrimeAreaTrigger"|"ExplorationTrigger"|"SoundVolumeTrigger"|"PointSoundTrigger"|"CrimeRegionTrigger"|"AIHintAreaTrigger"|"SpectatorTrigger"|"PointTrigger"|"RegionTrigger"|"AtmosphereTrigger"|"AISeederTrigger"|"AreaTrigger"|"MusicVolumeTrigger"|"CullTrigger"|"EventTrigger"|"StartTrigger"|"CameraLockTrigger"|"TeleportTrigger"|"StatsAreaTrigger"|"SecretRegionTrigger"
--- @alias UIObjectFlags string|"OF_DontHideOnDelete"|"OF_PlayerTextInput1"|"OF_RequestDelete"|"OF_PrecacheUIData"|"OF_PlayerTextInput2"|"OF_Loaded"|"OF_Visible"|"OF_KeepCustomInScreen"|"OF_Activated"|"OF_PlayerModal4"|"OF_PlayerInput1"|"OF_KeepInScreen"|"OF_PlayerInput2"|"OF_PauseRequest"|"OF_PlayerInput3"|"OF_SortOnAdd"|"OF_PreventCameraMove"|"OF_PlayerInput4"|"OF_FullScreen"|"OF_PlayerTextInput3"|"OF_PlayerModal1"|"OF_PlayerModal2"|"OF_Load"|"OF_PlayerModal3"|"OF_DeleteOnChildDestroy"|"OF_PlayerTextInput4"
--- @alias VisualAttachmentFlags string|"BonusWeaponFX"|"Wings"|"WeaponOverlayFX"|"ExcludeFromBounds"|"ParticleSystem"|"UseLocalTransform"|"Armor"|"Weapon"|"Horns"|"InheritAnimations"|"KeepRot"|"KeepScale"|"DoNotUpdate"|"DestroyWithParent"|"Overhead"|"WeaponFX"
--- @alias VisualComponentFlags string|"ForceUseAnimationBlueprint"|"VisualSetLoaded"
--- @alias VisualFlags string|"AllowReceiveDecalWhenAnimated"|"CastShadow"|"IsShadowProxy"|"ReceiveDecal"|"Reflecting"
--- @alias VisualTemplateColorIndex string|"Cloth"|"Skin"|"Hair"
--- @alias VisualTemplateVisualIndex string|"Visual8"|"Head"|"Boots"|"Arms"|"HairHelmet"|"Trousers"|"Beard"|"Visual9"|"Torso"
--- @alias EclCharacterFlags string|"HasSkillTargetEffect"|"Floating"|"ReservedForDialog"|"CannotMove"|"WalkThrough"|"Global"|"SpotSneakers"|"Invisible"|"PartyFollower"|"NoCover"|"IsHuge"|"InParty"|"InCombat"|"VisualsUpdated"|"IsRunning"|"UseOverlayMaterials"|"WeaponSheathed"|"Summon"|"HasInventory"|"DisableSneaking"|"VisionGridInvisible"|"MovementUpdated"|"Dead"|"CharCreationInProgress"|"GMControl"|"Activated"|"CharacterCreationFinished"|"OffStage"|"Multiplayer"|"HasCustomVisualIndices"|"HasOwner"|"InDialog"|"VisionGridInvisible2"|"NoRotate"|"IsPlayer"|"CanShootThrough"|"StoryNPC"
--- @alias EclEntityComponentIndex string|"PointSoundTriggerDummy"|"Visual"|"OverviewMap"|"Vignette"|"Spline"|"Light"|"LightProbe"|"ParentEntity"|"Net"|"AnimationBlueprint"|"AiSeederTrigger"|"Container"|"SoundVolumeTrigger"|"PingBeacon"|"PointSoundTrigger"|"Note"|"CustomStatDefinition"|"Item"|"Decal"|"Combat"|"Projectile"|"ContainerElement"|"SpectatorTrigger"|"Sound"|"PointTrigger"|"CustomStats"|"Character"|"RegionTrigger"|"AtmosphereTrigger"|"CullTrigger"|"GameMaster"|"PublishingRequest"|"Effect"|"Scenery"|"CameraLockTrigger"|"Egg"|"GMJournalNode"|"SecretRegionTrigger"|"EquipmentVisualsComponent"
--- @alias EclEntitySystemIndex string|"EggManager"|"PhysXScene"|"SurfaceManager"|"SeeThroughManager"|"MusicManager"|"LEDSystem"|"GMJournalSystem"|"PickingHelperManager"|"EquipmentVisualsSystem"|"AnimationBlueprintSystem"|"CameraSplineSystem"|"ProjectileManager"|"GameMasterCampaignManager"|"CustomStatsSystem"|"LightProbeManager"|"GameActionManager"|"GameMasterManager"|"EncounterManager"|"VisualSystem"|"LightManager"|"DecalManager"|"AtmosphereManager"|"SoundSystem"|"ContainerElementComponent"|"GrannySystem"|"ContainerComponentSystem"|"TurnManager"|"PublishingSystem"|"SceneryManager"|"TriggerManager"|"PingBeaconManager"|"CharacterManager"|"ItemManager"
--- @alias EclGameState string|"InitMenu"|"InitNetwork"|"Exit"|"Init"|"InitConnection"|"LoadMenu"|"SwapLevel"|"Idle"|"LoadLevel"|"Lobby"|"LoadModule"|"LoadSession"|"LoadGMCampaign"|"UnloadLevel"|"Movie"|"UnloadModule"|"UnloadSession"|"PrepareRunning"|"Disconnect"|"Save"|"Paused"|"StartLoading"|"Menu"|"StopLoading"|"StartServer"|"Installation"|"Running"|"GameMasterPause"|"ModReceiving"|"BuildStory"|"LoadLoca"|"Unknown"|"Join"
--- @alias EclItemFlags string|"EnableHighlights"|"Floating"|"Global"|"FreezeGravity"|"Invisible"|"StoryItem"|"IsSourceContainer"|"TeleportOnUse"|"DontAddToBottomBar"|"PinnedContainer"|"Fade"|"InteractionDisabled"|"FoldDynamicStats"|"Destroyed"|"Hostile"|"MovementUpdated"|"Unimportant"|"HasPendingNetUpdate"|"Sticky"|"Activated"|"CanUse"|"Walkable"|"CanWalkThrough"|"WasOpened"|"PhysicsFlag1"|"Wadable"|"PhysicsFlag2"|"JoinedDialog"|"HideHP"|"IsCraftingIngredient"|"Registered"|"CanBePickedUp"|"Known"|"PhysicsFlag3"|"CanBeMoved"|"IsLadder"|"CoverAmount"|"Invulnerable"|"CanShootThrough"|"IsDoor"|"IsSecretDoor"
--- @alias EclItemFlags2 string|"Stolen"|"IsKey"|"UseSoundsLoaded"|"Consumable"|"CanUseRemotely"|"UnEquipLocked"
--- @alias EclItemPhysicsFlags string|"PhysicsDisabled"|"RequestRaycast"|"RequestWakeNeighbours"
--- @alias EclSceneryFlags string|"SeeThrough"|"Invisible"|"Fade"|"IsWall"|"Destroyed"|"Walkable"|"Wadable"|"UnknownFlag80"|"CanShootThrough"|"UnknownFlag100"|"Fadeable"
--- @alias EclSceneryRenderFlags string|"AllowReceiveDecalWhenAnimated"|"CastShadow"|"UnknownRenderFlag1"|"IsReflecting"|"ForceUseAnimationBlueprint"|"IsShadowProxy"|"UnknownRenderFlag20"|"ReceiveDecals"
--- @alias EclStatusFlags string|"KeepAlive"|"HasVisuals"|"RequestDelete"|"Started"
--- @alias EclVisualSystemSetFlags string|"ClearEffects"|"AllowTPose"|"SomeWeaponFlag"|"ApplyColors"|"CastShadow"|"IsShadowProxy"|"HasHair"|"ReceiveDecal"|"Reflecting"
--- @alias EocCombatComponentFlags string|"CanGuard"|"IsInspector"|"Guarded"|"CanUseResistDeadTalent"|"RequestEnterCombat"|"IsTicking"|"RequestEndTurn"|"IsBoss"|"CanForceEndTurn"|"FleeOnEndTurn"|"InArena"|"GuardOnEndTurn"|"CanFight"|"TurnEnded"|"TookExtraTurn"|"CanJoinCombat"|"DelayDeathCount"|"RequestTakeExtraTurn"|"CounterAttacked"
--- @alias EocSkillBarItemType string|"None"|"ItemTemplate"|"Action"|"Item"|"Skill"
--- @alias EsvActionStateType string|"Die"|"Repair"|"UseItem"|"Sheath"|"Idle"|"PrepareSkill"|"MoveItem"|"UseSkill"|"KnockedDown"|"Drop"|"Polymorphing"|"CombineItem"|"Identify"|"Animation"|"TeleportFall"|"DisarmTrap"|"Unsheath"|"Incapacitated"|"JumpFlight"|"Summoning"|"Attack"|"Hit"|"Lockpick"|"PickUp"
--- @alias EsvCharacterFlags string|"FightMode"|"Loaded"|"Floating"|"CannotMove"|"WalkThrough"|"ReservedForDialog"|"RegisteredForAutomatedDialog"|"SpotSneakers"|"CannotRun"|"PartyFollower"|"DisableFlee_M"|"Totem"|"CustomLookEnabled"|"ForceNonzeroSpeed"|"IgnoresTriggers"|"IsCompanion_M"|"IsHuge"|"LevelTransitionPending"|"InParty"|"DisableCulling"|"GMReroll"|"Passthrough"|"NeedsMakePlayerUpdate"|"Summon"|"CharacterControl"|"Dead"|"CharCreationInProgress"|"Activated"|"CharacterCreationFinished"|"OffStage"|"Multiplayer"|"HostControl"|"HasOwner"|"RequestStartTurn"|"InDialog"|"Deactivated"|"Temporary"|"InArena"|"DontCacheTemplate"|"NoRotate"|"IsPlayer"|"Invulnerable"|"CoverAmount"|"DeferredRemoveEscapist"|"CannotDie"|"FindValidPositionOnActivate"|"CanShootThrough"|"StoryNPC"
--- @alias EsvCharacterFlags2 string|"Global"|"Resurrected"|"HasOsirisDialog"|"Trader"|"HasDefaultDialog"|"TreasureGeneratedForTrader"
--- @alias EsvCharacterFlags3 string|"IsPet"|"IsGameMaster"|"IsPossessed"|"ManuallyLeveled"|"NoReptuationEffects"|"IsSpectating"|"HasWalkSpeedOverride"|"HasRunSpeedOverride"
--- @alias EsvCharacterTransformFlags string|"ReplaceCustomNameIcon"|"ReplaceCurrentTemplate"|"DontCheckRootTemplate"|"ReplaceScripts"|"ReleasePlayerData"|"ReplaceStats"|"Immediate"|"ReplaceTags"|"SaveOriginalDisplayName"|"ReplaceScale"|"ReplaceSkills"|"DiscardOriginalDisplayName"|"ReplaceVoiceSet"|"ImmediateSync"|"DontReplaceCombatState"|"ReplaceEquipment"|"ReplaceInventory"|"ReplaceCustomLooks"|"ReplaceOriginalTemplate"
--- @alias EsvCharacterTransformType string|"TransformToCharacter"|"TransformToTemplate"
--- @alias EsvEntityComponentIndex string|"OverviewMap"|"Vignette"|"CrimeAreaTrigger"|"Spline"|"ExplorationTrigger"|"Net"|"EoCPointTrigger"|"AnimationBlueprint"|"EoCAreaTrigger"|"Container"|"SoundVolumeTrigger"|"Note"|"CustomStatDefinition"|"Item"|"Combat"|"Projectile"|"CrimeRegionTrigger"|"ContainerElement"|"AIHintAreaTrigger"|"CustomStats"|"Character"|"RegionTrigger"|"AtmosphereTrigger"|"MusicVolumeTrigger"|"EventTrigger"|"GameMaster"|"StartTrigger"|"TeleportTrigger"|"Effect"|"StatsAreaTrigger"|"Egg"|"GMJournalNode"|"SecretRegionTrigger"
--- @alias EsvEntitySystemIndex string|"EggManager"|"NetEntityManager"|"SurfaceManager"|"EffectManager"|"GMJournalSystem"|"RewardManager"|"CharacterSplineSystem"|"AnimationBlueprintSystem"|"ShroudManager"|"CameraSplineSystem"|"ProjectileManager"|"GameMasterCampaignManager"|"EnvironmentalStatusManager"|"CustomStatsSystem"|"SightManager"|"GameActionManager"|"GameMasterManager"|"ContainerElementComponent"|"ContainerComponentSystem"|"TurnManager"|"TriggerManager"|"CharacterManager"|"ItemManager"
--- @alias EsvGameState string|"Exit"|"Uninitialized"|"Init"|"ReloadStory"|"Idle"|"LoadLevel"|"LoadModule"|"LoadSession"|"LoadGMCampaign"|"UnloadLevel"|"UnloadModule"|"UnloadSession"|"Save"|"Disconnect"|"Paused"|"Installation"|"Running"|"GameMasterPause"|"BuildStory"|"Unknown"|"Sync"
--- @alias EsvItemFlags string|"Invulnerable2"|"WalkThrough"|"ReservedForDialog"|"Floating"|"ForceClientSync"|"FreezeGravity"|"IsSurfaceBlocker"|"ClientSync2"|"Invisible"|"StoryItem"|"SourceContainer"|"Totem"|"TeleportOnUse"|"InAutomatedDialog"|"PinnedContainer"|"NoCover"|"InteractionDisabled"|"Destroyed"|"Summon"|"Destroy"|"IsSurfaceCloudBlocker"|"Sticky"|"Activated"|"OffStage"|"CanUse"|"TransformChanged"|"WakePhysics"|"LoadedTemplate"|"ClientSync1"|"IsContainer"|"HideHP"|"ForceSync"|"Frozen"|"CanBePickedUp"|"Known"|"Invisible2"|"CanBeMoved"|"DisableSync"|"CanOnlyBeUsedByOwner"|"IsLadder"|"DontAddToHotbar"|"WalkOn"|"Invulnerable"|"PositionChanged"|"CanShootThrough"|"IsDoor"|"GMFolding"|"IsSecretDoor"
--- @alias EsvItemFlags2 string|"Global"|"CanConsume"|"UseRemotely"|"TreasureGenerated"|"IsKey"|"UnsoldGenerated"|"UnEquipLocked"
...
--- @alias EsvStatusControllerFlags string|"SteerToEnemy"|"CancelSkill"|"HitAnimationFlag2"|"HitAnimationFlag3"|"KnockedDown"|"PlayingDeathAnimation"|"Polymorphing"|"HitAnimationFlag2b"|"Incapacitated"|"CancelCurrentAction"|"JumpFlight"|"Summoning"|"PlayHitAnimation"|"CancelCurrentAction2"|"HitAnimationFlag1"|"TeleportFalling"|"Dying"|"CombatReady"|"SheathWeapon"|"EndTurn"|"PlayHitStillAnimation"|"UnsheathWeapon"
--- @alias EsvStatusFlags0 string|"KeepAlive"|"Influence"|"IsOnSourceSurface"|"Channeled"|"IsFromItem"|"InitiateCombat"|"IsLifeTimeSet"
--- @alias EsvStatusFlags1 string|"IsResistingDeath"|"IsHostileAct"|"BringIntoCombat"|"IsInvulnerable"
--- @alias EsvStatusFlags2 string|"RequestDeleteAtTurnEnd"|"RequestDelete"|"RequestClientSync2"|"ForceStatus"|"ForceFailStatus"|"Started"|"RequestClientSync"
--- @alias EsvTaskType string|"UseItem"|"TeleportToLocation"|"MoveItem"|"UseSkill"|"Steer"|"Drop"|"MoveToLocation"|"MoveToObject"|"Flee"|"MoveInRange"|"Attack"|"Disappear"|"FollowNPC"|"Appear"|"PlayAnimation"|"PickupItem"|"Resurrect"|"Wander"|"MoveToAndTalk"
--- @alias StatsAbilityType string|"Repair"|"Sneaking"|"RangerLore"|"RogueLore"|"Reason"|"Persuasion"|"Intimidate"|"Leadership"|"DualWielding"|"Perseverance"|"Sentinel"|"PhysicalArmorMastery"|"Sulfurology"|"VitalityMastery"|"Shield"|"Luck"|"SingleHanded"|"TwoHanded"|"WarriorLore"|"AirSpecialist"|"EarthSpecialist"|"Brewmaster"|"MagicArmorMastery"|"FireSpecialist"|"Charm"|"Runecrafting"|"Necromancy"|"Summoning"|"Ranged"|"Polymorph"|"PainReflection"|"Telekinesis"|"Pickpocket"|"WaterSpecialist"|"Barter"|"Sourcery"|"Crafting"|"Thievery"|"Wand"|"Loremaster"|"Reflexes"
--- @alias StatsArmorType string|"None"|"Cloth"|"Plate"|"Sentinel"|"Leather"|"Mail"|"Robe"
--- @alias StatsCharacterFlags string|"IsSneaking"|"Invisible"|"DrinkedPotion"|"InParty"|"EquipmentValidated"|"Blind"|"IsPlayer"
--- @alias StatsCharacterStatGetterType string|"APMaximum"|"APRecovery"|"ShadowResistance"|"Wits"|"Accuracy"|"Movement"|"PiercingResistance"|"FireResistance"|"EarthResistance"|"WaterResistance"|"CustomResistance"|"Memory"|"AirResistance"|"MaxMp"|"MagicResistance"|"DamageBoost"|"CriticalChance"|"PhysicalResistance"|"BlockChance"|"Dodge"|"Hearing"|"Finesse"|"Strength"|"APStart"|"Intelligence"|"Constitution"|"CorrosiveResistance"|"Sight"|"PoisonResistance"|"LifeSteal"|"ChanceToHitBoost"|"Initiative"
--- @alias StatsCriticalRoll string|"Critical"|"NotCritical"|"Roll"
--- @alias StatsDamageType string|"None"|"Water"|"Sentinel"|"Fire"|"Poison"|"Air"|"Piercing"|"Physical"|"Corrosive"|"Shadow"|"Chaos"|"Earth"|"Magic"|"Sulfuric"
--- @alias StatsDeathType string|"None"|"Explode"|"Sentinel"|"PetrifiedShatter"|"Acid"|"KnockedDown"|"Arrow"|"Lifetime"|"Hang"|"Sulfur"|"Piercing"|"Physical"|"Incinerate"|"Electrocution"|"FrozenShatter"|"Surrender"|"DoT"
--- @alias StatsEquipmentStatsType string|"Shield"|"Armor"|"Weapon"
--- @alias StatsHandednessType string|"Two"|"Any"|"One"
--- @alias StatsHighGroundBonus string|"HighGround"|"EvenGround"|"LowGround"|"Unknown"
--- @alias StatsHitFlag string|"DamagedMagicArmor"|"CriticalHit"|"FromSetHP"|"NoDamageOnOwner"|"Blocked"|"DamagedVitality"|"CounterAttack"|"Dodged"|"Surface"|"ProcWindWalker"|"Poisoned"|"Bleeding"|"NoEvents"|"DamagedPhysicalArmor"|"DontCreateBloodSurface"|"Burning"|"Flanking"|"Backstab"|"Hit"|"PropagatedFromOwner"|"FromShacklesOfPain"|"Missed"|"Reflection"|"DoT"
--- @alias StatsHitType string|"WeaponDamage"|"Reflected"|"Surface"|"Melee"|"Ranged"|"Magic"|"DoT"
--- @alias StatsItemSlot string|"Wings"|"Ring"|"Sentinel"|"Breast"|"Shield"|"Ring2"|"Leggings"|"Boots"|"Weapon"|"Gloves"|"Horns"|"Belt"|"Helmet"|"Amulet"|"Overhead"
--- @alias StatsItemSlot32 string|"Wings"|"Ring"|"Sentinel"|"Breast"|"Shield"|"Ring2"|"Leggings"|"Boots"|"Weapon"|"Gloves"|"Horns"|"Belt"|"Helmet"|"Amulet"|"Overhead"
--- @alias StatsPropertyContext string|"AoE"|"Target"|"Self"|"SelfOnHit"|"SelfOnEquip"
--- @alias StatsPropertyType string|"Sabotage"|"GameAction"|"SurfaceChange"|"Summon"|"CustomDescription"|"Custom"|"Status"|"OsirisTask"|"Extender"|"Force"
--- @alias StatsRequirementType string|"Repair"|"Sneaking"|"TALENT_Repair"|"TALENT_StandYourGround"|"TALENT_RogueLoreDaggerAPBonus"|"TRAIT_Heartless"|"RangerLore"|"TALENT_ChanceToHitMelee"|"TALENT_ExpGain"|"TALENT_ElementalRanger"|"MinKarma"|"None"|"RogueLore"|"TALENT_ChanceToHitRanged"|"TALENT_ResistStun"|"TALENT_Vitality"|"TALENT_FolkDancer"|"TRAIT_Compassionate"|"MaxKarma"|"Reason"|"Persuasion"|"TALENT_Awareness"|"TALENT_Charm"|"TALENT_RogueLoreMovementBonus"|"TALENT_Dwarf_Sturdy"|"Immobile"|"TALENT_GreedyVessel"|"Intimidate"|"TALENT_Reason"|"TALENT_InventoryAccess"|"TALENT_Ambidextrous"|"TALENT_Sadist"|"Wits"|"Leadership"|"TALENT_Luck"|"TALENT_MrKnowItAll"|"TALENT_ElementalAffinity"|"TALENT_Haymaker"|"DualWielding"|"TALENT_IncreasedArmor"|"TALENT_Escapist"|"TALENT_Courageous"|"TALENT_NoAttackOfOpportunity"|"TRAIT_Independent"|"TALENT_WildMag"|"Perseverance"|"TALENT_ExtraStatPoints"|"TALENT_Raistlin"|"TALENT_Human_Civil"|"TALENT_Jitterbug"|"PhysicalArmorMastery"|"TALENT_EarthSpells"|"TALENT_Leech"|"TALENT_WarriorLoreNaturalArmor"|"TALENT_RogueLoreGrenadePrecision"|"TALENT_QuickStep"|"TALENT_SurpriseAttack"|"TALENT_Bully"|"TALENT_DualWieldingDodging"|"Shield"|"Luck"|"TALENT_ActionPoints"|"TALENT_LightningRod"|"TALENT_LoneWolf"|"TALENT_ResistPoison"|"TALENT_Zombie"|"TALENT_SpillNoBlood"|"TALENT_RangerLoreArrowRecover"|"TALENT_Elementalist"|"Memory"|"SingleHanded"|"TALENT_FireSpells"|"TALENT_Demon"|"TALENT_Elf_CorpseEater"|"TALENT_Lizard_Resistance"|"TALENT_MagicCycles"|"Level"|"TwoHanded"|"TALENT_AvoidDetection"|"TALENT_IceKing"|"TALENT_Sourcerer"|"Combat"|"WarriorLore"|"TALENT_ItemMovement"|"TALENT_WhatARush"|"TALENT_Stench"|"TALENT_WarriorLoreNaturalResistance"|"TALENT_RangerLoreRangedAPBonus"|"AirSpecialist"|"TALENT_ResistFear"|"TALENT_GoldenMage"|"TALENT_Elf_Lore"|"TRAIT_Materialistic"|"EarthSpecialist"|"TALENT_AttackOfOpportunity"|"TALENT_ExtraSkillPoints"|"TALENT_Human_Inventive"|"TALENT_Memory"|"TALENT_Soulcatcher"|"MagicArmorMastery"|"Vitality"|"FireSpecialist"|"Charm"|"TALENT_Intimidate"|"TALENT_RogueLoreDaggerBackStab"|"TALENT_ViolentMagic"|"Necromancy"|"TALENT_LightStep"|"Finesse"|"Summoning"|"TALENT_ActionPoints2"|"TALENT_ResurrectToFullHealth"|"TALENT_Politician"|"TALENT_Torturer"|"TRAIT_Altruistic"|"Ranged"|"Polymorph"|"TALENT_ResistSilence"|"TALENT_Kickstarter"|"TALENT_RogueLoreHoldResistance"|"TALENT_Unstable"|"TALENT_Gladiator"|"Strength"|"PainReflection"|"TALENT_WaterSpells"|"TALENT_Perfectionist"|"TRAIT_Forgiving"|"Intelligence"|"Telekinesis"|"Pickpocket"|"TALENT_AnimalEmpathy"|"TALENT_FiveStarRestaurant"|"TRAIT_Vindictive"|"TRAIT_Bold"|"Constitution"|"WaterSpecialist"|"TALENT_ItemCreation"|"TALENT_Flanking"|"TALENT_FaroutDude"|"TALENT_WarriorLoreGrenadeRange"|"TRAIT_Timid"|"Barter"|"TALENT_Backstab"|"TALENT_ResistKnockdown"|"TALENT_WalkItOff"|"TRAIT_Obedient"|"TRAIT_Considerate"|"Sourcery"|"TALENT_Trade"|"TALENT_Durability"|"TALENT_WarriorLoreNaturalHealth"|"TALENT_Dwarf_Sneaking"|"TRAIT_Pragmatic"|"Tag"|"TALENT_MasterThief"|"Crafting"|"TALENT_Lockpick"|"TALENT_Initiative"|"TALENT_Lizard_Persuasion"|"TALENT_LivingArmor"|"TRAIT_Romantic"|"Thievery"|"Wand"|"TALENT_Damage"|"TALENT_Scientist"|"TRAIT_Spiritual"|"Loremaster"|"TALENT_Criticals"|"TALENT_Sight"|"TALENT_WeatherProof"|"TALENT_RangerLoreEvasionBonus"|"TRAIT_Egotistical"|"TRAIT_Righteous"|"TALENT_ResistDead"|"TALENT_Carry"|"TALENT_ExtraWandCharge"|"TRAIT_Renegade"|"TALENT_Indomitable"|"Reflexes"|"TALENT_Kinetics"|"TALENT_AirSpells"|"TALENT_Executioner"|"TRAIT_Blunt"
--- @alias StatsTalentType string|"ResistDead"|"Repair"|"ExtraSkillPoints"|"Quest_GhostTree"|"Throwing"|"WarriorLoreNaturalResistance"|"RangerLoreRangedAPBonus"|"LivingArmor"|"None"|"Zombie"|"DualWieldingDodging"|"Torturer"|"Reason"|"Quest_SpidersKiss_Null"|"Ambidextrous"|"ItemMovement"|"AttackOfOpportunity"|"ExtraStatPoints"|"Intimidate"|"Unstable"|"AnimalEmpathy"|"WarriorLoreNaturalArmor"|"Quest_Rooted"|"Rager"|"Trade"|"Awareness"|"RogueLoreHoldResistance"|"WandCharge"|"PainDrinker"|"Max"|"Escapist"|"Quest_SpidersKiss_Str"|"Sourcerer"|"Damage"|"FireSpells"|"DeathfogResistant"|"Elementalist"|"WaterSpells"|"ResurrectToFullHealth"|"Bully"|"Haymaker"|"AirSpells"|"Luck"|"RogueLoreDaggerAPBonus"|"Gladiator"|"EarthSpells"|"Elf_CorpseEating"|"Indomitable"|"InventoryAccess"|"Stench"|"Memory"|"Quest_TradeSecrets"|"Jitterbug"|"ChanceToHitRanged"|"AvoidDetection"|"Soulcatcher"|"Kickstarter"|"RangerLoreArrowRecover"|"MasterThief"|"StandYourGround"|"Courageous"|"WarriorLoreNaturalHealth"|"NoAttackOfOpportunity"|"GreedyVessel"|"SurpriseAttack"|"Leech"|"GoldenMage"|"Quest_SpidersKiss_Int"|"MagicCycles"|"Vitality"|"Charm"|"LightStep"|"WalkItOff"|"Scientist"|"ElementalAffinity"|"FolkDancer"|"RogueLoreGrenadePrecision"|"ItemCreation"|"Raistlin"|"IceKing"|"SpillNoBlood"|"RogueLoreDaggerBackStab"|"Flanking"|"MrKnowItAll"|"Lizard_Persuasion"|"Backstab"|"WhatARush"|"Human_Inventive"|"ResurrectExtraHealth"|"Lockpick"|"ChanceToHitMelee"|"FaroutDude"|"Human_Civil"|"WildMag"|"ActionPoints2"|"ExpGain"|"ElementalRanger"|"RangerLoreEvasionBonus"|"Dwarf_Sneaking"|"Criticals"|"Durability"|"LightningRod"|"WarriorLoreGrenadeRange"|"Dwarf_Sturdy"|"IncreasedArmor"|"Sight"|"Politician"|"Elf_Lore"|"Quest_SpidersKiss_Per"|"ResistFear"|"WeatherProof"|"Demon"|"Perfectionist"|"ResistKnockdown"|"FiveStarRestaurant"|"LoneWolf"|"Executioner"|"ResistStun"|"RogueLoreMovementBonus"|"ViolentMagic"|"ActionPoints"|"ResistPoison"|"Lizard_Resistance"|"QuickStep"|"Sadist"|"ResistSilence"|"Carry"|"Initiative"|"BeastMaster"|"NaturalConductor"
--- @alias StatsWeaponType string|"Rifle"|"None"|"Knife"|"Sword"|"Crossbow"|"Sentinel"|"Axe"|"Staff"|"Arrow"|"Spear"|"Club"|"Bow"|"Wand"
...
--- @field DestroyWithParent bool
--- @field DoNotUpdate bool
--- @field EquipmentSlotMask uint16
--- @field ExcludeFromBounds bool
--- @field HasHair bool
--- @field Horns bool
--- @field InheritAnimations bool
...
--- @field VisualSetSlotMask uint16
--- @field Weapon bool
--- @field WeaponFX bool
--- @field WeaponOverlayFX bool
--- @field Wings bool

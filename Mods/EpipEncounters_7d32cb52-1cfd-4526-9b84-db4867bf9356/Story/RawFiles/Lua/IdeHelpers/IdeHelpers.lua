...
--- @alias ActionDataType string | "'UseSkill'" | "'Consume'" | "'Book'" | "'SkillBook'" | "'Repair'" | "'Identify'" | "'DisarmTrap'" | "'Sit'" | "'SpawnCharacter'" | "'Constrain'" | "'KickstarterMessageInABottle'" | "'Ladder'" | "'StoryUseInInventoryOnly'" | "'PlaySound'" | "'DestroyParameters'" | "'Destroy'" | "'Sticky'" | "'StoryUseInInventory'" | "'Craft'" | "'Lying'" | "'Door'" | "'Lockpick'" | "'Pyramid'" | "'Unknown'" | "'OpenClose'" | "'Teleport'" | "'CreateSurface'" | "'StoryUse'" | "'ShowStoryElementUI'" | "'Recipe'" | "'Equip'" | "'CreatePuddle'"
--- @alias AiActionStep string | "'SortActions'" | "'ScoreActions'" | "'ScoreActionsBehavior'" | "'Init'" | "'CalculateStandardAttack'" | "'ScoreActionsFallback'" | "'CalculatePositionScores'" | "'ReevaluateActions'" | "'ScoreActionsAPSaving'" | "'CollectPossibleActions'" | "'CalculateSkills'" | "'CalculateFutureScores'" | "'CalculateItems'"
--- @alias AiActionType string | "'Consume'" | "'None'" | "'StandardAttack'" | "'Skill'" | "'FallbackCommand'"
--- @alias AiModifier string | "'MULTIPLIER_DOT_ENEMY_POS'" | "'MULTIPLIER_ARMOR_NEUTRAL_NEG'" | "'MULTIPLIER_INVISIBLE_MOVEMENT_COST_MULT'" | "'MAX_SCORE_ON_NEUTRAL'" | "'MULTIPLIER_DECAYING_TOUCH'" | "'MULTIPLIER_MAIN_ATTRIB'" | "'MULTIPLIER_CONTROL_ENEMY_NEG'" | "'MULTIPLIER_TARGET_HOSTILE_COUNT_ONE'" | "'MULTIPLIER_ENDPOS_ALLIES_NEARBY'" | "'MULTIPLIER_INCAPACITATE'" | "'MULTIPLIER_CONTACT_BOOST'" | "'SCORE_MOD'" | "'MULTIPLIER_DAMAGE_NEUTRAL_NEG'" | "'MULTIPLIER_BOOST_NEUTRAL_POS'" | "'MULTIPLIER_ENDPOS_NOT_IN_DANGEROUS_SURF'" | "'MULTIPLIER_VITALITYBOOST'" | "'MULTIPLIER_DISARMED'" | "'MULTIPLIER_DOT_ALLY_NEG'" | "'MULTIPLIER_DOT_NEUTRAL_POS'" | "'MULTIPLIER_TARGET_MY_ENEMY'" | "'MULTIPLIER_STATUS_CANCEL_SLEEPING'" | "'MULTIPLIER_FEAR'" | "'MULTIPLIER_ACTIVE_DEFENSE'" | "'MULTIPLIER_CRITICAL'" | "'MULTIPLIER_CONTROL_ALLY_NEG'" | "'MULTIPLIER_ENDPOS_FLANKED'" | "'DANGEROUS_ITEM_NEARBY'" | "'MULTIPLIER_MUTE'" | "'MULTIPLIER_AP_COSTBOOST'" | "'TURNS_REPLACEMENT_INFINITE'" | "'MULTIPLIER_POS_SECONDARY_SURFACE'" | "'MULTIPLIER_HEAL_SELF_NEG'" | "'MULTIPLIER_ARMOR_SELF_POS'" | "'MULTIPLIER_KILL_ENEMY'" | "'MULTIPLIER_KILL_ENEMY_SUMMON'" | "'BUFF_DIST_MAX'" | "'UNSTABLE_BOMB_RADIUS'" | "'MULTIPLIER_HOT_ENEMY_POS'" | "'MULTIPLIER_MOVEMENT_COST_MULTPLIER'" | "'MULTIPLIER_TARGET_SUMMON'" | "'MULTIPLIER_INVISIBLE'" | "'SKILL_JUMP_MINIMUM_DISTANCE'" | "'BUFF_DIST_MIN'" | "'MULTIPLIER_DAMAGE_SELF_POS'" | "'MULTIPLIER_DOT_SELF_POS'" | "'MULTIPLIER_CONTROL_NEUTRAL_NEG'" | "'MULTIPLIER_CANNOT_EXECUTE_THIS_TURN'" | "'MULTIPLIER_ENDPOS_NOT_IN_SMOKE'" | "'MULTIPLIER_RESURRECT'" | "'MULTIPLIER_POSITION_LEAVE'" | "'MULTIPLIER_HEAL_ENEMY_NEG'" | "'MULTIPLIER_HOT_ALLY_NEG'" | "'MULTIPLIER_ARMOR_ENEMY_POS'" | "'MULTIPLIER_ENDPOS_TURNED_INVISIBLE'" | "'SURFACE_DAMAGE_MAX_TURNS'" | "'MULTIPLIER_AP_RECOVERY'" | "'MULTIPLIER_HOT_NEUTRAL_POS'" | "'MULTIPLIER_TARGET_IN_SIGHT'" | "'MAX_HEAL_MULTIPLIER'" | "'MULTIPLIER_STATUS_CANCEL_INVISIBILITY'" | "'MULTIPLIER_ADD_MAGIC_ARMOR'" | "'MULTIPLIER_GROUNDED'" | "'MULTIPLIER_DAMAGE_ENEMY_POS'" | "'MULTIPLIER_BOOST_SELF_NEG'" | "'MOVESKILL_AP_DIFF_REQUIREMENT'" | "'MULTIPLIER_KNOCKDOWN'" | "'MULTIPLIER_SUMMON_PATH_INFLUENCES'" | "'ENABLE_SAVING_ACTION_POINTS'" | "'MULTIPLIER_HEAL_ALLY_NEG'" | "'MULTIPLIER_ARMOR_ALLY_POS'" | "'MULTIPLIER_STATUS_FAILED'" | "'MULTIPLIER_WINDWALKER'" | "'MULTIPLIER_HOT_SELF_POS'" | "'MULTIPLIER_CONTROL_SELF_POS'" | "'MULTIPLIER_ACTION_COST_MULTIPLIER'" | "'MULTIPLIER_TARGET_KNOCKED_DOWN'" | "'MULTIPLIER_SURFACE_REMOVE'" | "'MULTIPLIER_ACC_BOOST'" | "'MULTIPLIER_DAMAGE_ALLY_POS'" | "'MULTIPLIER_BOOST_ENEMY_NEG'" | "'MULTIPLIER_HIGH_ITEM_AMOUNT_MULTIPLIER'" | "'FALLBACK_ALLIES_NEARBY'" | "'MULTIPLIER_SCORE_ON_ALLY'" | "'MULTIPLIER_SOURCE_POINT'" | "'MULTIPLIER_MAGICAL_SULFUR'" | "'MULTIPLIER_HEAL_NEUTRAL_NEG'" | "'MULTIPLIER_ARMOR_NEUTRAL_POS'" | "'MULTIPLIER_ENDPOS_HEIGHT_DIFFERENCE'" | "'MULTIPLIER_KILL_ALLY'" | "'MULTIPLIER_SHACKLES_OF_PAIN'" | "'TARGET_WEAK_ALLY'" | "'MULTIPLIER_CONTROL_ENEMY_POS'" | "'MULTIPLIER_TARGET_UNPREFERRED'" | "'MULTIPLIER_SURFACE_STATUS_ON_MOVE'" | "'MULTIPLIER_SOURCE_MUTE'" | "'MULTIPLIER_SECONDARY_ATTRIB'" | "'MULTIPLIER_DAMAGE_NEUTRAL_POS'" | "'MULTIPLIER_DOT_SELF_NEG'" | "'MULTIPLIER_BOOST_ALLY_NEG'" | "'MAX_HEAL_SELF_MULTIPLIER'" | "'MULTIPLIER_ADD_ARMOR'" | "'MULTIPLIER_COMBO_SCORE_POSITIONING'" | "'AVENGE_ME_VITALITY_LEVEL'" | "'MULTIPLIER_DOT_ENEMY_NEG'" | "'MULTIPLIER_FREE_ACTION'" | "'MULTIPLIER_COOLDOWN_MULTIPLIER'" | "'MULTIPLIER_GUARDIAN_ANGEL'" | "'MULTIPLIER_AP_BOOST'" | "'CHARMED_MAX_CONSUMABLES_PER_TURN'" | "'MULTIPLIER_CONTROL_ALLY_POS'" | "'MULTIPLIER_ENDPOS_STENCH'" | "'MULTIPLIER_DAMAGEBOOST'" | "'MIN_TURNS_SCORE_EXISTING_STATUS'" | "'MULTIPLIER_SHIELD_BLOCK'" | "'MULTIPLIER_HEAL_SELF_POS'" | "'MULTIPLIER_BOOST_NEUTRAL_NEG'" | "'MULTIPLIER_LOW_ITEM_AMOUNT_MULTIPLIER'" | "'MULTIPLIER_BONUS_WEAPON_BOOST'" | "'MULTIPLIER_CHARMED'" | "'MULTIPLIER_DOT_NEUTRAL_NEG'" | "'MULTIPLIER_TARGET_MY_HOSTILE'" | "'MULTIPLIER_ENDPOS_ENEMIES_NEARBY'" | "'MULTIPLIER_SPARK'" | "'MULTIPLIER_DAMAGE_ON_MOVE'" | "'MULTIPLIER_HOT_SELF_NEG'" | "'MULTIPLIER_CONTROL_NEUTRAL_POS'" | "'MULTIPLIER_ENDPOS_NOT_IN_AIHINT'" | "'MULTIPLIER_EXPLOSION_DISTANCE_MIN'" | "'MULTIPLIER_DODGE_BOOST'" | "'MULTIPLIER_PUDDLE_RADIUS'" | "'MULTIPLIER_HEAL_ENEMY_POS'" | "'MULTIPLIER_ARMOR_SELF_NEG'" | "'FALLBACK_ENEMIES_NEARBY'" | "'MULTIPLIER_KILL_ALLY_SUMMON'" | "'MULTIPLIER_SP_COSTBOOST'" | "'MULTIPLIER_COMBO_SCORE_INTERACTION'" | "'MULTIPLIER_HOT_ENEMY_NEG'" | "'MULTIPLIER_TARGET_AGGRO_MARKED'" | "'MULTIPLIER_LOSE_CONTROL'" | "'SKILL_TELEPORT_MINIMUM_DISTANCE'" | "'MULTIPLIER_MAGICAL_SULFUR_CURRENTLY_DAM'" | "'AVENGE_ME_RADIUS'" | "'MULTIPLIER_DAMAGE_SELF_NEG'" | "'MULTIPLIER_BOOST_SELF_POS'" | "'FALLBACK_WANTED_ENEMY_DISTANCE'" | "'MULTIPLIER_HEAL_SHARING'" | "'MULTIPLIER_DEFLECT_PROJECTILES'" | "'MULTIPLIER_HEAL_ALLY_POS'" | "'MULTIPLIER_DOT_ALLY_POS'" | "'MULTIPLIER_ARMOR_ENEMY_NEG'" | "'MULTIPLIER_SOURCE_COST_MULTIPLIER'" | "'MULTIPLIER_STATUS_REMOVE'" | "'MULTIPLIER_REMOVE_ARMOR'" | "'MULTIPLIER_HOT_NEUTRAL_NEG'" | "'MULTIPLIER_TARGET_HOSTILE_COUNT_TWO_OR_'" | "'MULTIPLIER_TARGET_INCAPACITATED'" | "'ENDPOS_NEARBY_DISTANCE'" | "'MULTIPLIER_REMOVE_MAGIC_ARMOR'" | "'MULTIPLIER_AP_MAX'" | "'MULTIPLIER_DAMAGE_ENEMY_NEG'" | "'MULTIPLIER_BOOST_ENEMY_POS'" | "'MOVESKILL_ITEM_AP_DIFF_REQUIREMENT'" | "'MULTIPLIER_SCORE_ON_NEUTRAL'" | "'MULTIPLIER_ARMORBOOST'" | "'MULTIPLIER_REFLECT_DAMAGE'" | "'UNSTABLE_BOMB_NEARBY'" | "'MULTIPLIER_HEAL_NEUTRAL_POS'" | "'MULTIPLIER_ARMOR_ALLY_NEG'" | "'MULTIPLIER_STATUS_OVERWRITE'" | "'MULTIPLIER_BLIND'" | "'MULTIPLIER_DESTROY_INTERESTING_ITEM'" | "'MULTIPLIER_CONTROL_SELF_NEG'" | "'MULTIPLIER_TARGET_PREFERRED'" | "'MULTIPLIER_DEATH_RESIST'" | "'MULTIPLIER_MOVEMENT_BOOST'" | "'ENABLE_ACTIVE_DEFENSE_OFFENSIVE_USE'" | "'MULTIPLIER_DAMAGE_ALLY_NEG'" | "'MULTIPLIER_HOT_ALLY_POS'" | "'MULTIPLIER_BOOST_ALLY_POS'" | "'MULTIPLIER_SCORE_OUT_OF_COMBAT'" | "'MULTIPLIER_RESISTANCE'" | "'MULTIPLIER_FIRST_ACTION_BUFF'"
--- @alias AiScoreReasonFlags string | "'RemoveMadnessSelf'" | "'BreakInvisibilityForNoEnemies'" | "'BreakInvisibility'" | "'CannotTargetFrozen'" | "'StupidInvisibility'" | "'ResurrectOutOfCombat'" | "'ResurrectByCharmedPlayer'" | "'KillSelf'" | "'MustStayInAiHint'" | "'ScoreTooLow'" | "'TooFar'" | "'TooComplex'" | "'NoMovement'" | "'MoveSkillCannotExecute'" | "'TargetBlocked'"
--- @alias CauseType string | "'None'" | "'Offhand'" | "'GM'" | "'SurfaceMove'" | "'SurfaceCreate'" | "'Attack'" | "'SurfaceStatus'" | "'StatusEnter'" | "'StatusTick'"
--- @alias CraftingStationType string | "'Beehive'" | "'None'" | "'Misc1'" | "'Misc3'" | "'Wetstone'" | "'BoilingPot'" | "'SpinningWheel'" | "'Cauldron'" | "'Oven'" | "'Misc2'" | "'Well'" | "'Misc4'" | "'Anvil'"
--- @alias ESurfaceFlag string | "'Cursed'" | "'SomeDecay'" | "'HasItem'" | "'Irreplaceable'" | "'Lava'" | "'CloudElectrified'" | "'Source'" | "'HasInteractableObject'" | "'Water'" | "'FireCloud'" | "'WaterCloud'" | "'Blessed'" | "'BloodCloud'" | "'PoisonCloud'" | "'Fire'" | "'SmokeCloud'" | "'ExplosionCloud'" | "'ElectrifiedDecay'" | "'FrostCloud'" | "'Blood'" | "'Purified'" | "'Web'" | "'Electrified'" | "'GroundSurfaceBlock'" | "'Poison'" | "'Deathfog'" | "'ShockwaveCloud'" | "'Oil'" | "'Deepwater'" | "'IrreplaceableCloud'" | "'MovementBlock'" | "'ProjectileBlock'" | "'HasCharacter'" | "'CloudSurfaceBlock'" | "'Frozen'" | "'Occupied'" | "'SurfaceExclude'" | "'Sulfurium'" | "'CloudBlessed'" | "'CloudCursed'" | "'CloudPurified'"
--- @alias ExtComponentType string | "'ServerProjectile'" | "'Max'" | "'ServerCustomStatDefinition'" | "'ClientCharacter'" | "'Combat'" | "'ClientItem'" | "'ServerCharacter'" | "'ServerItem'"
...
--- @alias HealEffect string | "'Heal'" | "'Script'" | "'None'" | "'ResistDeath'" | "'Surface'" | "'Behavior'" | "'Unknown4'" | "'Necromantic'" | "'HealSharingReflected'" | "'Lifesteal'" | "'NegativeDamage'" | "'Sitting'" | "'Unknown9'" | "'HealSharing'"
...
--- @alias InputType string | "'Repeat'" | "'Release'" | "'ValueChange'" | "'Hold'" | "'Press'" | "'AcceleratedRepeat'" | "'Unknown'"
--- @alias ItemDataRarity string | "'Rare'" | "'Sentinel'" | "'Unique'" | "'Common'" | "'Divine'" | "'Uncommon'" | "'Legendary'" | "'Epic'"
--- @alias LuaTypeId string | "'Tuple'" | "'Enumeration'" | "'Function'" | "'String'" | "'Nullable'" | "'Array'" | "'Void'" | "'Map'" | "'Integer'" | "'Object'" | "'Module'" | "'Unknown'" | "'Any'" | "'Set'" | "'Boolean'" | "'Float'"
--- @alias MultiEffectHandlerFlags string | "'Beam'" | "'Detach'" | "'FaceSource'" | "'FollowScale'" | "'EffectAttached'" | "'KeepRot'"
--- @alias NetMessage string | "'NETMSG_CHARACTER_SET_STORY_NAME'" | "'NETMSG_ITEM_ACTIVATE'" | "'NETMSG_PROJECTILE_EXPLOSION'" | "'NETMSG_PLAY_HUD_SOUND'" | "'NETMSG_GM_EXPORT'" | "'NETMSG_GM_SYNC_VIGNETTES'" | "'NETMSG_CAMERA_MODE'" | "'NETMSG_LOBBY_RETURN'" | "'NETMSG_PLAYER_LEFT'" | "'NETMSG_CHARACTER_ITEM_USED'" | "'NETMSG_ITEM_OFFSTAGE'" | "'NETMSG_COMBATLOG'" | "'NETMSG_OPEN_WAYPOINT_UI_MESSAGE'" | "'NETMSG_GM_POSITION_SYNC'" | "'NETMSG_GM_UI_OPEN_STICKY'" | "'NETMSG_SESSION_LOAD'" | "'NETMSG_READYCHECK'" | "'NETMSG_CHARACTER_DESTROY'" | "'NETMSG_CHARACTER_ASSIGN'" | "'NETMSG_CHARACTER_ACTION_REQUEST_RESULT'" | "'NETMSG_ITEM_CONFIRMATION'" | "'NETMSG_TURNBASED_ROUND'" | "'NETMSG_SECRET_UPDATE'" | "'NETMSG_DIALOG_HISTORY_MESSAGE'" | "'NETMSG_GM_CHANGE_NAME'" | "'NETMSG_RUNECRAFT'" | "'NETMSG_JOURNALDIALOGLOG_UPDATE'" | "'NETMSG_SHOW_ERROR'" | "'NETMSG_HOST_LEFT'" | "'NETMSG_CHARACTER_UPGRADE'" | "'NETMSG_CHARACTER_BOOST'" | "'NETMSG_INVENTORY_VIEW_UPDATE_ITEMS'" | "'NETMSG_TURNBASED_SETTEAM'" | "'NETMSG_SKILL_LEARN'" | "'NETMSG_MYSTERY_STATE'" | "'NETMSG_GM_SET_START_POINT'" | "'NETMSG_GM_REMOVE_STATUS'" | "'NETMSG_GM_REQUEST_CHARACTERS_REROLL'" | "'NETMSG_UNLOCK_ITEM'" | "'NETMSG_PLAYER_JOINED'" | "'NETMSG_COMBAT_TURN_TIMER'" | "'NETMSG_SHROUD_UPDATE'" | "'NETMSG_FORCE_SHEATH'" | "'NETMSG_JOURNALRECIPE_UPDATE'" | "'NETMSG_GM_ITEM_CHANGE'" | "'NETMSG_GM_SET_REPUTATION'" | "'NETMSG_CAMERA_ACTIVATE'" | "'NETMSG_NOTIFY_COMBINE_FAILED_MESSAGE'" | "'NETMSG_LOBBY_COMMAND'" | "'NETMSG_UPDATE_CHARACTER_TAGS'" | "'NETMSG_CHARACTER_ACTIVATE'" | "'NETMSG_ITEM_ACTION'" | "'NETMSG_INVENTORY_DESTROY'" | "'NETMSG_ALIGNMENT_CLEAR'" | "'NETMSG_GAMEOVER'" | "'NETMSG_GM_TOGGLE_VIGNETTE'" | "'NETMSG_GM_REMOVE_ROLL'" | "'NETMSG_MODULE_LOAD'" | "'NETMSG_SAVEGAME_LOAD_FAIL'" | "'NETMSG_PARTYCREATEGROUP'" | "'NETMSG_LOAD_GAME_WITH_ADDONS_FAIL'" | "'NETMSG_SURFACE_META'" | "'NETMSG_CHARACTER_CUSTOMIZATION'" | "'NETMSG_EGG_DESTROY'" | "'NETMSG_NET_ENTITY_DESTROY'" | "'NETMSG_JOURNAL_RESET'" | "'NETMSG_GM_SPAWN'" | "'NETMSG_GM_SYNC_ASSETS'" | "'NETMSG_GM_REQUEST_CAMPAIGN_DATA'" | "'NETMSG_LOAD_START'" | "'NETMSG_TRIGGER_UPDATE'" | "'NETMSG_CHARACTER_DIALOG'" | "'NETMSG_UPDATE_COMBAT_GROUP_INFO'" | "'NETMSG_SKILL_CREATE'" | "'NETMSG_QUEST_TRACK'" | "'NETMSG_PARTY_CONSUMED_ITEMS'" | "'NETMSG_GM_HEAL'" | "'NETMSG_GM_MAKE_TRADER'" | "'NETMSG_SAVEGAMEHANDSHAKE'" | "'NETMSG_UNLOCK_WAYPOINT'" | "'NETMSG_CUSTOM_STATS_CREATE'" | "'NETMSG_SCRIPT_EXTENDER'" | "'NETMSG_CLIENT_LEFT'" | "'NETMSG_CHARACTER_POSITION'" | "'NETMSG_PARTYORDER'" | "'NETMSG_INVENTORY_VIEW_DESTROY'" | "'NETMSG_EFFECT_CREATE'" | "'NETMSG_NOTIFICATION'" | "'NETMSG_GM_ADD_EXPERIENCE'" | "'NETMSG_GM_ROLL'" | "'NETMSG_GM_MAKE_FOLLOWER'" | "'NETMSG_OPEN_CRAFT_UI_MESSAGE'" | "'NETMSG_MUSIC_EVENT'" | "'NETMSG_CHARACTER_TELEPORT'" | "'NETMSG_ITEM_DEACTIVATE'" | "'NETMSG_INVENTORY_CREATE_AND_OPEN'" | "'NETMSG_GAMECONTROL_UPDATE_C2S'" | "'NETMSG_CHARACTER_ERROR'" | "'NETMSG_GM_TOGGLE_PAUSE'" | "'NETMSG_GM_HOST'" | "'NETMSG_GM_SET_INTERESTED_CHARACTER'" | "'NETMSG_GM_SET_ATMOSPHERE'" | "'NETMSG_GAMETIME_SYNC'" | "'NETMSG_UPDATE_ITEM_TAGS'" | "'NETMSG_VOICEDATA'" | "'NETMSG_SECRET_REGION_UNLOCK'" | "'NETMSG_ITEM_MOVE_UUID'" | "'NETMSG_SCREEN_FADE'" | "'NETMSG_PARTY_SPLIT_NOTIFICATION'" | "'NETMSG_GM_TELEPORT'" | "'NETMSG_CHAT'" | "'NETMSG_SESSION_LOADED'" | "'NETMSG_LEVEL_SWAP_COMPLETE'" | "'NETMSG_ACHIEVEMENT_UNLOCKED_MESSAGE'" | "'NETMSG_DIPLOMACY'" | "'NETMSG_LOAD_GAME_WITH_ADDONS'" | "'NETMSG_CHARACTER_STEERING'" | "'NETMSG_CHARACTER_ACTION'" | "'NETMSG_INVENTORY_ITEM_UPDATE'" | "'NETMSG_TURNBASED_ORDER'" | "'NETMSG_TROPHY_UPDATE'" | "'NETMSG_DIALOG_ACTORLEAVES_MESSAGE'" | "'NETMSG_GM_TRAVEL_TO_DESTINATION'" | "'NETMSG_GM_DUPLICATE'" | "'NETMSG_SAVEGAME'" | "'NETMSG_SERVER_COMMAND'" | "'NETMSG_TELEPORT_WAYPOINT'" | "'NETMSG_CUSTOM_STATS_DEFINITION_UPDATE'" | "'NETMSG_STORY_VERSION'" | "'NETMSG_CLIENT_CONNECT'" | "'NETMSG_CHARACTER_OFFSTAGE'" | "'NETMSG_PARTY_CREATE'" | "'NETMSG_SKILL_UNLEARN'" | "'NETMSG_ALIGNMENT_RELATION'" | "'NETMSG_MYSTERY_UPDATE'" | "'NETMSG_GM_CREATE_ITEM'" | "'NETMSG_GM_CHANGE_SCENE_NAME'" | "'NETMSG_TELEPORT_PYRAMID'" | "'NETMSG_PAUSE'" | "'NETMSG_ITEM_CREATE'" | "'NETMSG_ITEM_MOVE_TO_WORLD'" | "'NETMSG_PLAYSOUND'" | "'NETMSG_DIALOG_STATE_MESSAGE'" | "'NETMSG_GM_DRAW_SURFACE'" | "'NETMSG_CAMERA_ROTATE'" | "'NETMSG_CHARACTERCREATION_READY'" | "'NETMSG_LOBBY_STARTGAME'" | "'NETMSG_UNPAUSE'" | "'NETMSG_GM_JOURNAL_UPDATE'" | "'NETMSG_CHARACTER_CONTROL'" | "'NETMSG_ITEM_STATUS'" | "'NETMSG_PROJECTILE_CREATE'" | "'NETMSG_CACHETEMPLATE'" | "'NETMSG_GM_TICK_ROLLS'" | "'NETMSG_GM_SYNC_OVERVIEW_MAPS'" | "'NETMSG_MODULE_LOADED'" | "'NETMSG_LOBBY_SPECTATORUPDATE'" | "'NETMSG_ARENA_RESULTS'" | "'NETMSG_GAMEACTION'" | "'NETMSG_CHARACTER_LOOT_CORPSE'" | "'NETMSG_CHARACTER_CORPSE_LOOTABLE'" | "'NETMSG_TURNBASED_START'" | "'NETMSG_OPEN_MESSAGE_BOX_MESSAGE'" | "'NETMSG_QUEST_UPDATE'" | "'NETMSG_GM_ASSETS_PENDING_SYNCS_INFO'" | "'NETMSG_GM_LOAD_CAMPAIGN'" | "'NETMSG_GM_EDIT_CHARACTER'" | "'NETMSG_LEVEL_SWAP_READY'" | "'NETMSG_PING_BEACON'" | "'NETMSG_HOST_WELCOME'" | "'NETMSG_PLAYER_DISCONNECT'" | "'NETMSG_CHARACTER_USE_AP'" | "'NETMSG_ITEM_STATUS_LIFETIME'" | "'NETMSG_SKILL_DESTROY'" | "'NETMSG_QUEST_POSTPONE'" | "'NETMSG_DIALOG_ANSWER_MESSAGE'" | "'NETMSG_GM_GIVE_REWARD'" | "'NETMSG_DIFFICULTY_CHANGED'" | "'NETMSG_CHARACTER_CHANGE_OWNERSHIP'" | "'NETMSG_LOCK_WAYPOINT'" | "'NETMSG_PLAYER_CONNECT'" | "'NETMSG_CHARACTER_SKILLBAR'" | "'NETMSG_PARTYUPDATE'" | "'NETMSG_TURNBASED_SUMMONS'" | "'NETMSG_EFFECT_FORGET'" | "'NETMSG_OPEN_KICKSTARTER_BOOK_UI_MESSAGE'" | "'NETMSG_FLAG_UPDATE'" | "'NETMSG_DIALOG_ACTORJOINS_MESSAGE'" | "'NETMSG_GM_REORDER_ELEMENTS'" | "'NETMSG_GM_DEACTIVATE'" | "'NETMSG_LOBBY_DATAUPDATE'" | "'NETMSG_CUSTOM_STATS_DEFINITION_REMOVE'" | "'NETMSG_CHARACTER_IN_DIALOG'" | "'NETMSG_ITEM_DESTINATION'" | "'NETMSG_ALIGNMENT_CREATE'" | "'NETMSG_QUEST_CATEGORY_UPDATE'" | "'NETMSG_GM_REQUEST_ROLL'" | "'NETMSG_GM_INVENTORY_OPERATION'" | "'NETMSG_PARTY_NPC_DATA'" | "'NETMSG_LOBBY_CHARACTER_SELECT'" | "'NETMSG_AITEST_UPDATE'" | "'NETMSG_SKIPMOVIE_RESULT'" | "'NETMSG_CHARACTER_CONFIRMATION'" | "'NETMSG_ITEM_MOVED_INFORM'" | "'NETMSG_INVENTORY_CREATE'" | "'NETMSG_SCREEN_FADE_DONE'" | "'NETMSG_GM_TOGGLE_OVERVIEWMAP'" | "'NETMSG_GM_CAMPAIGN_SAVE'" | "'NETMSG_LEVEL_LOAD'" | "'NETMSG_SHOW_TUTORIAL_MESSAGE'" | "'NETMSG_CHARACTER_COMPANION_CUSTOMIZATION'" | "'NETMSG_TRIGGER_CREATE'" | "'NETMSG_CHARACTER_STATUS'" | "'NETMSG_CHARACTER_STATS_UPDATE'" | "'NETMSG_NET_ENTITY_CREATE'" | "'NETMSG_PEER_ACTIVATE'" | "'NETMSG_MARKER_UI_CREATE'" | "'NETMSG_GM_CONFIGURE_CAMPAIGN'" | "'NETMSG_GM_ITEM_USE'" | "'NETMSG_ITEM_ENGRAVE'" | "'NETMSG_DLC_UPDATE'" | "'NETMSG_CLIENT_ACCEPT'" | "'NETMSG_CHARACTER_SELECTEDSKILLSET'" | "'NETMSG_COMBAT_COMPONENT_SYNC'" | "'NETMSG_PARTY_DESTROY'" | "'NETMSG_SKILL_ACTIVATE'" | "'NETMSG_PARTYFORMATION'" | "'NETMSG_REGISTER_WAYPOINT'" | "'NETMSG_GM_EDIT_ITEM'" | "'NETMSG_ATMOSPHERE_OVERRIDE'" | "'NETMSG_DIALOG_LISTEN'" | "'NETMSG_SET_CHARACTER_ARCHETYPE'" | "'NETMSG_CHARACTER_DEACTIVATE'" | "'NETMSG_ITEM_DESTROY'" | "'NETMSG_INVENTORY_VIEW_CREATE'" | "'NETMSG_TURNBASED_FLEECOMBATRESULT'" | "'NETMSG_PLAYMOVIE'" | "'NETMSG_GM_DAMAGE'" | "'NETMSG_GM_REMOVE_EXPORTED'" | "'NETMSG_CAMERA_TARGET'" | "'NETMSG_CHARACTERCREATION_NOT_READY'" | "'NETMSG_SERVER_NOTIFICATION'" | "'NETMSG_LOBBY_SURRENDER'" | "'NETMSG_CHARACTER_TRANSFORM'" | "'NETMSG_ITEM_TRANSFORM'" | "'NETMSG_GAMECONTROL_UPDATE_S2C'" | "'NETMSG_OVERHEADTEXT'" | "'NETMSG_CLOSE_CUSTOM_BOOK_UI_MESSAGE'" | "'NETMSG_DIALOG_ANSWER_HIGHLIGHT_MESSAGE'" | "'NETMSG_GM_CHANGE_LEVEL'" | "'NETMSG_GM_CLEAR_STATUSES'" | "'NETMSG_MODULES_DOWNLOAD'" | "'NETMSG_CAMERA_SPLINE'" | "'NETMSG_CUSTOM_STATS_DEFINITION_CREATE'" | "'NETMSG_CHARACTER_CREATE'" | "'NETMSG_SHROUD_FRUSTUM_UPDATE'" | "'NETMSG_TURNBASED_STOP'" | "'NETMSG_QUEST_STATE'" | "'NETMSG_PARTY_UNLOCKED_RECIPE'" | "'NETMSG_GM_POSSESS'" | "'NETMSG_LEVEL_INSTANTIATE_SWAP'" | "'NETMSG_LEVEL_START'" | "'NETMSG_CUSTOM_STATS_UPDATE'" | "'NETMSG_GIVE_REWARD'" | "'NETMSG_HOST_REFUSE'" | "'NETMSG_CHARACTER_POSITION_SYNC'" | "'NETMSG_CHARACTER_AOO'" | "'NETMSG_INVENTORY_VIEW_SORT'" | "'NETMSG_SKILL_UPDATE'" | "'NETMSG_CLOSED_MESSAGE_BOX_MESSAGE'" | "'NETMSG_UI_QUESTSELECTED'" | "'NETMSG_GM_VIGNETTE_ANSWER'" | "'NETMSG_GM_SET_STATUS'" | "'NETMSG_DISCOVERED_PORTALS'" | "'NETMSG_CRAFT_RESULT'" | "'NETMSG_PLAYER_ACCEPT'" | "'NETMSG_CHARACTER_PICKPOCKET'" | "'NETMSG_PARTYUSER'" | "'NETMSG_EFFECT_DESTROY'" | "'NETMSG_GAMECONTROL_PRICETAG'" | "'NETMSG_GM_DELETE'" | "'NETMSG_GM_SOUND_PLAYBACK'" | "'NETMSG_TRADE_ACTION'" | "'NETMSG_LOBBY_USERUPDATE'" | "'NETMSG_CHARACTER_STATUS_LIFETIME'" | "'NETMSG_ITEM_UPDATE'" | "'NETMSG_ITEM_USE_REMOTELY'" | "'NETMSG_ALIGNMENT_SET'" | "'NETMSG_PARTY_MERGE_NOTIFICATION'" | "'NETMSG_GM_PASS_ROLL'" | "'NETMSG_REQUESTAUTOSAVE'" | "'NETMSG_CHARACTERCREATION_DONE'" | "'NETMSG_TELEPORT_ACK'" | "'NETMSG_CLIENT_GAME_SETTINGS'" | "'NETMSG_SURFACE_CREATE'" | "'NETMSG_CHARACTER_ACTION_DATA'" | "'NETMSG_INVENTORY_VIEW_UPDATE_PARENTS'" | "'NETMSG_INVENTORY_LOCKSTATE_SYNC'" | "'NETMSG_EGG_CREATE'" | "'NETMSG_CLOSE_UI_MESSAGE'" | "'NETMSG_GM_STOP_TRAVELING'" | "'NETMSG_GM_SYNC_SCENES'" | "'NETMSG_CHARACTER_ANIMATION_SET_UPDATE'" | "'NETMSG_LEVEL_LOADED'" | "'NETMSG_REALTIME_MULTIPLAY'" | "'NETMSG_TRIGGER_DESTROY'" | "'NETMSG_CHARACTER_UPDATE'" | "'NETMSG_CHARACTER_LOCK_ABILITY'" | "'NETMSG_PEER_DEACTIVATE'" | "'NETMSG_COMBATLOGITEMINTERACTION'" | "'NETMSG_OPEN_CUSTOM_BOOK_UI_MESSAGE'" | "'NETMSG_SHOW_ENTER_REGION_UI_MESSAGE'" | "'NETMSG_MARKER_UI_UPDATE'" | "'NETMSG_GM_TOGGLE_PEACE'" | "'NETMSG_GM_CHANGE_SCENE_PATH'" | "'NETMSG_STORY_ELEMENT_UI'" | "'NETMSG_ACHIEVEMENT_PROGRESS_MESSAGE'" | "'NETMSG_MUTATORS_ENABLED'" | "'NETMSG_HOST_REFUSEPLAYER'" | "'NETMSG_CLIENT_JOINED'" | "'NETMSG_PARTYGROUP'" | "'NETMSG_ITEM_MOVE_TO_INVENTORY'" | "'NETMSG_SKILL_REMOVED'" | "'NETMSG_STOP_FOLLOW'" | "'NETMSG_DIALOG_NODE_MESSAGE'" | "'NETMSG_GM_SYNC_NOTES'" | "'NETMSG_CHANGE_COMBAT_FORMATION'" | "'NETMSG_MUSIC_STATE'" | "'NETMSG_MULTIPLE_TARGET_OPERATION'" | "'NETMSG_HACK_TELL_BUILDNAME'"
--- @alias ObjectHandleType string | "'ClientCameraLockTrigger'" | "'ServerNote'" | "'ServerProjectile'" | "'Texture'" | "'IndexBuffer'" | "'ServerTeleportTrigger'" | "'VertexBuffer'" | "'Visual'" | "'ContainerComponent'" | "'VertexFormat'" | "'TextureRemoveData'" | "'ClientOverviewMap'" | "'ServerSoundVolumeTrigger'" | "'SamplerState'" | "'ClientAtmosphereTrigger'" | "'BlendState'" | "'Light'" | "'ServerEocPointTrigger'" | "'DepthState'" | "'ServerAIHintAreaTrigger'" | "'RasterizerState'" | "'SRV'" | "'UIObject'" | "'Reference'" | "'ClientInventoryView'" | "'Shader'" | "'Constant'" | "'TerrainObject'" | "'ClientRegionTrigger'" | "'ClientSecretRegionTrigger'" | "'ConstantBuffer'" | "'GrannyFile'" | "'ServerInventoryView'" | "'CompiledShader'" | "'GMJournalNode'" | "'ServerEventTrigger'" | "'TexturedFont'" | "'ClientEgg'" | "'ClientProjectile'" | "'ClientPointSoundTriggerDummy'" | "'StructuredBuffer'" | "'Decal'" | "'Trigger'" | "'ClientCharacter'" | "'ClientPointTrigger'" | "'CombatComponent'" | "'ClientItem'" | "'ClientAiSeederTrigger'" | "'MeshProxy'" | "'ClientScenery'" | "'ServerEocAreaTrigger'" | "'ServerMusicVolumeTrigger'" | "'SoundVolumeTrigger'" | "'ClientWallBase'" | "'ServerStatsAreaTrigger'" | "'Text3D'" | "'ClientInventory'" | "'ClientAlignmentData'" | "'ClientAlignment'" | "'ClientPointSoundTrigger'" | "'ServerSecretRegionTrigger'" | "'ClientSkill'" | "'ServerOverviewMap'" | "'ClientStatus'" | "'ServerCustomStatDefinitionComponent'" | "'ServerCrimeAreaTrigger'" | "'ClientWallConstruction'" | "'ClientParty'" | "'ServerExplorationTrigger'" | "'ClientVignette'" | "'ClientCullTrigger'" | "'ContainerElementComponent'" | "'ClientNote'" | "'ClientDummyGameObject'" | "'Unknown'" | "'ClientSurface'" | "'ServerStartTrigger'" | "'CustomStatsComponent'" | "'ServerEgg'" | "'ServerRegionTrigger'" | "'Scene'" | "'ClientCustomStatDefinitionComponent'" | "'ClientGameAction'" | "'ClientSoundVolumeTrigger'" | "'ServerCharacter'" | "'Dummy'" | "'Effect'" | "'ClientSpectatorTrigger'" | "'ServerItem'" | "'ServerInventory'" | "'ServerSurfaceAction'" | "'ServerParty'" | "'ServerCrimeRegionTrigger'" | "'ServerAtmosphereTrigger'" | "'ClientWallIntersection'" | "'ServerVignette'"
--- @alias PathRootType string | "'Data'" | "'MyDocuments'" | "'GameStorage'" | "'Root'" | "'Public'"
--- @alias PlayerUpgradeAttribute string | "'Wits'" | "'Memory'" | "'Finesse'" | "'Strength'" | "'Intelligence'" | "'Constitution'"
--- @alias RecipeCategory string | "'Weapons'" | "'Grenades'" | "'Grimoire'" | "'Objects'" | "'Food'" | "'Common'" | "'Arrows'" | "'Runes'" | "'Armour'" | "'Potions'"
--- @alias ResourceType string | "'Texture'" | "'Script'" | "'AnimationBlueprint'" | "'Visual'" | "'MaterialSet'" | "'Animation'" | "'MeshProxy'" | "'AnimationSet'" | "'Material'" | "'Sound'" | "'VisualSet'" | "'Atmosphere'" | "'Physics'" | "'Effect'"
...
--- @alias StatAttributeFlags string | "'SlowedImmunity'" | "'DrunkImmunity'" | "'InfectiousDiseasedImmunity'" | "'SlippingImmunity'" | "'FreezeContact'" | "'Floating'" | "'BurnContact'" | "'ProtectFromSummon'" | "'StunContact'" | "'PoisonContact'" | "'LoseDurabilityOnCharacterHit'" | "'CrippledImmunity'" | "'ChillContact'" | "'Unbreakable'" | "'DisarmedImmunity'" | "'Unrepairable'" | "'ShacklesOfPainImmunity'" | "'Unstorable'" | "'Grounded'" | "'HastedImmunity'" | "'SleepingImmunity'" | "'TauntedImmunity'" | "'DeflectProjectiles'" | "'AcidImmunity'" | "'EnragedImmunity'" | "'DiseasedImmunity'" | "'BlessedImmunity'" | "'DecayingImmunity'" | "'IgnoreClouds'" | "'MadnessImmunity'" | "'InvisibilityImmunity'" | "'FreezeImmunity'" | "'ChickenImmunity'" | "'BurnImmunity'" | "'KnockdownImmunity'" | "'IgnoreCursedOil'" | "'PickpocketableWhenEquipped'" | "'StunImmunity'" | "'Arrow'" | "'SuffocatingImmunity'" | "'ShockedImmunity'" | "'PoisonImmunity'" | "'Torch'" | "'WebImmunity'" | "'LootableWhenEquipped'" | "'CharmImmunity'" | "'MagicalSulfur'" | "'FearImmunity'" | "'ThrownImmunity'" | "'MuteImmunity'" | "'PetrifiedImmunity'" | "'ChilledImmunity'" | "'ClairvoyantImmunity'" | "'WarmImmunity'" | "'WetImmunity'" | "'BleedingImmunity'" | "'BlindImmunity'" | "'CursedImmunity'" | "'RegeneratingImmunity'" | "'WeakImmunity'" | "'EntangledContact'"
--- @alias StatusHealType string | "'None'" | "'Source'" | "'All'" | "'PhysicalArmor'" | "'Vitality'" | "'MagicArmor'" | "'AllArmor'"
--- @alias StatusType string | "'THROWN'" | "'UNHEALABLE'" | "'SPIRIT'" | "'DEMONIC_BARGAIN'" | "'DYING'" | "'SMELLY'" | "'CHANNELING'" | "'GUARDIAN_ANGEL'" | "'SPIRIT_VISION'" | "'COMBAT'" | "'UNSHEATHED'" | "'FORCE_MOVE'" | "'REMORSE'" | "'CLIMBING'" | "'DISARMED'" | "'INCAPACITATED'" | "'PLAY_DEAD'" | "'STANCE'" | "'SHACKLES_OF_PAIN_CASTER'" | "'INSURFACE'" | "'CONSTRAINED'" | "'HEALING'" | "'INFUSED'" | "'HIT'" | "'BLIND'" | "'DEACTIVATED'" | "'EFFECT'" | "'TUTORIAL_BED'" | "'TELEPORT_FALLING'" | "'CONSUME'" | "'OVERPOWER'" | "'EXPLODE'" | "'COMBUSTION'" | "'REPAIR'" | "'POLYMORPHED'" | "'BOOST'" | "'HEAL_SHARING'" | "'CHARMED'" | "'DRAIN'" | "'DAMAGE'" | "'LINGERING_WOUNDS'" | "'AOO'" | "'INVISIBLE'" | "'ROTATE'" | "'INFECTIOUS_DISEASED'" | "'ENCUMBERED'" | "'FEAR'" | "'MATERIAL'" | "'MUTED'" | "'IDENTIFY'" | "'LEADERSHIP'" | "'FLANKED'" | "'ADRENALINE'" | "'LYING'" | "'WIND_WALKER'" | "'DARK_AVENGER'" | "'SOURCE_MUTED'" | "'HEAL_SHARING_CASTER'" | "'HEAL'" | "'KNOCKED_DOWN'" | "'CLEAN'" | "'SUMMONING'" | "'FLOATING'" | "'STORY_FROZEN'" | "'UNLOCK'" | "'EXTRA_TURN'" | "'SHACKLES_OF_PAIN'" | "'ACTIVE_DEFENSE'" | "'SNEAKING'" | "'CHALLENGE'" | "'SITTING'" | "'DECAYING_TOUCH'" | "'DAMAGE_ON_MOVE'" | "'SPARK'"
--- @alias SurfaceActionType string | "'PolygonSurfaceAction'" | "'ChangeSurfaceOnPathAction'" | "'ExtinguishFireAction'" | "'TransformSurfaceAction'" | "'CreateSurfaceAction'" | "'ZoneAction'" | "'RectangleSurfaceAction'" | "'CreatePuddleAction'" | "'SwapSurfaceAction'"
...
--- @alias SurfaceType string | "'WaterFrozenCursed'" | "'WaterPurified'" | "'BloodCloudElectrifiedCursed'" | "'BloodFrozen'" | "'BloodFrozenPurified'" | "'BloodBlessed'" | "'Lava'" | "'BloodCloudElectrified'" | "'Sentinel'" | "'BloodCursed'" | "'Source'" | "'SmokeCloudBlessed'" | "'WaterElectrifiedBlessed'" | "'BloodPurified'" | "'BloodFrozenBlessed'" | "'PoisonBlessed'" | "'Water'" | "'PoisonCursed'" | "'FireCloud'" | "'WaterCloudBlessed'" | "'PoisonPurified'" | "'WaterCloud'" | "'PoisonCloudBlessed'" | "'BloodElectrifiedPurified'" | "'OilBlessed'" | "'BloodCloud'" | "'WaterFrozenPurified'" | "'OilCursed'" | "'PoisonCloud'" | "'Fire'" | "'OilPurified'" | "'FireCloudBlessed'" | "'SmokeCloud'" | "'WebBlessed'" | "'WaterCloudElectrifiedCursed'" | "'BloodCloudBlessed'" | "'ExplosionCloud'" | "'WebCursed'" | "'SmokeCloudCursed'" | "'FrostCloud'" | "'WaterFrozenBlessed'" | "'Blood'" | "'WebPurified'" | "'BloodElectrifiedCursed'" | "'Web'" | "'CustomBlessed'" | "'BloodCloudElectrifiedBlessed'" | "'Poison'" | "'CustomCursed'" | "'WaterCloudCursed'" | "'CustomPurified'" | "'PoisonCloudCursed'" | "'Custom'" | "'FireCloudCursed'" | "'BloodCloudElectrifiedPurified'" | "'BloodElectrified'" | "'Deathfog'" | "'FireCloudPurified'" | "'ShockwaveCloud'" | "'Oil'" | "'Deepwater'" | "'BloodCloudCursed'" | "'SmokeCloudPurified'" | "'WaterElectrifiedCursed'" | "'WaterElectrifiedPurified'" | "'BloodFrozenCursed'" | "'WaterCloudPurified'" | "'FireBlessed'" | "'WaterCloudElectrifiedBlessed'" | "'PoisonCloudPurified'" | "'FireCursed'" | "'WaterElectrified'" | "'FirePurified'" | "'BloodElectrifiedBlessed'" | "'WaterFrozen'" | "'WaterCloudElectrified'" | "'WaterCloudElectrifiedPurified'" | "'WaterBlessed'" | "'BloodCloudPurified'" | "'WaterCursed'"
--- @alias TemplateType string | "'LevelCacheTemplate'" | "'RootTemplate'" | "'LocalTemplate'" | "'GlobalTemplate'" | "'GlobalCacheTemplate'"
--- @alias UIObjectFlags string | "'OF_Loaded'" | "'OF_Visible'" | "'OF_PlayerTextInput2'" | "'OF_Activated'" | "'OF_PlayerInput1'" | "'OF_PlayerInput2'" | "'OF_Load'" | "'OF_PlayerInput3'" | "'OF_KeepCustomInScreen'" | "'OF_PlayerInput4'" | "'OF_PrecacheUIData'" | "'OF_PlayerModal1'" | "'OF_PlayerModal2'" | "'OF_PlayerModal3'" | "'OF_PlayerModal4'" | "'OF_PlayerTextInput3'" | "'OF_KeepInScreen'" | "'OF_PauseRequest'" | "'OF_SortOnAdd'" | "'OF_DeleteOnChildDestroy'" | "'OF_FullScreen'" | "'OF_PreventCameraMove'" | "'OF_PlayerTextInput4'" | "'OF_PlayerTextInput1'" | "'OF_RequestDelete'" | "'OF_DontHideOnDelete'"
--- @alias VisualAttachmentFlags string | "'UseLocalTransform'" | "'ParticleSystem'" | "'Armor'" | "'InheritAnimations'" | "'Horns'" | "'Weapon'" | "'KeepScale'" | "'DoNotUpdate'" | "'Overhead'" | "'WeaponFX'" | "'KeepRot'" | "'DestroyWithParent'" | "'BonusWeaponFX'" | "'WeaponOverlayFX'" | "'ExcludeFromBounds'" | "'Wings'"
...
--- @alias VisualTemplateVisualIndex string | "'Torso'" | "'Visual8'" | "'HairHelmet'" | "'Trousers'" | "'Boots'" | "'Arms'" | "'Head'" | "'Beard'" | "'Visual9'"
--- @alias EclCharacterFlags string | "'NoCover'" | "'Activated'" | "'Invisible_M'" | "'PartyFollower'" | "'InCombat'" | "'Floating'" | "'OffStage'" | "'WalkThrough'" | "'VisualsUpdated'" | "'Multiplayer'" | "'Global'" | "'SpotSneakers'" | "'Invisible_M2'" | "'HasOwner'" | "'IsRunning'" | "'InDialog'" | "'WeaponSheathed'" | "'DisableSneaking'" | "'IsHuge'" | "'InParty'" | "'HasCustomVisualIndices'" | "'Summon'" | "'CharacterCreationFinished'" | "'CharCreationInProgress'" | "'NoSound'" | "'NoRotate'" | "'IsPlayer'" | "'StoryNPC'" | "'Dead'" | "'CannotMove'" | "'CanShootThrough'" | "'UseOverlayMaterials'"
--- @alias EclEntityComponentIndex string | "'PointSoundTriggerDummy'" | "'AnimationBlueprint'" | "'Visual'" | "'OverviewMap'" | "'Vignette'" | "'CameraLockTrigger'" | "'Spline'" | "'Light'" | "'Net'" | "'Container'" | "'SpectatorTrigger'" | "'GMJournalNode'" | "'Note'" | "'CustomStatDefinition'" | "'Item'" | "'Decal'" | "'Combat'" | "'Projectile'" | "'SecretRegionTrigger'" | "'SoundVolumeTrigger'" | "'LightProbe'" | "'ParentEntity'" | "'PointTrigger'" | "'AtmosphereTrigger'" | "'Sound'" | "'CullTrigger'" | "'CustomStats'" | "'ContainerElement'" | "'Character'" | "'RegionTrigger'" | "'AiSeederTrigger'" | "'PointSoundTrigger'" | "'PingBeacon'" | "'GameMaster'" | "'Scenery'" | "'PublishingRequest'" | "'Effect'" | "'EquipmentVisualsComponent'" | "'Egg'"
--- @alias EclEntitySystemIndex string | "'CharacterManager'" | "'EncounterManager'" | "'VisualSystem'" | "'LightManager'" | "'AtmosphereManager'" | "'MusicManager'" | "'DecalManager'" | "'SoundSystem'" | "'AnimationBlueprintSystem'" | "'GrannySystem'" | "'PublishingSystem'" | "'TurnManager'" | "'Container'" | "'SceneryManager'" | "'PingBeaconManager'" | "'TriggerManager'" | "'GameMasterCampaignManager'" | "'GMJournalNode'" | "'ItemManager'" | "'EggManager'" | "'PhysXScene'" | "'SeeThroughManager'" | "'ProjectileManager'" | "'SurfaceManager'" | "'LEDSystem'" | "'GMJournalSystem'" | "'PickingHelperManager'" | "'EquipmentVisualsSystem'" | "'CustomStats'" | "'ContainerElement'" | "'GameActionManager'" | "'GameMasterManager'" | "'CameraSplineSystem'" | "'ContainerElementComponent'" | "'ContainerComponentSystem'" | "'GameMaster'" | "'CustomStatsSystem'" | "'LightProbeManager'"
--- @alias EclGameState string | "'Join'" | "'ModReceiving'" | "'BuildStory'" | "'LoadLoca'" | "'Init'" | "'Exit'" | "'Idle'" | "'Lobby'" | "'InitMenu'" | "'InitNetwork'" | "'Movie'" | "'InitConnection'" | "'LoadMenu'" | "'Paused'" | "'SwapLevel'" | "'LoadLevel'" | "'Save'" | "'LoadModule'" | "'Menu'" | "'LoadSession'" | "'Running'" | "'LoadGMCampaign'" | "'UnloadLevel'" | "'UnloadModule'" | "'UnloadSession'" | "'Unknown'" | "'PrepareRunning'" | "'Disconnect'" | "'StartLoading'" | "'StopLoading'" | "'StartServer'" | "'Installation'" | "'GameMasterPause'"
--- @alias EclItemFlags string | "'FoldDynamicStats'" | "'Activated'" | "'Floating'" | "'InteractionDisabled'" | "'Global'" | "'FreezeGravity'" | "'StoryItem'" | "'IsCraftingIngredient'" | "'IsSourceContainer'" | "'Walkable'" | "'CanUse'" | "'CanWalkThrough'" | "'PhysicsFlag1'" | "'Destroyed'" | "'Fade'" | "'PhysicsFlag2'" | "'EnableHighlights'" | "'Hostile'" | "'Unimportant'" | "'PhysicsFlag3'" | "'IsContainer'" | "'Sticky'" | "'IsLadder'" | "'Wadable'" | "'PositionUpdatePending'" | "'IsDoor'" | "'CanBePickedUp'" | "'Known'" | "'IsSecretDoor'" | "'CanBeMoved'" | "'DontAddToBottomBar'" | "'Invulnerable'" | "'CoverAmount'" | "'HideHP'" | "'TeleportOnUse'" | "'CanShootThrough'" | "'Invisible'" | "'PinnedContainer'"
--- @alias EclItemFlags2 string | "'UnEquipLocked'" | "'UseSoundsLoaded'" | "'Consumable'" | "'Stolen'" | "'CanUseRemotely'" | "'IsKey'"
...
--- @alias EocCombatComponentFlags string | "'RequestTakeExtraTurn'" | "'CanGuard'" | "'IsInspector'" | "'IsTicking'" | "'RequestEndTurn'" | "'CanForceEndTurn'" | "'FleeOnEndTurn'" | "'IsBoss'" | "'GuardOnEndTurn'" | "'RequestEnterCombat'" | "'EnteredCombat'" | "'TookExtraTurn'" | "'InArena'" | "'Guarded'" | "'DelayDeathCount'" | "'CanFight'" | "'TurnEnded'" | "'CounterAttacked'" | "'CanJoinCombat'"
--- @alias EocSkillBarItemType string | "'None'" | "'ItemTemplate'" | "'Action'" | "'Item'" | "'Skill'"
--- @alias EsvCharacterFlags string | "'CannotRun'" | "'Activated'" | "'PartyFollower'" | "'LevelTransitionPending'" | "'RegisteredForAutomatedDialog'" | "'OffStage'" | "'Floating'" | "'WalkThrough'" | "'DisableFlee_M'" | "'Multiplayer'" | "'SpotSneakers'" | "'IgnoresTriggers'" | "'HostControl'" | "'IsCompanion_M'" | "'HasOwner'" | "'Totem'" | "'CustomLookEnabled'" | "'NeedsMakePlayerUpdate'" | "'GMReroll'" | "'InDialog'" | "'Passthrough'" | "'Deactivated'" | "'IsHuge'" | "'InParty'" | "'CharacterControl'" | "'ForceNonzeroSpeed'" | "'Summon'" | "'RequestStartTurn'" | "'CharacterCreationFinished'" | "'CharCreationInProgress'" | "'Temporary'" | "'DeferredRemoveEscapist'" | "'InArena'" | "'NoRotate'" | "'Loaded'" | "'CannotDie'" | "'DontCacheTemplate'" | "'IsPlayer'" | "'StoryNPC'" | "'Dead'" | "'FindValidPositionOnActivate'" | "'FightMode'" | "'CoverAmount'" | "'CannotMove'" | "'CanShootThrough'"
--- @alias EsvCharacterFlags2 string | "'HasDefaultDialog'" | "'TreasureGeneratedForTrader'" | "'Global'" | "'Resurrected'" | "'HasOsirisDialog'" | "'Trader'"
...
--- @alias EsvCharacterTransformFlags string | "'ReplaceCurrentTemplate'" | "'DontCheckRootTemplate'" | "'ReleasePlayerData'" | "'ReplaceScripts'" | "'ReplaceStats'" | "'Immediate'" | "'SaveOriginalDisplayName'" | "'ReplaceTags'" | "'ReplaceScale'" | "'ReplaceSkills'" | "'DontReplaceCombatState'" | "'ReplaceVoiceSet'" | "'ReplaceEquipment'" | "'ImmediateSync'" | "'DiscardOriginalDisplayName'" | "'ReplaceInventory'" | "'ReplaceCustomLooks'" | "'ReplaceOriginalTemplate'" | "'ReplaceCustomNameIcon'"
--- @alias EsvCharacterTransformType string | "'TransformToTemplate'" | "'TransformToCharacter'"
--- @alias EsvEntityComponentIndex string | "'TeleportTrigger'" | "'EventTrigger'" | "'AnimationBlueprint'" | "'AIHintAreaTrigger'" | "'OverviewMap'" | "'Vignette'" | "'Spline'" | "'Net'" | "'Container'" | "'GMJournalNode'" | "'Note'" | "'CustomStatDefinition'" | "'MusicVolumeTrigger'" | "'Item'" | "'Combat'" | "'Projectile'" | "'SecretRegionTrigger'" | "'CrimeAreaTrigger'" | "'SoundVolumeTrigger'" | "'AtmosphereTrigger'" | "'StatsAreaTrigger'" | "'CustomStats'" | "'ContainerElement'" | "'Character'" | "'RegionTrigger'" | "'CrimeRegionTrigger'" | "'GameMaster'" | "'Effect'" | "'EoCPointTrigger'" | "'Egg'" | "'EoCAreaTrigger'" | "'ExplorationTrigger'" | "'StartTrigger'"
--- @alias EsvEntitySystemIndex string | "'CharacterManager'" | "'VisualSystem'" | "'LightManager'" | "'DecalManager'" | "'SoundSystem'" | "'CharacterSplineSystem'" | "'AnimationBlueprintSystem'" | "'PublishingSystem'" | "'TurnManager'" | "'Container'" | "'TriggerManager'" | "'GameMasterCampaignManager'" | "'GMJournalNode'" | "'ItemManager'" | "'ShroudManager'" | "'EggManager'" | "'SurfaceManager'" | "'ProjectileManager'" | "'EnvironmentalStatusManager'" | "'GMJournalSystem'" | "'SightManager'" | "'CustomStats'" | "'ContainerElement'" | "'GameActionManager'" | "'GameMasterManager'" | "'CameraSplineSystem'" | "'ContainerElementComponent'" | "'ContainerComponentSystem'" | "'GameMaster'" | "'EffectManager'" | "'CustomStatsSystem'" | "'RewardManager'" | "'NetEntityManager'" | "'LightProbeManager'"
--- @alias EsvGameState string | "'BuildStory'" | "'Init'" | "'Exit'" | "'Idle'" | "'Paused'" | "'LoadLevel'" | "'Save'" | "'LoadModule'" | "'LoadSession'" | "'Sync'" | "'Running'" | "'LoadGMCampaign'" | "'UnloadLevel'" | "'UnloadModule'" | "'UnloadSession'" | "'Unknown'" | "'Uninitialized'" | "'Disconnect'" | "'ReloadStory'" | "'Installation'" | "'GameMasterPause'"
--- @alias EsvItemFlags string | "'NoCover'" | "'Activated'" | "'OffStage'" | "'WalkThrough'" | "'Floating'" | "'InteractionDisabled'" | "'FreezeGravity'" | "'IsSurfaceBlocker'" | "'StoryItem'" | "'Totem'" | "'CanUse'" | "'TransformChanged'" | "'Destroyed'" | "'Summon'" | "'IsSurfaceCloudBlocker'" | "'Destroy'" | "'LoadedTemplate'" | "'ClientSync1'" | "'WakePhysics'" | "'IsContainer'" | "'Sticky'" | "'ForceSync'" | "'CanOnlyBeUsedByOwner'" | "'IsLadder'" | "'DontAddToHotbar'" | "'IsDoor'" | "'PositionChanged'" | "'GMFolding'" | "'Frozen'" | "'CanBePickedUp'" | "'Known'" | "'IsSecretDoor'" | "'CanBeMoved'" | "'Invulnerable'" | "'ClientSync2'" | "'SourceContainer'" | "'WalkOn'" | "'HideHP'" | "'TeleportOnUse'" | "'CanShootThrough'" | "'Invisible'" | "'PinnedContainer'"
--- @alias EsvItemFlags2 string | "'CanConsume'" | "'UnEquipLocked'" | "'Global'" | "'UseRemotely'" | "'TreasureGenerated'" | "'IsKey'" | "'UnsoldGenerated'"
...
--- @alias EsvStatusFlags2 string | "'RequestDeleteAtTurnEnd'" | "'RequestClientSync2'" | "'RequestClientSync'" | "'RequestDelete'" | "'ForceStatus'" | "'ForceFailStatus'" | "'Started'"
...
--- @alias EsvSystemType string | "'AnimationBlueprint'" | "'NetEntity'" | "'Reward'" | "'CharacterSpline'" | "'GM'" | "'GameAction'" | "'CameraSpline'" | "'EnvironmentalStatus'" | "'TurnManager'" | "'Container'" | "'Surface'" | "'Item'" | "'Trigger'" | "'GMCampaign'" | "'Projectile'" | "'Shroud'" | "'GMJournal'" | "'SightManager'" | "'ContainerElement'" | "'Character'" | "'CustomStat'" | "'Effect'" | "'Egg'"
--- @alias StatsAbilityType string | "'Reflexes'" | "'Repair'" | "'Sneaking'" | "'RangerLore'" | "'Sentinel'" | "'RogueLore'" | "'Sulfurology'" | "'Reason'" | "'Persuasion'" | "'Intimidate'" | "'Leadership'" | "'DualWielding'" | "'Perseverance'" | "'PhysicalArmorMastery'" | "'VitalityMastery'" | "'Shield'" | "'Luck'" | "'SingleHanded'" | "'TwoHanded'" | "'WarriorLore'" | "'AirSpecialist'" | "'EarthSpecialist'" | "'Brewmaster'" | "'MagicArmorMastery'" | "'FireSpecialist'" | "'Charm'" | "'Runecrafting'" | "'Necromancy'" | "'Pickpocket'" | "'Summoning'" | "'Ranged'" | "'Polymorph'" | "'PainReflection'" | "'Telekinesis'" | "'WaterSpecialist'" | "'Barter'" | "'Sourcery'" | "'Crafting'" | "'Thievery'" | "'Wand'" | "'Loremaster'"
--- @alias StatsArmorType string | "'Sentinel'" | "'None'" | "'Cloth'" | "'Leather'" | "'Plate'" | "'Mail'" | "'Robe'"
--- @alias StatsCharacterFlags string | "'DrinkedPotion'" | "'Blind'" | "'InParty'" | "'EquipmentValidated'" | "'IsPlayer'" | "'IsSneaking'" | "'Invisible'"
--- @alias StatsCharacterStatGetterType string | "'Initiative'" | "'APMaximum'" | "'APRecovery'" | "'ShadowResistance'" | "'MaxMp'" | "'Wits'" | "'Accuracy'" | "'Movement'" | "'PiercingResistance'" | "'FireResistance'" | "'EarthResistance'" | "'WaterResistance'" | "'CustomResistance'" | "'Memory'" | "'AirResistance'" | "'BlockChance'" | "'MagicResistance'" | "'DamageBoost'" | "'CriticalChance'" | "'PhysicalResistance'" | "'Dodge'" | "'Hearing'" | "'Finesse'" | "'Strength'" | "'APStart'" | "'Intelligence'" | "'Constitution'" | "'CorrosiveResistance'" | "'Sight'" | "'PoisonResistance'" | "'LifeSteal'" | "'ChanceToHitBoost'"
--- @alias StatsCriticalRoll string | "'Critical'" | "'NotCritical'" | "'Roll'"
--- @alias StatsDamageType string | "'Sentinel'" | "'None'" | "'Water'" | "'Chaos'" | "'Fire'" | "'Poison'" | "'Air'" | "'Piercing'" | "'Physical'" | "'Corrosive'" | "'Shadow'" | "'Earth'" | "'Sulfuric'" | "'Magic'"
--- @alias StatsDeathType string | "'Hang'" | "'Sentinel'" | "'None'" | "'Sulfur'" | "'Lifetime'" | "'DoT'" | "'Arrow'" | "'Piercing'" | "'Incinerate'" | "'PetrifiedShatter'" | "'Physical'" | "'Electrocution'" | "'Explode'" | "'FrozenShatter'" | "'Surrender'" | "'KnockedDown'" | "'Acid'"
--- @alias StatsEquipmentStatsType string | "'Shield'" | "'Armor'" | "'Weapon'"
--- @alias StatsHandednessType string | "'One'" | "'Two'" | "'Any'"
--- @alias StatsHighGroundBonus string | "'EvenGround'" | "'LowGround'" | "'Unknown'" | "'HighGround'"
--- @alias StatsHitFlag string | "'CriticalHit'" | "'FromSetHP'" | "'NoDamageOnOwner'" | "'DamagedVitality'" | "'PropagatedFromOwner'" | "'Burning'" | "'CounterAttack'" | "'Poisoned'" | "'FromShacklesOfPain'" | "'Blocked'" | "'Bleeding'" | "'NoEvents'" | "'Surface'" | "'Missed'" | "'DoT'" | "'DamagedMagicArmor'" | "'Flanking'" | "'Backstab'" | "'Hit'" | "'DamagedPhysicalArmor'" | "'Dodged'" | "'ProcWindWalker'" | "'Reflection'" | "'DontCreateBloodSurface'"
--- @alias StatsHitType string | "'Melee'" | "'Surface'" | "'DoT'" | "'Ranged'" | "'WeaponDamage'" | "'Reflected'" | "'Magic'"
--- @alias StatsItemSlot string | "'Sentinel'" | "'Belt'" | "'Helmet'" | "'Amulet'" | "'Shield'" | "'Leggings'" | "'Boots'" | "'Horns'" | "'Weapon'" | "'Gloves'" | "'Ring'" | "'Overhead'" | "'Breast'" | "'Ring2'" | "'Wings'"
--- @alias StatsItemSlot32 string | "'Sentinel'" | "'Belt'" | "'Helmet'" | "'Amulet'" | "'Shield'" | "'Leggings'" | "'Boots'" | "'Horns'" | "'Weapon'" | "'Gloves'" | "'Ring'" | "'Overhead'" | "'Breast'" | "'Ring2'" | "'Wings'"
--- @alias StatsPropertyContext string | "'AoE'" | "'Target'" | "'SelfOnHit'" | "'SelfOnEquip'" | "'Self'"
--- @alias StatsPropertyType string | "'Sabotage'" | "'GameAction'" | "'SurfaceChange'" | "'Summon'" | "'OsirisTask'" | "'CustomDescription'" | "'Extender'" | "'Custom'" | "'Status'" | "'Force'"
--- @alias StatsRequirementType string | "'Reflexes'" | "'TALENT_ResistDead'" | "'TALENT_Charm'" | "'TALENT_RogueLoreDaggerAPBonus'" | "'TALENT_Executioner'" | "'TALENT_Haymaker'" | "'Repair'" | "'Sneaking'" | "'TALENT_AirSpells'" | "'TALENT_Reason'" | "'TRAIT_Altruistic'" | "'TALENT_WildMag'" | "'RangerLore'" | "'TALENT_ChanceToHitRanged'" | "'TALENT_Luck'" | "'TALENT_StandYourGround'" | "'TALENT_Gladiator'" | "'None'" | "'RogueLore'" | "'TALENT_ChanceToHitMelee'" | "'TALENT_Escapist'" | "'TALENT_ElementalRanger'" | "'TALENT_FolkDancer'" | "'TALENT_RogueLoreMovementBonus'" | "'Reason'" | "'Persuasion'" | "'TALENT_ResistStun'" | "'TALENT_Raistlin'" | "'TALENT_Dwarf_Sturdy'" | "'Intimidate'" | "'TALENT_Awareness'" | "'TALENT_Leech'" | "'TALENT_ElementalAffinity'" | "'TALENT_Ambidextrous'" | "'Wits'" | "'Leadership'" | "'TALENT_InventoryAccess'" | "'TALENT_Bully'" | "'TALENT_NoAttackOfOpportunity'" | "'TRAIT_Considerate'" | "'DualWielding'" | "'TALENT_MrKnowItAll'" | "'TALENT_LoneWolf'" | "'TALENT_Courageous'" | "'TALENT_MasterThief'" | "'Perseverance'" | "'TALENT_IncreasedArmor'" | "'TALENT_Zombie'" | "'TALENT_WarriorLoreNaturalArmor'" | "'TALENT_Human_Civil'" | "'PhysicalArmorMastery'" | "'TALENT_ExtraStatPoints'" | "'TALENT_Demon'" | "'TALENT_DualWieldingDodging'" | "'TALENT_QuickStep'" | "'TALENT_EarthSpells'" | "'TALENT_IceKing'" | "'TRAIT_Egotistical'" | "'Shield'" | "'Luck'" | "'TALENT_SurpriseAttack'" | "'TALENT_Stench'" | "'TALENT_RangerLoreArrowRecover'" | "'TALENT_Indomitable'" | "'TALENT_ActionPoints'" | "'TALENT_LightningRod'" | "'TALENT_SpillNoBlood'" | "'TALENT_Elf_Lore'" | "'TALENT_Lizard_Resistance'" | "'Memory'" | "'SingleHanded'" | "'TALENT_ResistPoison'" | "'TALENT_Elf_CorpseEater'" | "'TALENT_Memory'" | "'Level'" | "'TwoHanded'" | "'TALENT_FireSpells'" | "'TALENT_RangerLoreRangedAPBonus'" | "'TALENT_Torturer'" | "'TALENT_Sourcerer'" | "'Combat'" | "'WarriorLore'" | "'TALENT_AvoidDetection'" | "'TALENT_Unstable'" | "'TRAIT_Compassionate'" | "'AirSpecialist'" | "'TALENT_ItemMovement'" | "'TALENT_AttackOfOpportunity'" | "'TALENT_WhatARush'" | "'TALENT_GoldenMage'" | "'TRAIT_Forgiving'" | "'TALENT_GreedyVessel'" | "'EarthSpecialist'" | "'TALENT_ResistFear'" | "'TALENT_RogueLoreDaggerBackStab'" | "'TALENT_Human_Inventive'" | "'TRAIT_Bold'" | "'MagicArmorMastery'" | "'Vitality'" | "'FireSpecialist'" | "'Charm'" | "'TALENT_ExtraSkillPoints'" | "'TALENT_RogueLoreGrenadePrecision'" | "'TALENT_ViolentMagic'" | "'TRAIT_Timid'" | "'Necromancy'" | "'Pickpocket'" | "'TALENT_Intimidate'" | "'TALENT_ResurrectToFullHealth'" | "'TRAIT_Independent'" | "'TRAIT_Obedient'" | "'Finesse'" | "'Summoning'" | "'TALENT_Flanking'" | "'TALENT_LightStep'" | "'TALENT_Politician'" | "'TALENT_RogueLoreHoldResistance'" | "'TRAIT_Pragmatic'" | "'TALENT_Jitterbug'" | "'Ranged'" | "'Polymorph'" | "'TALENT_Backstab'" | "'TALENT_ActionPoints2'" | "'TALENT_Kickstarter'" | "'TRAIT_Romantic'" | "'Strength'" | "'PainReflection'" | "'TALENT_Trade'" | "'TALENT_ResistSilence'" | "'TALENT_FiveStarRestaurant'" | "'TALENT_Perfectionist'" | "'TRAIT_Spiritual'" | "'Intelligence'" | "'Telekinesis'" | "'TALENT_Lockpick'" | "'TALENT_WaterSpells'" | "'TALENT_WarriorLoreGrenadeRange'" | "'TRAIT_Vindictive'" | "'TRAIT_Righteous'" | "'Constitution'" | "'WaterSpecialist'" | "'TALENT_Damage'" | "'TALENT_AnimalEmpathy'" | "'TALENT_WarriorLoreNaturalResistance'" | "'TRAIT_Renegade'" | "'TALENT_Elementalist'" | "'Barter'" | "'TALENT_ItemCreation'" | "'TALENT_Sight'" | "'TALENT_FaroutDude'" | "'TALENT_WalkItOff'" | "'TALENT_WarriorLoreNaturalHealth'" | "'TRAIT_Blunt'" | "'TALENT_MagicCycles'" | "'Sourcery'" | "'TALENT_ResistKnockdown'" | "'TALENT_Carry'" | "'TALENT_Dwarf_Sneaking'" | "'TALENT_Lizard_Persuasion'" | "'TRAIT_Heartless'" | "'Tag'" | "'Crafting'" | "'TALENT_Kinetics'" | "'TALENT_Durability'" | "'TALENT_LivingArmor'" | "'MinKarma'" | "'Thievery'" | "'Wand'" | "'TALENT_Repair'" | "'TALENT_Initiative'" | "'TALENT_RangerLoreEvasionBonus'" | "'TRAIT_Materialistic'" | "'MaxKarma'" | "'Loremaster'" | "'TALENT_ExpGain'" | "'TALENT_Scientist'" | "'TALENT_WeatherProof'" | "'Immobile'" | "'TALENT_Soulcatcher'" | "'TALENT_Criticals'" | "'TALENT_Vitality'" | "'TALENT_ExtraWandCharge'" | "'TALENT_Sadist'"
--- @alias StatsTalentType string | "'ResistSilence'" | "'Carry'" | "'Initiative'" | "'BeastMaster'" | "'NaturalConductor'" | "'ResistDead'" | "'Repair'" | "'ExtraSkillPoints'" | "'Quest_GhostTree'" | "'Throwing'" | "'WarriorLoreNaturalResistance'" | "'RangerLoreRangedAPBonus'" | "'LivingArmor'" | "'None'" | "'Zombie'" | "'DualWieldingDodging'" | "'Torturer'" | "'Reason'" | "'Quest_SpidersKiss_Null'" | "'Ambidextrous'" | "'ItemMovement'" | "'AttackOfOpportunity'" | "'ExtraStatPoints'" | "'Intimidate'" | "'Unstable'" | "'AnimalEmpathy'" | "'WarriorLoreNaturalArmor'" | "'Quest_Rooted'" | "'Rager'" | "'Trade'" | "'Awareness'" | "'RogueLoreHoldResistance'" | "'PainDrinker'" | "'Max'" | "'Escapist'" | "'Quest_SpidersKiss_Str'" | "'Sourcerer'" | "'Damage'" | "'FireSpells'" | "'DeathfogResistant'" | "'Elementalist'" | "'WaterSpells'" | "'ResurrectToFullHealth'" | "'Bully'" | "'Haymaker'" | "'AirSpells'" | "'Luck'" | "'RogueLoreDaggerAPBonus'" | "'Gladiator'" | "'EarthSpells'" | "'Elf_CorpseEating'" | "'Indomitable'" | "'InventoryAccess'" | "'Stench'" | "'Memory'" | "'Quest_TradeSecrets'" | "'Jitterbug'" | "'ChanceToHitRanged'" | "'AvoidDetection'" | "'Soulcatcher'" | "'Kickstarter'" | "'RangerLoreArrowRecover'" | "'MasterThief'" | "'StandYourGround'" | "'Courageous'" | "'WarriorLoreNaturalHealth'" | "'NoAttackOfOpportunity'" | "'GreedyVessel'" | "'SurpriseAttack'" | "'Leech'" | "'GoldenMage'" | "'Quest_SpidersKiss_Int'" | "'MagicCycles'" | "'Vitality'" | "'Charm'" | "'LightStep'" | "'WalkItOff'" | "'Scientist'" | "'ElementalAffinity'" | "'FolkDancer'" | "'RogueLoreGrenadePrecision'" | "'ItemCreation'" | "'Raistlin'" | "'IceKing'" | "'SpillNoBlood'" | "'RogueLoreDaggerBackStab'" | "'Flanking'" | "'MrKnowItAll'" | "'Lizard_Persuasion'" | "'Backstab'" | "'WhatARush'" | "'Human_Inventive'" | "'ResurrectExtraHealth'" | "'Lockpick'" | "'ChanceToHitMelee'" | "'FaroutDude'" | "'Human_Civil'" | "'WildMag'" | "'ActionPoints2'" | "'ExpGain'" | "'ElementalRanger'" | "'RangerLoreEvasionBonus'" | "'WandCharge'" | "'Dwarf_Sneaking'" | "'Criticals'" | "'Durability'" | "'LightningRod'" | "'WarriorLoreGrenadeRange'" | "'Dwarf_Sturdy'" | "'IncreasedArmor'" | "'Sight'" | "'Politician'" | "'Elf_Lore'" | "'Quest_SpidersKiss_Per'" | "'ResistFear'" | "'WeatherProof'" | "'Demon'" | "'Perfectionist'" | "'ResistKnockdown'" | "'FiveStarRestaurant'" | "'LoneWolf'" | "'Executioner'" | "'ResistStun'" | "'RogueLoreMovementBonus'" | "'ViolentMagic'" | "'ActionPoints'" | "'ResistPoison'" | "'Lizard_Resistance'" | "'QuickStep'" | "'Sadist'"
--- @alias StatsWeaponType string | "'Sentinel'" | "'None'" | "'Knife'" | "'Crossbow'" | "'Rifle'" | "'Sword'" | "'Staff'" | "'Axe'" | "'Spear'" | "'Arrow'" | "'Bow'" | "'Club'" | "'Wand'"

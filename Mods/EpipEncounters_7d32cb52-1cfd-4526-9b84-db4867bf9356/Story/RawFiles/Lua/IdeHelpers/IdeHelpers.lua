...
--- @alias ActionDataType string | "'Recipe'" | "'Equip'" | "'Consume'" | "'Repair'" | "'StoryUseInInventory'" | "'OpenClose'" | "'Destroy'" | "'Teleport'" | "'CreateSurface'" | "'StoryUse'" | "'CreatePuddle'" | "'Sticky'" | "'UseSkill'" | "'Craft'" | "'SkillBook'" | "'Lying'" | "'PlaySound'" | "'Door'" | "'Identify'" | "'ShowStoryElementUI'" | "'DisarmTrap'" | "'Pyramid'" | "'SpawnCharacter'" | "'Constrain'" | "'KickstarterMessageInABottle'" | "'StoryUseInInventoryOnly'" | "'Book'" | "'Lockpick'" | "'Unknown'" | "'DestroyParameters'" | "'Sit'" | "'Ladder'"
--- @alias AiActionStep string | "'CalculateFutureScores'" | "'ScoreActionsBehavior'" | "'Init'" | "'CalculateStandardAttack'" | "'CalculateSkills'" | "'CalculateItems'" | "'SortActions'" | "'ScoreActionsFallback'" | "'ScoreActions'" | "'CalculatePositionScores'" | "'ReevaluateActions'" | "'ScoreActionsAPSaving'" | "'CollectPossibleActions'"
--- @alias AiActionType string | "'Skill'" | "'Consume'" | "'None'" | "'StandardAttack'" | "'FallbackCommand'"
--- @alias AiModifier string | "'MULTIPLIER_DOT_ENEMY_NEG'" | "'MULTIPLIER_COOLDOWN_MULTIPLIER'" | "'MULTIPLIER_GUARDIAN_ANGEL'" | "'MULTIPLIER_DEATH_RESIST'" | "'MULTIPLIER_HOT_ALLY_POS'" | "'MULTIPLIER_CONTROL_ALLY_POS'" | "'MULTIPLIER_SOURCE_COST_MULTIPLIER'" | "'MULTIPLIER_ENDPOS_STENCH'" | "'MULTIPLIER_RESISTANCE'" | "'MIN_TURNS_SCORE_EXISTING_STATUS'" | "'MULTIPLIER_HEAL_SELF_POS'" | "'MULTIPLIER_BOOST_NEUTRAL_NEG'" | "'MULTIPLIER_TARGET_HOSTILE_COUNT_TWO_OR_'" | "'MAX_SCORE_ON_NEUTRAL'" | "'MULTIPLIER_BONUS_WEAPON_BOOST'" | "'MULTIPLIER_MAIN_ATTRIB'" | "'MULTIPLIER_DOT_NEUTRAL_NEG'" | "'MULTIPLIER_TARGET_MY_HOSTILE'" | "'MOVESKILL_ITEM_AP_DIFF_REQUIREMENT'" | "'MULTIPLIER_INCAPACITATE'" | "'MULTIPLIER_DAMAGE_ON_MOVE'" | "'MULTIPLIER_CONTROL_NEUTRAL_POS'" | "'MULTIPLIER_ENDPOS_NOT_IN_AIHINT'" | "'MULTIPLIER_DISARMED'" | "'MULTIPLIER_DESTROY_INTERESTING_ITEM'" | "'MULTIPLIER_PUDDLE_RADIUS'" | "'MULTIPLIER_HEAL_ENEMY_POS'" | "'MULTIPLIER_DOT_ALLY_NEG'" | "'MULTIPLIER_ARMOR_SELF_NEG'" | "'MULTIPLIER_KILL_ALLY_SUMMON'" | "'MULTIPLIER_CRITICAL'" | "'ENABLE_ACTIVE_DEFENSE_OFFENSIVE_USE'" | "'MULTIPLIER_HOT_ENEMY_NEG'" | "'MULTIPLIER_TARGET_AGGRO_MARKED'" | "'DANGEROUS_ITEM_NEARBY'" | "'SKILL_TELEPORT_MINIMUM_DISTANCE'" | "'MULTIPLIER_AP_COSTBOOST'" | "'MULTIPLIER_DAMAGE_SELF_NEG'" | "'MULTIPLIER_BOOST_SELF_POS'" | "'MULTIPLIER_INVISIBLE_MOVEMENT_COST_MULT'" | "'FALLBACK_WANTED_ENEMY_DISTANCE'" | "'MULTIPLIER_KILL_ENEMY'" | "'MULTIPLIER_DEFLECT_PROJECTILES'" | "'UNSTABLE_BOMB_RADIUS'" | "'MULTIPLIER_HEAL_ALLY_POS'" | "'MULTIPLIER_ARMOR_ENEMY_NEG'" | "'MULTIPLIER_TARGET_HOSTILE_COUNT_ONE'" | "'MULTIPLIER_STATUS_REMOVE'" | "'MULTIPLIER_INVISIBLE'" | "'MULTIPLIER_DOT_SELF_POS'" | "'MULTIPLIER_HOT_NEUTRAL_NEG'" | "'MULTIPLIER_TARGET_INCAPACITATED'" | "'MULTIPLIER_ENDPOS_NOT_IN_DANGEROUS_SURF'" | "'MULTIPLIER_RESURRECT'" | "'MULTIPLIER_REMOVE_MAGIC_ARMOR'" | "'MULTIPLIER_DAMAGE_ENEMY_NEG'" | "'MULTIPLIER_HOT_ALLY_NEG'" | "'MULTIPLIER_BOOST_ENEMY_POS'" | "'MULTIPLIER_SCORE_ON_NEUTRAL'" | "'MULTIPLIER_STATUS_CANCEL_SLEEPING'" | "'MULTIPLIER_AP_RECOVERY'" | "'MULTIPLIER_REFLECT_DAMAGE'" | "'MULTIPLIER_HEAL_NEUTRAL_POS'" | "'MULTIPLIER_ARMOR_ALLY_NEG'" | "'MAX_HEAL_MULTIPLIER'" | "'MULTIPLIER_STATUS_OVERWRITE'" | "'MULTIPLIER_GROUNDED'" | "'MULTIPLIER_POS_SECONDARY_SURFACE'" | "'MULTIPLIER_CONTROL_SELF_NEG'" | "'MULTIPLIER_TARGET_PREFERRED'" | "'MULTIPLIER_KNOCKDOWN'" | "'MULTIPLIER_MOVEMENT_BOOST'" | "'MULTIPLIER_DAMAGE_ALLY_NEG'" | "'MULTIPLIER_BOOST_ALLY_POS'" | "'MULTIPLIER_MOVEMENT_COST_MULTPLIER'" | "'MULTIPLIER_SCORE_OUT_OF_COMBAT'" | "'MULTIPLIER_WINDWALKER'" | "'MULTIPLIER_FIRST_ACTION_BUFF'" | "'MULTIPLIER_DOT_ENEMY_POS'" | "'MULTIPLIER_HOT_SELF_POS'" | "'MULTIPLIER_ARMOR_NEUTRAL_NEG'" | "'MULTIPLIER_CANNOT_EXECUTE_THIS_TURN'" | "'MULTIPLIER_DECAYING_TOUCH'" | "'MULTIPLIER_ACC_BOOST'" | "'SCORE_MOD'" | "'MULTIPLIER_CONTROL_ENEMY_NEG'" | "'MULTIPLIER_ENDPOS_ALLIES_NEARBY'" | "'MULTIPLIER_ENDPOS_TURNED_INVISIBLE'" | "'FALLBACK_ALLIES_NEARBY'" | "'MULTIPLIER_SOURCE_POINT'" | "'MULTIPLIER_CONTACT_BOOST'" | "'MULTIPLIER_DAMAGE_NEUTRAL_NEG'" | "'MULTIPLIER_BOOST_NEUTRAL_POS'" | "'MULTIPLIER_VITALITYBOOST'" | "'MULTIPLIER_KILL_ALLY'" | "'MULTIPLIER_STATUS_CANCEL_INVISIBILITY'" | "'MULTIPLIER_FEAR'" | "'TARGET_WEAK_ALLY'" | "'MULTIPLIER_DOT_NEUTRAL_POS'" | "'MULTIPLIER_TARGET_MY_ENEMY'" | "'MULTIPLIER_MUTE'" | "'MULTIPLIER_SOURCE_MUTE'" | "'MULTIPLIER_ACTIVE_DEFENSE'" | "'MULTIPLIER_SUMMON_PATH_INFLUENCES'" | "'MULTIPLIER_DOT_SELF_NEG'" | "'MULTIPLIER_CONTROL_ALLY_NEG'" | "'MULTIPLIER_ENDPOS_FLANKED'" | "'MULTIPLIER_ADD_ARMOR'" | "'TURNS_REPLACEMENT_INFINITE'" | "'BUFF_DIST_MAX'" | "'MULTIPLIER_HEAL_SELF_NEG'" | "'MULTIPLIER_ARMOR_SELF_POS'" | "'MULTIPLIER_FREE_ACTION'" | "'MULTIPLIER_ACTION_COST_MULTIPLIER'" | "'MULTIPLIER_KILL_ENEMY_SUMMON'" | "'MULTIPLIER_AP_BOOST'" | "'BUFF_DIST_MIN'" | "'MULTIPLIER_HOT_ENEMY_POS'" | "'MULTIPLIER_HIGH_ITEM_AMOUNT_MULTIPLIER'" | "'MULTIPLIER_TARGET_SUMMON'" | "'MULTIPLIER_DAMAGEBOOST'" | "'SKILL_JUMP_MINIMUM_DISTANCE'" | "'MULTIPLIER_SHIELD_BLOCK'" | "'MULTIPLIER_DAMAGE_SELF_POS'" | "'MULTIPLIER_CONTROL_NEUTRAL_NEG'" | "'MULTIPLIER_ENDPOS_HEIGHT_DIFFERENCE'" | "'MULTIPLIER_ENDPOS_NOT_IN_SMOKE'" | "'MULTIPLIER_CHARMED'" | "'MULTIPLIER_POSITION_LEAVE'" | "'MULTIPLIER_HEAL_ENEMY_NEG'" | "'MULTIPLIER_ARMOR_ENEMY_POS'" | "'MULTIPLIER_SURFACE_STATUS_ON_MOVE'" | "'SURFACE_DAMAGE_MAX_TURNS'" | "'MULTIPLIER_SPARK'" | "'MULTIPLIER_HOT_SELF_NEG'" | "'MULTIPLIER_HOT_NEUTRAL_POS'" | "'MULTIPLIER_TARGET_IN_SIGHT'" | "'MULTIPLIER_ADD_MAGIC_ARMOR'" | "'MULTIPLIER_DODGE_BOOST'" | "'MULTIPLIER_COMBO_SCORE_POSITIONING'" | "'MULTIPLIER_DAMAGE_ENEMY_POS'" | "'MULTIPLIER_BOOST_SELF_NEG'" | "'FALLBACK_ENEMIES_NEARBY'" | "'MOVESKILL_AP_DIFF_REQUIREMENT'" | "'MULTIPLIER_SP_COSTBOOST'" | "'ENABLE_SAVING_ACTION_POINTS'" | "'CHARMED_MAX_CONSUMABLES_PER_TURN'" | "'MULTIPLIER_HEAL_ALLY_NEG'" | "'MULTIPLIER_ARMOR_ALLY_POS'" | "'MULTIPLIER_STATUS_FAILED'" | "'MULTIPLIER_LOSE_CONTROL'" | "'AVENGE_ME_RADIUS'" | "'MULTIPLIER_CONTROL_SELF_POS'" | "'MULTIPLIER_LOW_ITEM_AMOUNT_MULTIPLIER'" | "'MULTIPLIER_TARGET_KNOCKED_DOWN'" | "'MULTIPLIER_HEAL_SHARING'" | "'MULTIPLIER_SURFACE_REMOVE'" | "'MULTIPLIER_DAMAGE_ALLY_POS'" | "'MULTIPLIER_DOT_ALLY_POS'" | "'MULTIPLIER_BOOST_ENEMY_NEG'" | "'MULTIPLIER_ENDPOS_ENEMIES_NEARBY'" | "'MULTIPLIER_SCORE_ON_ALLY'" | "'MULTIPLIER_REMOVE_ARMOR'" | "'MULTIPLIER_MAGICAL_SULFUR'" | "'MULTIPLIER_HEAL_NEUTRAL_NEG'" | "'MULTIPLIER_ARMOR_NEUTRAL_POS'" | "'ENDPOS_NEARBY_DISTANCE'" | "'MULTIPLIER_EXPLOSION_DISTANCE_MIN'" | "'MULTIPLIER_SHACKLES_OF_PAIN'" | "'MULTIPLIER_AP_MAX'" | "'MULTIPLIER_CONTROL_ENEMY_POS'" | "'MULTIPLIER_TARGET_UNPREFERRED'" | "'MULTIPLIER_ARMORBOOST'" | "'MULTIPLIER_SECONDARY_ATTRIB'" | "'MULTIPLIER_COMBO_SCORE_INTERACTION'" | "'UNSTABLE_BOMB_NEARBY'" | "'MULTIPLIER_DAMAGE_NEUTRAL_POS'" | "'MULTIPLIER_BOOST_ALLY_NEG'" | "'MAX_HEAL_SELF_MULTIPLIER'" | "'MULTIPLIER_BLIND'" | "'MULTIPLIER_MAGICAL_SULFUR_CURRENTLY_DAM'" | "'AVENGE_ME_VITALITY_LEVEL'"
--- @alias AiScoreReasonFlags string | "'TargetBlocked'" | "'RemoveMadnessSelf'" | "'ResurrectByCharmedPlayer'" | "'KillSelf'" | "'ScoreTooLow'" | "'TooComplex'" | "'BreakInvisibility'" | "'NoMovement'" | "'CannotTargetFrozen'" | "'StupidInvisibility'" | "'BreakInvisibilityForNoEnemies'" | "'ResurrectOutOfCombat'" | "'MustStayInAiHint'" | "'TooFar'" | "'MoveSkillCannotExecute'"
--- @alias CauseType string | "'SurfaceMove'" | "'SurfaceCreate'" | "'SurfaceStatus'" | "'StatusEnter'" | "'StatusTick'" | "'None'" | "'GM'" | "'Offhand'" | "'Attack'"
--- @alias CraftingStationType string | "'Misc2'" | "'Well'" | "'Misc4'" | "'Anvil'" | "'None'" | "'Beehive'" | "'Misc1'" | "'Misc3'" | "'Wetstone'" | "'Oven'" | "'BoilingPot'" | "'SpinningWheel'" | "'Cauldron'"
--- @alias ESurfaceFlag string | "'Deathfog'" | "'ShockwaveCloud'" | "'MovementBlock'" | "'Cursed'" | "'CloudElectrified'" | "'ProjectileBlock'" | "'HasCharacter'" | "'Lava'" | "'Occupied'" | "'Source'" | "'HasInteractableObject'" | "'SurfaceExclude'" | "'Sulfurium'" | "'Water'" | "'FireCloud'" | "'CloudBlessed'" | "'HasItem'" | "'WaterCloud'" | "'Blessed'" | "'CloudCursed'" | "'BloodCloud'" | "'CloudPurified'" | "'PoisonCloud'" | "'ElectrifiedDecay'" | "'SomeDecay'" | "'Fire'" | "'SmokeCloud'" | "'Irreplaceable'" | "'ExplosionCloud'" | "'FrostCloud'" | "'GroundSurfaceBlock'" | "'Blood'" | "'Purified'" | "'Web'" | "'Electrified'" | "'Poison'" | "'IrreplaceableCloud'" | "'Oil'" | "'Deepwater'" | "'CloudSurfaceBlock'" | "'Frozen'"
--- @alias ExtComponentType string | "'ServerCharacter'" | "'ServerItem'" | "'Max'" | "'Combat'" | "'ServerProjectile'" | "'ClientCharacter'" | "'ServerCustomStatDefinition'" | "'ClientItem'"
...
--- @alias HealEffect string | "'Heal'" | "'Script'" | "'None'" | "'Surface'" | "'HealSharingReflected'" | "'Necromantic'" | "'ResistDeath'" | "'Behavior'" | "'Unknown4'" | "'Sitting'" | "'Lifesteal'" | "'NegativeDamage'" | "'Unknown9'" | "'HealSharing'"
...
--- @alias InputType string | "'AcceleratedRepeat'" | "'Hold'" | "'Repeat'" | "'Press'" | "'ValueChange'" | "'Unknown'" | "'Release'"
--- @alias ItemDataRarity string | "'Rare'" | "'Unique'" | "'Sentinel'" | "'Common'" | "'Divine'" | "'Uncommon'" | "'Legendary'" | "'Epic'"
--- @alias LuaTypeId string | "'Float'" | "'Array'" | "'Void'" | "'Map'" | "'Integer'" | "'Function'" | "'String'" | "'Object'" | "'Enumeration'" | "'Set'" | "'Nullable'" | "'Boolean'" | "'Module'" | "'Tuple'" | "'Unknown'" | "'Any'"
--- @alias MultiEffectHandlerFlags string | "'FollowScale'" | "'EffectAttached'" | "'Detach'" | "'KeepRot'" | "'Beam'" | "'FaceSource'"
--- @alias NetMessage string | "'NETMSG_CHARACTER_SKILLBAR'" | "'NETMSG_ITEM_STATUS'" | "'NETMSG_TURNBASED_SUMMONS'" | "'NETMSG_CACHETEMPLATE'" | "'NETMSG_GM_TICK_ROLLS'" | "'NETMSG_GM_REORDER_ELEMENTS'" | "'NETMSG_MODULE_LOADED'" | "'NETMSG_UPDATE_CHARACTER_TAGS'" | "'NETMSG_ARENA_RESULTS'" | "'NETMSG_GAMEACTION'" | "'NETMSG_CHARACTER_IN_DIALOG'" | "'NETMSG_TURNBASED_START'" | "'NETMSG_QUEST_UPDATE'" | "'NETMSG_QUEST_CATEGORY_UPDATE'" | "'NETMSG_GM_LOAD_CAMPAIGN'" | "'NETMSG_GM_INVENTORY_OPERATION'" | "'NETMSG_LEVEL_SWAP_READY'" | "'NETMSG_PING_BEACON'" | "'NETMSG_HOST_WELCOME'" | "'NETMSG_CHARACTER_CONFIRMATION'" | "'NETMSG_CHARACTER_USE_AP'" | "'NETMSG_ITEM_MOVED_INFORM'" | "'NETMSG_SKILL_DESTROY'" | "'NETMSG_QUEST_POSTPONE'" | "'NETMSG_GM_TOGGLE_OVERVIEWMAP'" | "'NETMSG_GM_GIVE_REWARD'" | "'NETMSG_SHOW_TUTORIAL_MESSAGE'" | "'NETMSG_LOCK_WAYPOINT'" | "'NETMSG_PLAYER_CONNECT'" | "'NETMSG_CHARACTER_ACTION_REQUEST_RESULT'" | "'NETMSG_CHARACTER_STATS_UPDATE'" | "'NETMSG_PARTYUPDATE'" | "'NETMSG_NET_ENTITY_CREATE'" | "'NETMSG_EFFECT_FORGET'" | "'NETMSG_FLAG_UPDATE'" | "'NETMSG_GM_CONFIGURE_CAMPAIGN'" | "'NETMSG_GM_DEACTIVATE'" | "'NETMSG_LOBBY_DATAUPDATE'" | "'NETMSG_CUSTOM_STATS_CREATE'" | "'NETMSG_COMBAT_COMPONENT_SYNC'" | "'NETMSG_ITEM_DESTINATION'" | "'NETMSG_INVENTORY_VIEW_UPDATE_ITEMS'" | "'NETMSG_ALIGNMENT_CREATE'" | "'NETMSG_REGISTER_WAYPOINT'" | "'NETMSG_GM_REQUEST_ROLL'" | "'NETMSG_ATMOSPHERE_OVERRIDE'" | "'NETMSG_PARTY_NPC_DATA'" | "'NETMSG_CHARACTER_ANIMATION_SET_UPDATE'" | "'NETMSG_AITEST_UPDATE'" | "'NETMSG_SKIPMOVIE_RESULT'" | "'NETMSG_CHARACTER_DEACTIVATE'" | "'NETMSG_INVENTORY_CREATE'" | "'NETMSG_INVENTORY_VIEW_CREATE'" | "'NETMSG_SCREEN_FADE_DONE'" | "'NETMSG_OPEN_CUSTOM_BOOK_UI_MESSAGE'" | "'NETMSG_GM_REMOVE_EXPORTED'" | "'NETMSG_GM_CAMPAIGN_SAVE'" | "'NETMSG_LEVEL_LOAD'" | "'NETMSG_SERVER_NOTIFICATION'" | "'NETMSG_ACHIEVEMENT_PROGRESS_MESSAGE'" | "'NETMSG_TRIGGER_CREATE'" | "'NETMSG_CHARACTER_STATUS'" | "'NETMSG_CHARACTER_TRANSFORM'" | "'NETMSG_PEER_ACTIVATE'" | "'NETMSG_GAMECONTROL_UPDATE_S2C'" | "'NETMSG_MARKER_UI_CREATE'" | "'NETMSG_GM_ITEM_USE'" | "'NETMSG_GM_CLEAR_STATUSES'" | "'NETMSG_ITEM_ENGRAVE'" | "'NETMSG_LOAD_GAME_WITH_ADDONS'" | "'NETMSG_MULTIPLE_TARGET_OPERATION'" | "'NETMSG_DLC_UPDATE'" | "'NETMSG_CLIENT_ACCEPT'" | "'NETMSG_PARTY_DESTROY'" | "'NETMSG_SHROUD_FRUSTUM_UPDATE'" | "'NETMSG_SKILL_ACTIVATE'" | "'NETMSG_PARTYFORMATION'" | "'NETMSG_PARTY_UNLOCKED_RECIPE'" | "'NETMSG_GM_EDIT_ITEM'" | "'NETMSG_LEVEL_INSTANTIATE_SWAP'" | "'NETMSG_DIALOG_LISTEN'" | "'NETMSG_CHARACTER_POSITION_SYNC'" | "'NETMSG_ITEM_DESTROY'" | "'NETMSG_INVENTORY_VIEW_SORT'" | "'NETMSG_PLAYMOVIE'" | "'NETMSG_GM_DAMAGE'" | "'NETMSG_GM_VIGNETTE_ANSWER'" | "'NETMSG_CAMERA_TARGET'" | "'NETMSG_DISCOVERED_PORTALS'" | "'NETMSG_LOBBY_SURRENDER'" | "'NETMSG_CHARACTER_PICKPOCKET'" | "'NETMSG_ITEM_TRANSFORM'" | "'NETMSG_GAMECONTROL_PRICETAG'" | "'NETMSG_OVERHEADTEXT'" | "'NETMSG_GM_CHANGE_LEVEL'" | "'NETMSG_GM_SOUND_PLAYBACK'" | "'NETMSG_MODULES_DOWNLOAD'" | "'NETMSG_CAMERA_SPLINE'" | "'NETMSG_GM_JOURNAL_UPDATE'" | "'NETMSG_CHARACTER_CREATE'" | "'NETMSG_ITEM_USE_REMOTELY'" | "'NETMSG_INVENTORY_CREATE_AND_OPEN'" | "'NETMSG_TURNBASED_STOP'" | "'NETMSG_QUEST_STATE'" | "'NETMSG_PARTY_MERGE_NOTIFICATION'" | "'NETMSG_GM_POSSESS'" | "'NETMSG_GM_REQUEST_CHARACTERS_REROLL'" | "'NETMSG_LEVEL_START'" | "'NETMSG_CHARACTERCREATION_DONE'" | "'NETMSG_GIVE_REWARD'" | "'NETMSG_HOST_REFUSE'" | "'NETMSG_CHARACTER_ACTION_DATA'" | "'NETMSG_CHARACTER_AOO'" | "'NETMSG_INVENTORY_LOCKSTATE_SYNC'" | "'NETMSG_SKILL_UPDATE'" | "'NETMSG_UI_QUESTSELECTED'" | "'NETMSG_GM_STOP_TRAVELING'" | "'NETMSG_GM_SET_STATUS'" | "'NETMSG_NOTIFY_COMBINE_FAILED_MESSAGE'" | "'NETMSG_CRAFT_RESULT'" | "'NETMSG_REALTIME_MULTIPLAY'" | "'NETMSG_PLAYER_ACCEPT'" | "'NETMSG_CHARACTER_LOCK_ABILITY'" | "'NETMSG_PARTYUSER'" | "'NETMSG_EFFECT_DESTROY'" | "'NETMSG_COMBATLOGITEMINTERACTION'" | "'NETMSG_DIALOG_ACTORLEAVES_MESSAGE'" | "'NETMSG_GM_DELETE'" | "'NETMSG_GM_CHANGE_SCENE_PATH'" | "'NETMSG_TRADE_ACTION'" | "'NETMSG_LOBBY_USERUPDATE'" | "'NETMSG_LOAD_GAME_WITH_ADDONS_FAIL'" | "'NETMSG_HOST_REFUSEPLAYER'" | "'NETMSG_ITEM_UPDATE'" | "'NETMSG_ITEM_MOVE_TO_INVENTORY'" | "'NETMSG_ALIGNMENT_SET'" | "'NETMSG_DIALOG_NODE_MESSAGE'" | "'NETMSG_GM_PASS_ROLL'" | "'NETMSG_REQUESTAUTOSAVE'" | "'NETMSG_CHANGE_COMBAT_FORMATION'" | "'NETMSG_TELEPORT_ACK'" | "'NETMSG_SURFACE_CREATE'" | "'NETMSG_CHARACTER_SET_STORY_NAME'" | "'NETMSG_PROJECTILE_EXPLOSION'" | "'NETMSG_EGG_CREATE'" | "'NETMSG_CLOSE_UI_MESSAGE'" | "'NETMSG_GM_SYNC_SCENES'" | "'NETMSG_GM_SYNC_VIGNETTES'" | "'NETMSG_LEVEL_LOADED'" | "'NETMSG_LOBBY_CHARACTER_SELECT'" | "'NETMSG_TRIGGER_DESTROY'" | "'NETMSG_CHARACTER_UPDATE'" | "'NETMSG_CHARACTER_ITEM_USED'" | "'NETMSG_PEER_DEACTIVATE'" | "'NETMSG_OPEN_WAYPOINT_UI_MESSAGE'" | "'NETMSG_MARKER_UI_UPDATE'" | "'NETMSG_GM_TOGGLE_PEACE'" | "'NETMSG_GM_UI_OPEN_STICKY'" | "'NETMSG_STORY_ELEMENT_UI'" | "'NETMSG_MUTATORS_ENABLED'" | "'NETMSG_CLIENT_JOINED'" | "'NETMSG_CHARACTER_DESTROY'" | "'NETMSG_CHARACTER_CORPSE_LOOTABLE'" | "'NETMSG_PARTYGROUP'" | "'NETMSG_ITEM_CONFIRMATION'" | "'NETMSG_SKILL_REMOVED'" | "'NETMSG_STOP_FOLLOW'" | "'NETMSG_DIALOG_HISTORY_MESSAGE'" | "'NETMSG_GM_SET_INTERESTED_CHARACTER'" | "'NETMSG_GM_SYNC_NOTES'" | "'NETMSG_JOURNALDIALOGLOG_UPDATE'" | "'NETMSG_MUSIC_STATE'" | "'NETMSG_CHARACTER_UPGRADE'" | "'NETMSG_ITEM_ACTIVATE'" | "'NETMSG_TURNBASED_SETTEAM'" | "'NETMSG_PLAY_HUD_SOUND'" | "'NETMSG_GM_EXPORT'" | "'NETMSG_GM_SET_START_POINT'" | "'NETMSG_CAMERA_MODE'" | "'NETMSG_ACHIEVEMENT_UNLOCKED_MESSAGE'" | "'NETMSG_LOBBY_RETURN'" | "'NETMSG_SET_CHARACTER_ARCHETYPE'" | "'NETMSG_PLAYER_LEFT'" | "'NETMSG_COMBAT_TURN_TIMER'" | "'NETMSG_ITEM_OFFSTAGE'" | "'NETMSG_COMBATLOG'" | "'NETMSG_OPEN_KICKSTARTER_BOOK_UI_MESSAGE'" | "'NETMSG_JOURNALRECIPE_UPDATE'" | "'NETMSG_GAMEOVER'" | "'NETMSG_DIALOG_ACTORJOINS_MESSAGE'" | "'NETMSG_GM_POSITION_SYNC'" | "'NETMSG_GM_SET_REPUTATION'" | "'NETMSG_SESSION_LOAD'" | "'NETMSG_CHARACTER_COMPANION_CUSTOMIZATION'" | "'NETMSG_READYCHECK'" | "'NETMSG_CUSTOM_STATS_DEFINITION_UPDATE'" | "'NETMSG_CHARACTER_ACTIVATE'" | "'NETMSG_CHARACTER_ASSIGN'" | "'NETMSG_INVENTORY_DESTROY'" | "'NETMSG_TURNBASED_ROUND'" | "'NETMSG_SECRET_UPDATE'" | "'NETMSG_GM_SPAWN'" | "'NETMSG_GM_TOGGLE_VIGNETTE'" | "'NETMSG_GM_CHANGE_NAME'" | "'NETMSG_RUNECRAFT'" | "'NETMSG_SAVEGAME_LOAD_FAIL'" | "'NETMSG_SHOW_ERROR'" | "'NETMSG_HOST_LEFT'" | "'NETMSG_CHARACTER_BOOST'" | "'NETMSG_CHARACTER_CUSTOMIZATION'" | "'NETMSG_NET_ENTITY_DESTROY'" | "'NETMSG_SKILL_LEARN'" | "'NETMSG_MYSTERY_STATE'" | "'NETMSG_GM_HEAL'" | "'NETMSG_GM_REQUEST_CAMPAIGN_DATA'" | "'NETMSG_GM_REMOVE_STATUS'" | "'NETMSG_UNLOCK_ITEM'" | "'NETMSG_CUSTOM_STATS_UPDATE'" | "'NETMSG_PLAYER_JOINED'" | "'NETMSG_UPDATE_COMBAT_GROUP_INFO'" | "'NETMSG_SHROUD_UPDATE'" | "'NETMSG_FORCE_SHEATH'" | "'NETMSG_PARTY_CONSUMED_ITEMS'" | "'NETMSG_GM_ITEM_CHANGE'" | "'NETMSG_GM_ROLL'" | "'NETMSG_CAMERA_ACTIVATE'" | "'NETMSG_SAVEGAMEHANDSHAKE'" | "'NETMSG_LOBBY_COMMAND'" | "'NETMSG_CHARACTER_POSITION'" | "'NETMSG_CHARACTER_SELECTEDSKILLSET'" | "'NETMSG_ITEM_ACTION'" | "'NETMSG_INVENTORY_VIEW_DESTROY'" | "'NETMSG_ALIGNMENT_CLEAR'" | "'NETMSG_GM_ADD_EXPERIENCE'" | "'NETMSG_GM_REMOVE_ROLL'" | "'NETMSG_GM_ASSETS_PENDING_SYNCS_INFO'" | "'NETMSG_GM_HOST'" | "'NETMSG_MODULE_LOAD'" | "'NETMSG_OPEN_CRAFT_UI_MESSAGE'" | "'NETMSG_PARTYCREATEGROUP'" | "'NETMSG_SURFACE_META'" | "'NETMSG_CHARACTER_TELEPORT'" | "'NETMSG_EGG_DESTROY'" | "'NETMSG_TURNBASED_FLEECOMBATRESULT'" | "'NETMSG_GAMECONTROL_UPDATE_C2S'" | "'NETMSG_JOURNAL_RESET'" | "'NETMSG_GM_SYNC_ASSETS'" | "'NETMSG_GM_SET_ATMOSPHERE'" | "'NETMSG_CHAT'" | "'NETMSG_LOAD_START'" | "'NETMSG_CHARACTER_CHANGE_OWNERSHIP'" | "'NETMSG_TRIGGER_UPDATE'" | "'NETMSG_CLIENT_GAME_SETTINGS'" | "'NETMSG_CHARACTER_DIALOG'" | "'NETMSG_SECRET_REGION_UNLOCK'" | "'NETMSG_SKILL_CREATE'" | "'NETMSG_QUEST_TRACK'" | "'NETMSG_PARTY_SPLIT_NOTIFICATION'" | "'NETMSG_DIALOG_ANSWER_HIGHLIGHT_MESSAGE'" | "'NETMSG_GM_MAKE_TRADER'" | "'NETMSG_SAVEGAME'" | "'NETMSG_LEVEL_SWAP_COMPLETE'" | "'NETMSG_UNLOCK_WAYPOINT'" | "'NETMSG_CUSTOM_STATS_DEFINITION_REMOVE'" | "'NETMSG_SCRIPT_EXTENDER'" | "'NETMSG_CLIENT_LEFT'" | "'NETMSG_CHARACTER_STEERING'" | "'NETMSG_PARTYORDER'" | "'NETMSG_INVENTORY_ITEM_UPDATE'" | "'NETMSG_EFFECT_CREATE'" | "'NETMSG_NOTIFICATION'" | "'NETMSG_GM_TRAVEL_TO_DESTINATION'" | "'NETMSG_GM_MAKE_FOLLOWER'" | "'NETMSG_TELEPORT_WAYPOINT'" | "'NETMSG_MUSIC_EVENT'" | "'NETMSG_PAUSE'" | "'NETMSG_CHARACTER_OFFSTAGE'" | "'NETMSG_ITEM_DEACTIVATE'" | "'NETMSG_CHARACTER_ERROR'" | "'NETMSG_ALIGNMENT_RELATION'" | "'NETMSG_CLOSED_MESSAGE_BOX_MESSAGE'" | "'NETMSG_GM_TOGGLE_PAUSE'" | "'NETMSG_GM_CHANGE_SCENE_NAME'" | "'NETMSG_GAMETIME_SYNC'" | "'NETMSG_UPDATE_ITEM_TAGS'" | "'NETMSG_UNPAUSE'" | "'NETMSG_HACK_TELL_BUILDNAME'" | "'NETMSG_VOICEDATA'" | "'NETMSG_ITEM_MOVE_TO_WORLD'" | "'NETMSG_ITEM_MOVE_UUID'" | "'NETMSG_SCREEN_FADE'" | "'NETMSG_DIALOG_STATE_MESSAGE'" | "'NETMSG_GM_TELEPORT'" | "'NETMSG_SESSION_LOADED'" | "'NETMSG_CHARACTERCREATION_READY'" | "'NETMSG_DIPLOMACY'" | "'NETMSG_CHARACTER_ACTION'" | "'NETMSG_CHARACTER_STATUS_LIFETIME'" | "'NETMSG_CHARACTER_CONTROL'" | "'NETMSG_PROJECTILE_CREATE'" | "'NETMSG_TURNBASED_ORDER'" | "'NETMSG_TROPHY_UPDATE'" | "'NETMSG_GM_SYNC_OVERVIEW_MAPS'" | "'NETMSG_GM_DUPLICATE'" | "'NETMSG_SERVER_COMMAND'" | "'NETMSG_LOBBY_SPECTATORUPDATE'" | "'NETMSG_STORY_VERSION'" | "'NETMSG_CLIENT_CONNECT'" | "'NETMSG_CHARACTER_LOOT_CORPSE'" | "'NETMSG_PARTY_CREATE'" | "'NETMSG_INVENTORY_VIEW_UPDATE_PARENTS'" | "'NETMSG_SKILL_UNLEARN'" | "'NETMSG_OPEN_MESSAGE_BOX_MESSAGE'" | "'NETMSG_MYSTERY_UPDATE'" | "'NETMSG_GM_CREATE_ITEM'" | "'NETMSG_GM_EDIT_CHARACTER'" | "'NETMSG_CHARACTERCREATION_NOT_READY'" | "'NETMSG_TELEPORT_PYRAMID'" | "'NETMSG_PLAYER_DISCONNECT'" | "'NETMSG_ITEM_CREATE'" | "'NETMSG_ITEM_STATUS_LIFETIME'" | "'NETMSG_PLAYSOUND'" | "'NETMSG_CLOSE_CUSTOM_BOOK_UI_MESSAGE'" | "'NETMSG_SHOW_ENTER_REGION_UI_MESSAGE'" | "'NETMSG_DIALOG_ANSWER_MESSAGE'" | "'NETMSG_GM_DRAW_SURFACE'" | "'NETMSG_CAMERA_ROTATE'" | "'NETMSG_DIFFICULTY_CHANGED'" | "'NETMSG_LOBBY_STARTGAME'" | "'NETMSG_CUSTOM_STATS_DEFINITION_CREATE'"
--- @alias ObjectHandleType string | "'Effect'" | "'ClientAlignment'" | "'ClientAiSeederTrigger'" | "'SRV'" | "'ClientSkill'" | "'ServerEocAreaTrigger'" | "'ServerSecretRegionTrigger'" | "'Shader'" | "'SoundVolumeTrigger'" | "'ClientStatus'" | "'ServerStatsAreaTrigger'" | "'ClientAlignmentData'" | "'ClientParty'" | "'ClientVignette'" | "'ClientPointSoundTrigger'" | "'ServerExplorationTrigger'" | "'ClientNote'" | "'ServerOverviewMap'" | "'Texture'" | "'ContainerElementComponent'" | "'ClientSurface'" | "'ServerCrimeAreaTrigger'" | "'Visual'" | "'ClientWallConstruction'" | "'ServerEgg'" | "'ClientCullTrigger'" | "'ServerCharacter'" | "'ClientSoundVolumeTrigger'" | "'ClientDummyGameObject'" | "'ServerItem'" | "'Light'" | "'ServerInventory'" | "'ServerStartTrigger'" | "'CustomStatsComponent'" | "'ServerParty'" | "'ServerRegionTrigger'" | "'Reference'" | "'ClientGameAction'" | "'ServerVignette'" | "'ServerCrimeRegionTrigger'" | "'ClientSpectatorTrigger'" | "'ServerNote'" | "'ServerSurfaceAction'" | "'IndexBuffer'" | "'ServerAtmosphereTrigger'" | "'VertexBuffer'" | "'ClientWallIntersection'" | "'VertexFormat'" | "'Decal'" | "'Trigger'" | "'ClientCameraLockTrigger'" | "'SamplerState'" | "'CombatComponent'" | "'ServerProjectile'" | "'ServerSoundVolumeTrigger'" | "'BlendState'" | "'MeshProxy'" | "'Scene'" | "'ServerTeleportTrigger'" | "'DepthState'" | "'Dummy'" | "'ContainerComponent'" | "'RasterizerState'" | "'TextureRemoveData'" | "'UIObject'" | "'Text3D'" | "'ClientOverviewMap'" | "'ServerCustomStatDefinitionComponent'" | "'Constant'" | "'TerrainObject'" | "'ClientAtmosphereTrigger'" | "'ConstantBuffer'" | "'GrannyFile'" | "'ClientSecretRegionTrigger'" | "'ServerEocPointTrigger'" | "'CompiledShader'" | "'GMJournalNode'" | "'ServerAIHintAreaTrigger'" | "'TexturedFont'" | "'ClientEgg'" | "'ClientInventoryView'" | "'ClientCharacter'" | "'ClientRegionTrigger'" | "'ClientPointSoundTriggerDummy'" | "'ClientCustomStatDefinitionComponent'" | "'ClientItem'" | "'ServerInventoryView'" | "'Unknown'" | "'ClientScenery'" | "'ServerEventTrigger'" | "'ClientProjectile'" | "'ClientWallBase'" | "'ServerMusicVolumeTrigger'" | "'StructuredBuffer'" | "'ClientInventory'" | "'ClientPointTrigger'"
--- @alias PathRootType string | "'Root'" | "'Data'" | "'Public'" | "'MyDocuments'" | "'GameStorage'"
--- @alias PlayerUpgradeAttribute string | "'Wits'" | "'Memory'" | "'Finesse'" | "'Strength'" | "'Intelligence'" | "'Constitution'"
--- @alias RecipeCategory string | "'Potions'" | "'Runes'" | "'Weapons'" | "'Grenades'" | "'Objects'" | "'Food'" | "'Common'" | "'Grimoire'" | "'Arrows'" | "'Armour'"
--- @alias ResourceType string | "'Effect'" | "'Texture'" | "'Script'" | "'Visual'" | "'MaterialSet'" | "'Animation'" | "'AnimationBlueprint'" | "'MeshProxy'" | "'AnimationSet'" | "'Material'" | "'Sound'" | "'VisualSet'" | "'Atmosphere'" | "'Physics'"
...
--- @alias SkillType string | "'ProjectileStrike'" | "'Quake'" | "'Jump'" | "'Shout'" | "'Tornado'" | "'Rush'" | "'MultiStrike'" | "'Teleportation'" | "'Target'" | "'Summon'" | "'Projectile'" | "'Storm'" | "'Rain'" | "'Dome'" | "'Path'" | "'Zone'" | "'Wall'" | "'SkillHeal'"
--- @alias StatAttributeFlags string | "'FreezeImmunity'" | "'Torch'" | "'Arrow'" | "'RegeneratingImmunity'" | "'ChickenImmunity'" | "'BurnImmunity'" | "'IgnoreCursedOil'" | "'EntangledContact'" | "'StunImmunity'" | "'ShockedImmunity'" | "'PickpocketableWhenEquipped'" | "'PoisonImmunity'" | "'WebImmunity'" | "'CharmImmunity'" | "'SlippingImmunity'" | "'MagicalSulfur'" | "'FearImmunity'" | "'ProtectFromSummon'" | "'ThrownImmunity'" | "'MuteImmunity'" | "'Floating'" | "'ChilledImmunity'" | "'WarmImmunity'" | "'CrippledImmunity'" | "'WetImmunity'" | "'DisarmedImmunity'" | "'BlindImmunity'" | "'ShacklesOfPainImmunity'" | "'CursedImmunity'" | "'WeakImmunity'" | "'SlowedImmunity'" | "'SleepingImmunity'" | "'DrunkImmunity'" | "'DeflectProjectiles'" | "'FreezeContact'" | "'InfectiousDiseasedImmunity'" | "'BurnContact'" | "'DiseasedImmunity'" | "'StunContact'" | "'PoisonContact'" | "'DecayingImmunity'" | "'ChillContact'" | "'LoseDurabilityOnCharacterHit'" | "'InvisibilityImmunity'" | "'Unbreakable'" | "'KnockdownImmunity'" | "'Unrepairable'" | "'Unstorable'" | "'SuffocatingImmunity'" | "'Grounded'" | "'LootableWhenEquipped'" | "'HastedImmunity'" | "'TauntedImmunity'" | "'PetrifiedImmunity'" | "'AcidImmunity'" | "'ClairvoyantImmunity'" | "'EnragedImmunity'" | "'BlessedImmunity'" | "'IgnoreClouds'" | "'BleedingImmunity'" | "'MadnessImmunity'"
...
--- @alias SurfaceActionType string | "'PolygonSurfaceAction'" | "'ZoneAction'" | "'ExtinguishFireAction'" | "'TransformSurfaceAction'" | "'ChangeSurfaceOnPathAction'" | "'CreateSurfaceAction'" | "'RectangleSurfaceAction'" | "'CreatePuddleAction'" | "'SwapSurfaceAction'"
...
--- @alias SurfaceType string | "'BloodCloudPurified'" | "'BloodCloudElectrifiedPurified'" | "'Deathfog'" | "'ShockwaveCloud'" | "'WaterFrozenCursed'" | "'BloodFrozenPurified'" | "'BloodCloudElectrified'" | "'WaterElectrifiedPurified'" | "'SmokeCloudBlessed'" | "'WaterElectrifiedBlessed'" | "'Lava'" | "'FireBlessed'" | "'BloodFrozenBlessed'" | "'Source'" | "'FireCursed'" | "'WaterCloudBlessed'" | "'WaterCloudElectrifiedBlessed'" | "'FirePurified'" | "'PoisonCloudBlessed'" | "'Water'" | "'WaterFrozen'" | "'FireCloud'" | "'WaterBlessed'" | "'WaterFrozenPurified'" | "'WaterCloud'" | "'WaterCloudElectrifiedPurified'" | "'WaterCursed'" | "'FireCloudBlessed'" | "'BloodCloud'" | "'WaterPurified'" | "'BloodCloudBlessed'" | "'PoisonCloud'" | "'Fire'" | "'BloodFrozen'" | "'BloodCloudElectrifiedCursed'" | "'SmokeCloud'" | "'SmokeCloudCursed'" | "'WaterFrozenBlessed'" | "'BloodBlessed'" | "'ExplosionCloud'" | "'BloodCursed'" | "'BloodElectrifiedCursed'" | "'FrostCloud'" | "'Blood'" | "'BloodPurified'" | "'WaterCloudCursed'" | "'Sentinel'" | "'PoisonBlessed'" | "'Web'" | "'PoisonCloudCursed'" | "'Poison'" | "'PoisonCursed'" | "'BloodElectrified'" | "'PoisonPurified'" | "'OilBlessed'" | "'Custom'" | "'FireCloudPurified'" | "'BloodElectrifiedPurified'" | "'OilCursed'" | "'BloodCloudCursed'" | "'OilPurified'" | "'SmokeCloudPurified'" | "'WaterElectrifiedCursed'" | "'Oil'" | "'WebBlessed'" | "'Deepwater'" | "'BloodFrozenCursed'" | "'WebCursed'" | "'WaterCloudElectrifiedCursed'" | "'WebPurified'" | "'WaterCloudPurified'" | "'CustomBlessed'" | "'PoisonCloudPurified'" | "'WaterElectrified'" | "'CustomCursed'" | "'BloodCloudElectrifiedBlessed'" | "'BloodElectrifiedBlessed'" | "'CustomPurified'" | "'FireCloudCursed'" | "'WaterCloudElectrified'"
--- @alias TemplateType string | "'GlobalCacheTemplate'" | "'GlobalTemplate'" | "'LevelCacheTemplate'" | "'RootTemplate'" | "'LocalTemplate'"
--- @alias UIObjectFlags string | "'OF_RequestDelete'" | "'OF_DontHideOnDelete'" | "'OF_PlayerTextInput2'" | "'OF_KeepCustomInScreen'" | "'OF_PrecacheUIData'" | "'OF_PlayerTextInput3'" | "'OF_Loaded'" | "'OF_Visible'" | "'OF_Load'" | "'OF_Activated'" | "'OF_PlayerInput1'" | "'OF_DeleteOnChildDestroy'" | "'OF_PlayerInput2'" | "'OF_PreventCameraMove'" | "'OF_PlayerInput3'" | "'OF_PlayerInput4'" | "'OF_PlayerModal1'" | "'OF_PlayerModal2'" | "'OF_PlayerTextInput4'" | "'OF_PlayerModal3'" | "'OF_PlayerModal4'" | "'OF_KeepInScreen'" | "'OF_PauseRequest'" | "'OF_PlayerTextInput1'" | "'OF_SortOnAdd'" | "'OF_FullScreen'"
--- @alias VisualAttachmentFlags string | "'InheritAnimations'" | "'KeepScale'" | "'DoNotUpdate'" | "'Overhead'" | "'WeaponFX'" | "'BonusWeaponFX'" | "'WeaponOverlayFX'" | "'Horns'" | "'DestroyWithParent'" | "'ParticleSystem'" | "'ExcludeFromBounds'" | "'Armor'" | "'KeepRot'" | "'Wings'" | "'UseLocalTransform'" | "'Weapon'"
...
--- @alias EclCharacterFlags string | "'IsPlayer'" | "'UseOverlayMaterials'" | "'NoSound'" | "'CanShootThrough'" | "'Activated'" | "'Floating'" | "'WalkThrough'" | "'Global'" | "'SpotSneakers'" | "'OffStage'" | "'Multiplayer'" | "'HasOwner'" | "'NoCover'" | "'HasCustomVisualIndices'" | "'StoryNPC'" | "'InDialog'" | "'IsHuge'" | "'InParty'" | "'CannotMove'" | "'Invisible_M'" | "'PartyFollower'" | "'InCombat'" | "'Summon'" | "'VisualsUpdated'" | "'Invisible_M2'" | "'IsRunning'" | "'WeaponSheathed'" | "'CharCreationInProgress'" | "'DisableSneaking'" | "'Dead'" | "'NoRotate'" | "'CharacterCreationFinished'"
--- @alias EclEntityComponentIndex string | "'Effect'" | "'ParentEntity'" | "'SecretRegionTrigger'" | "'PointTrigger'" | "'CullTrigger'" | "'SoundVolumeTrigger'" | "'RegionTrigger'" | "'AiSeederTrigger'" | "'AtmosphereTrigger'" | "'PingBeacon'" | "'ContainerElement'" | "'Visual'" | "'OverviewMap'" | "'Vignette'" | "'PointSoundTrigger'" | "'Spline'" | "'Light'" | "'EquipmentVisualsComponent'" | "'Container'" | "'PublishingRequest'" | "'Note'" | "'CustomStatDefinition'" | "'Item'" | "'Decal'" | "'Combat'" | "'Projectile'" | "'PointSoundTriggerDummy'" | "'AnimationBlueprint'" | "'Scenery'" | "'Egg'" | "'CameraLockTrigger'" | "'GMJournalNode'" | "'Sound'" | "'CustomStats'" | "'Character'" | "'SpectatorTrigger'" | "'GameMaster'" | "'LightProbe'" | "'Net'"
--- @alias EclEntitySystemIndex string | "'PickingHelperManager'" | "'CharacterManager'" | "'EquipmentVisualsSystem'" | "'ContainerElementComponent'" | "'ContainerComponentSystem'" | "'ContainerElement'" | "'CameraSplineSystem'" | "'MusicManager'" | "'CustomStatsSystem'" | "'Container'" | "'VisualSystem'" | "'LightProbeManager'" | "'LightManager'" | "'EncounterManager'" | "'DecalManager'" | "'ProjectileManager'" | "'SoundSystem'" | "'GrannySystem'" | "'AnimationBlueprintSystem'" | "'TurnManager'" | "'AtmosphereManager'" | "'SceneryManager'" | "'TriggerManager'" | "'GMJournalNode'" | "'ItemManager'" | "'GameMasterCampaignManager'" | "'CustomStats'" | "'PublishingSystem'" | "'GameActionManager'" | "'GameMasterManager'" | "'EggManager'" | "'PhysXScene'" | "'PingBeaconManager'" | "'SurfaceManager'" | "'LEDSystem'" | "'GMJournalSystem'" | "'GameMaster'" | "'SeeThroughManager'"
--- @alias EclGameState string | "'LoadModule'" | "'LoadSession'" | "'Idle'" | "'LoadGMCampaign'" | "'Lobby'" | "'UnloadLevel'" | "'UnloadModule'" | "'UnloadSession'" | "'PrepareRunning'" | "'Movie'" | "'Init'" | "'Disconnect'" | "'StartLoading'" | "'StopLoading'" | "'Save'" | "'StartServer'" | "'Installation'" | "'Menu'" | "'GameMasterPause'" | "'ModReceiving'" | "'BuildStory'" | "'LoadLoca'" | "'Paused'" | "'Running'" | "'Join'" | "'InitMenu'" | "'InitNetwork'" | "'InitConnection'" | "'Unknown'" | "'LoadMenu'" | "'Exit'" | "'SwapLevel'" | "'LoadLevel'"
--- @alias EclItemFlags string | "'IsContainer'" | "'CoverAmount'" | "'IsDoor'" | "'FoldDynamicStats'" | "'CanShootThrough'" | "'IsLadder'" | "'InteractionDisabled'" | "'Activated'" | "'IsCraftingIngredient'" | "'Floating'" | "'Global'" | "'FreezeGravity'" | "'IsSecretDoor'" | "'StoryItem'" | "'HideHP'" | "'Invulnerable'" | "'IsSourceContainer'" | "'TeleportOnUse'" | "'Sticky'" | "'PinnedContainer'" | "'Invisible'" | "'EnableHighlights'" | "'Destroyed'" | "'Hostile'" | "'Unimportant'" | "'CanUse'" | "'Fade'" | "'Walkable'" | "'CanWalkThrough'" | "'PositionUpdatePending'" | "'PhysicsFlag1'" | "'Wadable'" | "'PhysicsFlag2'" | "'PhysicsFlag3'" | "'DontAddToBottomBar'" | "'CanBePickedUp'" | "'Known'" | "'CanBeMoved'"
--- @alias EclItemFlags2 string | "'UnEquipLocked'" | "'Stolen'" | "'UseSoundsLoaded'" | "'IsKey'" | "'Consumable'" | "'CanUseRemotely'"
...
--- @alias EocCombatComponentFlags string | "'IsTicking'" | "'CanJoinCombat'" | "'RequestEndTurn'" | "'CanForceEndTurn'" | "'RequestTakeExtraTurn'" | "'FleeOnEndTurn'" | "'Guarded'" | "'GuardOnEndTurn'" | "'EnteredCombat'" | "'CanGuard'" | "'TookExtraTurn'" | "'DelayDeathCount'" | "'IsInspector'" | "'CounterAttacked'" | "'RequestEnterCombat'" | "'IsBoss'" | "'InArena'" | "'CanFight'" | "'TurnEnded'"
--- @alias EocSkillBarItemType string | "'Skill'" | "'None'" | "'ItemTemplate'" | "'Action'" | "'Item'"
--- @alias EsvCharacterFlags string | "'IsPlayer'" | "'CoverAmount'" | "'CanShootThrough'" | "'LevelTransitionPending'" | "'Loaded'" | "'Activated'" | "'Floating'" | "'WalkThrough'" | "'OffStage'" | "'SpotSneakers'" | "'NeedsMakePlayerUpdate'" | "'Multiplayer'" | "'HostControl'" | "'CannotDie'" | "'Totem'" | "'CustomLookEnabled'" | "'HasOwner'" | "'StoryNPC'" | "'InDialog'" | "'ForceNonzeroSpeed'" | "'FightMode'" | "'IsHuge'" | "'InParty'" | "'FindValidPositionOnActivate'" | "'CannotMove'" | "'Deactivated'" | "'CannotRun'" | "'PartyFollower'" | "'DisableFlee_M'" | "'RegisteredForAutomatedDialog'" | "'Summon'" | "'IgnoresTriggers'" | "'RequestStartTurn'" | "'IsCompanion_M'" | "'GMReroll'" | "'Passthrough'" | "'CharCreationInProgress'" | "'Dead'" | "'CharacterControl'" | "'DeferredRemoveEscapist'" | "'Temporary'" | "'InArena'" | "'NoRotate'" | "'CharacterCreationFinished'" | "'DontCacheTemplate'"
--- @alias EsvCharacterFlags2 string | "'HasDefaultDialog'" | "'TreasureGeneratedForTrader'" | "'Global'" | "'HasOsirisDialog'" | "'Trader'" | "'Resurrected'"
--- @alias EsvCharacterFlags3 string | "'HasRunSpeedOverride'" | "'IsPet'" | "'IsGameMaster'" | "'IsPossessed'" | "'NoReptuationEffects'" | "'ManuallyLeveled'" | "'IsSpectating'" | "'HasWalkSpeedOverride'"
--- @alias EsvCharacterTransformFlags string | "'ReplaceCustomNameIcon'" | "'DiscardOriginalDisplayName'" | "'ReplaceCurrentTemplate'" | "'DontCheckRootTemplate'" | "'ReleasePlayerData'" | "'SaveOriginalDisplayName'" | "'DontReplaceCombatState'" | "'ReplaceEquipment'" | "'ReplaceScripts'" | "'ReplaceInventory'" | "'ReplaceStats'" | "'Immediate'" | "'ReplaceTags'" | "'ReplaceCustomLooks'" | "'ReplaceScale'" | "'ReplaceSkills'" | "'ReplaceOriginalTemplate'" | "'ReplaceVoiceSet'" | "'ImmediateSync'"
--- @alias EsvCharacterTransformType string | "'TransformToTemplate'" | "'TransformToCharacter'"
--- @alias EsvEntityComponentIndex string | "'SecretRegionTrigger'" | "'Effect'" | "'CrimeAreaTrigger'" | "'SoundVolumeTrigger'" | "'RegionTrigger'" | "'AtmosphereTrigger'" | "'StatsAreaTrigger'" | "'ContainerElement'" | "'OverviewMap'" | "'Vignette'" | "'Spline'" | "'EoCPointTrigger'" | "'CrimeRegionTrigger'" | "'EoCAreaTrigger'" | "'StartTrigger'" | "'Container'" | "'TeleportTrigger'" | "'EventTrigger'" | "'Note'" | "'CustomStatDefinition'" | "'ExplorationTrigger'" | "'Item'" | "'Combat'" | "'Projectile'" | "'AnimationBlueprint'" | "'AIHintAreaTrigger'" | "'Egg'" | "'GMJournalNode'" | "'CustomStats'" | "'Character'" | "'MusicVolumeTrigger'" | "'GameMaster'" | "'Net'"
--- @alias EsvEntitySystemIndex string | "'CharacterManager'" | "'ContainerElementComponent'" | "'ContainerComponentSystem'" | "'ContainerElement'" | "'EffectManager'" | "'CameraSplineSystem'" | "'RewardManager'" | "'CustomStatsSystem'" | "'Container'" | "'NetEntityManager'" | "'ShroudManager'" | "'VisualSystem'" | "'LightProbeManager'" | "'LightManager'" | "'DecalManager'" | "'ProjectileManager'" | "'SoundSystem'" | "'EnvironmentalStatusManager'" | "'AnimationBlueprintSystem'" | "'TurnManager'" | "'TriggerManager'" | "'CharacterSplineSystem'" | "'GMJournalNode'" | "'SightManager'" | "'ItemManager'" | "'GameMasterCampaignManager'" | "'CustomStats'" | "'PublishingSystem'" | "'GameActionManager'" | "'EggManager'" | "'GameMasterManager'" | "'SurfaceManager'" | "'GMJournalSystem'" | "'GameMaster'"
--- @alias EsvGameState string | "'LoadModule'" | "'LoadSession'" | "'Idle'" | "'LoadGMCampaign'" | "'UnloadLevel'" | "'UnloadModule'" | "'UnloadSession'" | "'Uninitialized'" | "'Init'" | "'Disconnect'" | "'ReloadStory'" | "'Save'" | "'Installation'" | "'Sync'" | "'GameMasterPause'" | "'BuildStory'" | "'Paused'" | "'Running'" | "'Unknown'" | "'Exit'" | "'LoadLevel'"
--- @alias EsvItemFlags string | "'ClientSync1'" | "'IsContainer'" | "'WalkOn'" | "'IsDoor'" | "'ForceSync'" | "'CanShootThrough'" | "'IsLadder'" | "'DontAddToHotbar'" | "'InteractionDisabled'" | "'PositionChanged'" | "'Activated'" | "'WalkThrough'" | "'GMFolding'" | "'Floating'" | "'OffStage'" | "'FreezeGravity'" | "'IsSecretDoor'" | "'IsSurfaceBlocker'" | "'StoryItem'" | "'HideHP'" | "'Invulnerable'" | "'Totem'" | "'Destroy'" | "'ClientSync2'" | "'NoCover'" | "'SourceContainer'" | "'TeleportOnUse'" | "'Sticky'" | "'PinnedContainer'" | "'TransformChanged'" | "'Invisible'" | "'Destroyed'" | "'Summon'" | "'IsSurfaceCloudBlocker'" | "'CanUse'" | "'WakePhysics'" | "'CanOnlyBeUsedByOwner'" | "'Frozen'" | "'CanBePickedUp'" | "'Known'" | "'CanBeMoved'" | "'LoadedTemplate'"
...
--- @alias EsvStatusFlags0 string | "'InitiateCombat'" | "'IsLifeTimeSet'" | "'KeepAlive'" | "'Influence'" | "'IsOnSourceSurface'" | "'Channeled'" | "'IsFromItem'"
--- @alias EsvStatusFlags1 string | "'BringIntoCombat'" | "'IsInvulnerable'" | "'IsResistingDeath'" | "'IsHostileAct'"
--- @alias EsvStatusFlags2 string | "'Started'" | "'RequestClientSync2'" | "'RequestDeleteAtTurnEnd'" | "'RequestClientSync'" | "'RequestDelete'" | "'ForceStatus'" | "'ForceFailStatus'"
...
--- @alias EsvSystemType string | "'Effect'" | "'ContainerElement'" | "'GM'" | "'GameAction'" | "'Container'" | "'Reward'" | "'Surface'" | "'NetEntity'" | "'Item'" | "'CharacterSpline'" | "'Trigger'" | "'CameraSpline'" | "'GMCampaign'" | "'Projectile'" | "'AnimationBlueprint'" | "'TurnManager'" | "'Shroud'" | "'Egg'" | "'GMJournal'" | "'SightManager'" | "'EnvironmentalStatus'" | "'Character'" | "'CustomStat'"
--- @alias StatsAbilityType string | "'Crafting'" | "'Pickpocket'" | "'Thievery'" | "'Wand'" | "'Loremaster'" | "'Reflexes'" | "'Repair'" | "'Sneaking'" | "'RangerLore'" | "'RogueLore'" | "'Reason'" | "'Persuasion'" | "'Intimidate'" | "'Leadership'" | "'DualWielding'" | "'Perseverance'" | "'PhysicalArmorMastery'" | "'VitalityMastery'" | "'Shield'" | "'Luck'" | "'SingleHanded'" | "'Sentinel'" | "'TwoHanded'" | "'Sulfurology'" | "'WarriorLore'" | "'AirSpecialist'" | "'EarthSpecialist'" | "'Brewmaster'" | "'MagicArmorMastery'" | "'FireSpecialist'" | "'Charm'" | "'Runecrafting'" | "'Necromancy'" | "'Summoning'" | "'Ranged'" | "'Polymorph'" | "'PainReflection'" | "'Telekinesis'" | "'WaterSpecialist'" | "'Barter'" | "'Sourcery'"
--- @alias StatsArmorType string | "'Mail'" | "'None'" | "'Cloth'" | "'Robe'" | "'Leather'" | "'Sentinel'" | "'Plate'"
--- @alias StatsCharacterFlags string | "'IsPlayer'" | "'InParty'" | "'IsSneaking'" | "'Invisible'" | "'DrinkedPotion'" | "'Blind'" | "'EquipmentValidated'"
--- @alias StatsCharacterStatGetterType string | "'PoisonResistance'" | "'LifeSteal'" | "'ChanceToHitBoost'" | "'Initiative'" | "'APMaximum'" | "'APRecovery'" | "'ShadowResistance'" | "'Wits'" | "'Accuracy'" | "'Movement'" | "'PiercingResistance'" | "'FireResistance'" | "'EarthResistance'" | "'WaterResistance'" | "'CustomResistance'" | "'MaxMp'" | "'Memory'" | "'AirResistance'" | "'MagicResistance'" | "'DamageBoost'" | "'CriticalChance'" | "'PhysicalResistance'" | "'Dodge'" | "'Hearing'" | "'Finesse'" | "'Strength'" | "'APStart'" | "'Intelligence'" | "'BlockChance'" | "'Constitution'" | "'CorrosiveResistance'" | "'Sight'"
--- @alias StatsCriticalRoll string | "'Roll'" | "'Critical'" | "'NotCritical'"
--- @alias StatsDamageType string | "'Magic'" | "'None'" | "'Water'" | "'Sulfuric'" | "'Fire'" | "'Sentinel'" | "'Poison'" | "'Chaos'" | "'Air'" | "'Piercing'" | "'Physical'" | "'Corrosive'" | "'Shadow'" | "'Earth'"
--- @alias StatsDeathType string | "'Arrow'" | "'Explode'" | "'Incinerate'" | "'Acid'" | "'Electrocution'" | "'None'" | "'FrozenShatter'" | "'Surrender'" | "'KnockedDown'" | "'Hang'" | "'Sulfur'" | "'Sentinel'" | "'Lifetime'" | "'PetrifiedShatter'" | "'Piercing'" | "'Physical'" | "'DoT'"
...
--- @alias StatsHitFlag string | "'DontCreateBloodSurface'" | "'Reflection'" | "'ProcWindWalker'" | "'Dodged'" | "'PropagatedFromOwner'" | "'FromShacklesOfPain'" | "'Blocked'" | "'Burning'" | "'Surface'" | "'CriticalHit'" | "'FromSetHP'" | "'NoDamageOnOwner'" | "'DamagedMagicArmor'" | "'DamagedVitality'" | "'CounterAttack'" | "'Poisoned'" | "'Bleeding'" | "'Missed'" | "'NoEvents'" | "'Flanking'" | "'Backstab'" | "'DoT'" | "'Hit'" | "'DamagedPhysicalArmor'"
--- @alias StatsHitType string | "'Magic'" | "'WeaponDamage'" | "'Melee'" | "'Reflected'" | "'Surface'" | "'Ranged'" | "'DoT'"
--- @alias StatsItemSlot string | "'Ring'" | "'Breast'" | "'Overhead'" | "'Ring2'" | "'Horns'" | "'Shield'" | "'Leggings'" | "'Boots'" | "'Belt'" | "'Sentinel'" | "'Helmet'" | "'Amulet'" | "'Wings'" | "'Weapon'" | "'Gloves'"
--- @alias StatsItemSlot32 string | "'Ring'" | "'Breast'" | "'Overhead'" | "'Ring2'" | "'Horns'" | "'Shield'" | "'Leggings'" | "'Boots'" | "'Belt'" | "'Sentinel'" | "'Helmet'" | "'Amulet'" | "'Wings'" | "'Weapon'" | "'Gloves'"
--- @alias StatsPropertyContext string | "'SelfOnEquip'" | "'Self'" | "'Target'" | "'AoE'" | "'SelfOnHit'"
--- @alias StatsPropertyType string | "'Sabotage'" | "'GameAction'" | "'SurfaceChange'" | "'Summon'" | "'CustomDescription'" | "'Custom'" | "'Status'" | "'Force'" | "'OsirisTask'" | "'Extender'"
--- @alias StatsRequirementType string | "'Crafting'" | "'TALENT_FireSpells'" | "'TALENT_WeatherProof'" | "'TALENT_WarriorLoreNaturalResistance'" | "'TALENT_RogueLoreDaggerBackStab'" | "'TRAIT_Forgiving'" | "'TALENT_Soulcatcher'" | "'Pickpocket'" | "'Thievery'" | "'Wand'" | "'TALENT_AvoidDetection'" | "'TALENT_ElementalAffinity'" | "'TALENT_ExtraWandCharge'" | "'TRAIT_Bold'" | "'Loremaster'" | "'TALENT_ItemMovement'" | "'TALENT_Flanking'" | "'TALENT_WhatARush'" | "'TALENT_Executioner'" | "'TRAIT_Timid'" | "'TALENT_Backstab'" | "'TALENT_ResistFear'" | "'TALENT_RogueLoreHoldResistance'" | "'TRAIT_Altruistic'" | "'TRAIT_Obedient'" | "'Reflexes'" | "'TALENT_Trade'" | "'TALENT_ExtraSkillPoints'" | "'TALENT_WarriorLoreNaturalArmor'" | "'TRAIT_Pragmatic'" | "'TALENT_Gladiator'" | "'Repair'" | "'Sneaking'" | "'TALENT_Lockpick'" | "'TALENT_Intimidate'" | "'TALENT_FolkDancer'" | "'TRAIT_Romantic'" | "'RangerLore'" | "'TALENT_Damage'" | "'TALENT_LightStep'" | "'TALENT_WarriorLoreGrenadeRange'" | "'TALENT_Dwarf_Sturdy'" | "'TRAIT_Spiritual'" | "'None'" | "'RogueLore'" | "'TALENT_ActionPoints2'" | "'TALENT_Sight'" | "'TALENT_RangerLoreArrowRecover'" | "'TALENT_Ambidextrous'" | "'TRAIT_Righteous'" | "'Reason'" | "'Persuasion'" | "'TALENT_ResistSilence'" | "'TALENT_Carry'" | "'TRAIT_Renegade'" | "'TRAIT_Considerate'" | "'Intimidate'" | "'TALENT_Kinetics'" | "'TALENT_WaterSpells'" | "'TALENT_Courageous'" | "'TALENT_Lizard_Persuasion'" | "'TRAIT_Blunt'" | "'TALENT_MasterThief'" | "'Wits'" | "'Leadership'" | "'TALENT_Repair'" | "'TALENT_AnimalEmpathy'" | "'TALENT_RangerLoreRangedAPBonus'" | "'TALENT_Human_Civil'" | "'TRAIT_Heartless'" | "'DualWielding'" | "'TALENT_ItemCreation'" | "'TALENT_ExpGain'" | "'TALENT_FaroutDude'" | "'TALENT_QuickStep'" | "'MinKarma'" | "'Perseverance'" | "'TALENT_AttackOfOpportunity'" | "'TALENT_ResistKnockdown'" | "'TALENT_Vitality'" | "'TRAIT_Egotistical'" | "'MaxKarma'" | "'PhysicalArmorMastery'" | "'TALENT_Durability'" | "'TALENT_Charm'" | "'Immobile'" | "'TALENT_Indomitable'" | "'TALENT_Reason'" | "'TALENT_Initiative'" | "'TALENT_SpillNoBlood'" | "'TALENT_Sadist'" | "'Shield'" | "'Luck'" | "'TALENT_Luck'" | "'TALENT_ResurrectToFullHealth'" | "'TALENT_Scientist'" | "'TALENT_Elf_CorpseEater'" | "'TALENT_Haymaker'" | "'TALENT_Criticals'" | "'TALENT_Escapist'" | "'TALENT_Sourcerer'" | "'TALENT_WildMag'" | "'Memory'" | "'SingleHanded'" | "'TALENT_ResistDead'" | "'TALENT_Raistlin'" | "'TALENT_RogueLoreMovementBonus'" | "'TRAIT_Compassionate'" | "'Level'" | "'TwoHanded'" | "'TALENT_AirSpells'" | "'TALENT_Leech'" | "'TALENT_FiveStarRestaurant'" | "'TALENT_GoldenMage'" | "'Combat'" | "'TALENT_GreedyVessel'" | "'WarriorLore'" | "'TALENT_StandYourGround'" | "'TALENT_Bully'" | "'TALENT_Human_Inventive'" | "'AirSpecialist'" | "'TALENT_ChanceToHitMelee'" | "'TALENT_ElementalRanger'" | "'TALENT_LoneWolf'" | "'TALENT_NoAttackOfOpportunity'" | "'TALENT_ViolentMagic'" | "'EarthSpecialist'" | "'TALENT_ResistStun'" | "'TALENT_Zombie'" | "'TALENT_WarriorLoreNaturalHealth'" | "'TRAIT_Independent'" | "'MagicArmorMastery'" | "'Vitality'" | "'FireSpecialist'" | "'Charm'" | "'TALENT_Awareness'" | "'TALENT_Politician'" | "'TALENT_Demon'" | "'TALENT_Jitterbug'" | "'Necromancy'" | "'TALENT_InventoryAccess'" | "'TALENT_Kickstarter'" | "'TALENT_DualWieldingDodging'" | "'Finesse'" | "'Summoning'" | "'TALENT_MrKnowItAll'" | "'TALENT_RangerLoreEvasionBonus'" | "'TALENT_Perfectionist'" | "'Ranged'" | "'Polymorph'" | "'TALENT_IncreasedArmor'" | "'TALENT_IceKing'" | "'TALENT_RogueLoreGrenadePrecision'" | "'TRAIT_Vindictive'" | "'Strength'" | "'PainReflection'" | "'TALENT_ExtraStatPoints'" | "'TALENT_Stench'" | "'TALENT_Lizard_Resistance'" | "'TALENT_Elementalist'" | "'Intelligence'" | "'Telekinesis'" | "'TALENT_EarthSpells'" | "'TALENT_WalkItOff'" | "'TALENT_RogueLoreDaggerAPBonus'" | "'TALENT_Elf_Lore'" | "'TALENT_MagicCycles'" | "'Constitution'" | "'WaterSpecialist'" | "'TALENT_SurpriseAttack'" | "'TALENT_Dwarf_Sneaking'" | "'TALENT_Memory'" | "'Barter'" | "'TALENT_ChanceToHitRanged'" | "'TALENT_ActionPoints'" | "'TALENT_LightningRod'" | "'TALENT_LivingArmor'" | "'TALENT_Torturer'" | "'Sourcery'" | "'TALENT_ResistPoison'" | "'TALENT_Unstable'" | "'TRAIT_Materialistic'" | "'Tag'"
--- @alias StatsTalentType string | "'ResistFear'" | "'WeatherProof'" | "'Demon'" | "'Perfectionist'" | "'ResistKnockdown'" | "'FiveStarRestaurant'" | "'LoneWolf'" | "'Executioner'" | "'ResistStun'" | "'RogueLoreMovementBonus'" | "'ViolentMagic'" | "'ActionPoints'" | "'ResistPoison'" | "'Lizard_Resistance'" | "'QuickStep'" | "'Sadist'" | "'ResistSilence'" | "'Carry'" | "'Initiative'" | "'BeastMaster'" | "'NaturalConductor'" | "'ResistDead'" | "'Repair'" | "'ExtraSkillPoints'" | "'Quest_GhostTree'" | "'Throwing'" | "'WarriorLoreNaturalResistance'" | "'RangerLoreRangedAPBonus'" | "'WandCharge'" | "'LivingArmor'" | "'None'" | "'Zombie'" | "'DualWieldingDodging'" | "'Torturer'" | "'Reason'" | "'Quest_SpidersKiss_Null'" | "'Ambidextrous'" | "'ItemMovement'" | "'AttackOfOpportunity'" | "'ExtraStatPoints'" | "'Intimidate'" | "'Unstable'" | "'AnimalEmpathy'" | "'WarriorLoreNaturalArmor'" | "'Quest_Rooted'" | "'Rager'" | "'Trade'" | "'Awareness'" | "'RogueLoreHoldResistance'" | "'PainDrinker'" | "'Max'" | "'Escapist'" | "'Quest_SpidersKiss_Str'" | "'Sourcerer'" | "'Damage'" | "'FireSpells'" | "'DeathfogResistant'" | "'Elementalist'" | "'WaterSpells'" | "'ResurrectToFullHealth'" | "'Bully'" | "'Haymaker'" | "'AirSpells'" | "'Luck'" | "'RogueLoreDaggerAPBonus'" | "'Gladiator'" | "'EarthSpells'" | "'Elf_CorpseEating'" | "'Indomitable'" | "'InventoryAccess'" | "'Stench'" | "'Memory'" | "'Quest_TradeSecrets'" | "'Jitterbug'" | "'ChanceToHitRanged'" | "'AvoidDetection'" | "'Soulcatcher'" | "'Kickstarter'" | "'RangerLoreArrowRecover'" | "'MasterThief'" | "'StandYourGround'" | "'Courageous'" | "'WarriorLoreNaturalHealth'" | "'NoAttackOfOpportunity'" | "'GreedyVessel'" | "'SurpriseAttack'" | "'Leech'" | "'GoldenMage'" | "'Quest_SpidersKiss_Int'" | "'MagicCycles'" | "'Vitality'" | "'Charm'" | "'LightStep'" | "'WalkItOff'" | "'Scientist'" | "'ElementalAffinity'" | "'FolkDancer'" | "'RogueLoreGrenadePrecision'" | "'ItemCreation'" | "'Raistlin'" | "'IceKing'" | "'SpillNoBlood'" | "'RogueLoreDaggerBackStab'" | "'Flanking'" | "'MrKnowItAll'" | "'Lizard_Persuasion'" | "'Backstab'" | "'WhatARush'" | "'Human_Inventive'" | "'ResurrectExtraHealth'" | "'Lockpick'" | "'ChanceToHitMelee'" | "'FaroutDude'" | "'Human_Civil'" | "'WildMag'" | "'ActionPoints2'" | "'ExpGain'" | "'ElementalRanger'" | "'RangerLoreEvasionBonus'" | "'Dwarf_Sneaking'" | "'Criticals'" | "'Durability'" | "'LightningRod'" | "'WarriorLoreGrenadeRange'" | "'Dwarf_Sturdy'" | "'IncreasedArmor'" | "'Sight'" | "'Politician'" | "'Elf_Lore'" | "'Quest_SpidersKiss_Per'"
--- @alias StatsWeaponType string | "'Arrow'" | "'Wand'" | "'None'" | "'Knife'" | "'Club'" | "'Crossbow'" | "'Staff'" | "'Rifle'" | "'Sentinel'" | "'Sword'" | "'Spear'" | "'Axe'" | "'Bow'"

...
table.insert(tab.Entries, 8, {Type = "Setting", Module = adjustPitchSetting.ModTable, ID = adjustPitchSetting:GetID()})
table.insert(tab.Entries, 9, {Type = "Setting", Module = CameraControls:GetNamespace(), ID = CameraControls.Settings.Sensitivity:GetID()})

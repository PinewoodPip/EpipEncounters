...
---------------------------------------------
local TTD = Epip.Features.TreasureTableDisplay
local DerpyTreasures = {
    ...
    CHARACTERS = {
        ...
        -- ["03e6345f-1bd3-403c-80e2-a443a74f6349"] = TTD.TREASURE_TABLES.MegaBoss, -- S_GLO_Alexandar
...
Epip.AddFeature("DerpyTreasureDisplay", "DerpyTreasureDisplay", DerpyTreasures)

---------------------------------------------
-- EVENT LISTENERS
---------------------------------------------

TTD.Hooks.GetTreasureData:RegisterHook(function (data, char)
    if not data then

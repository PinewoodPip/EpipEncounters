...
for family,data in pairs(Data.Game.TIERED_STATUSES) do
    for tier,status in pairs(data.Tiers) do
        Data.Game.IS_TIERED_STATUS[status] = true
    end
end

Data.Game.EQUIPMENT_SUBTYPES = {
    -- TODO
}

Data.Game.EQUIPMENT_BASE_BOOST_TIERS = {
    Weapon = {
        Tiers = 14,
        Boosts = {

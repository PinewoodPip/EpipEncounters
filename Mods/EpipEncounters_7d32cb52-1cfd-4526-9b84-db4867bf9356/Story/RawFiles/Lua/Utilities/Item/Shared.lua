...
---Inventory texture and sound types.
---@enum ItemLib.InventoryType
Item.INVENTORY_TYPES = {
    BARREL = 1,
    CRATE = 2,
    BASKET = 3,
    CHEST = 4,
...
local INVENTORY_TYPES = Item.INVENTORY_TYPES

---Maps container type to texture resource.
---@type table<ItemLib.InventoryType, GUID.Texture>
Item.INVENTORY_TEXTURES = {
